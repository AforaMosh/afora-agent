...
public struct ArtifactBuildInfo: Equatable, Sendable {
        ...
        versionKeys: [String] = ["CFBundleShortVersionString"])
    {
        ...
        self.gitCommit = Self.validGitCommit(Self.nonEmptyString(infoDictionary["AforaGitCommit"]))
        let buildTimestamp = Self.nonEmptyString(infoDictionary["AforaBuildTimestamp"])
