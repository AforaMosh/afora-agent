...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int64,
        nonce: String) -> [String: AforaProtocol.AnyCodable]?
    {
        ...
        return [
            "id": AforaProtocol.AnyCodable(identity.deviceId),
            "publicKey": AforaProtocol.AnyCodable(publicKey),
            "signature": AforaProtocol.AnyCodable(signature),
            "signedAt": AforaProtocol.AnyCodable(signedAtMs),
            "nonce": AforaProtocol.AnyCodable(nonce),
        ]
    }
}
