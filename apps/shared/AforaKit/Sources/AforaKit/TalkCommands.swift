...
public enum AforaTalkCommand: String, Codable, Sendable {
...
public struct AforaTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct AforaTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
