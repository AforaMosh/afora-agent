...
public struct AforaSessionsCompactResponse: Decodable, Sendable {
    public let ok: Bool
    ...
    public static func requireSuccess(from data: Data) throws {
        ...
        guard response.ok else {
            throw AforaSessionsCompactError(reason: response.reason)
        }
    }
}

struct AforaSessionsCompactError: Error, LocalizedError, Sendable {
    let reason: String?
