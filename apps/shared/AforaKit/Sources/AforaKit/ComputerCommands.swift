...
public enum AforaComputerCommand: String, Codable, Sendable {
...
public enum AforaComputerAction: String, Codable, CaseIterable, Sendable {
    case screenshot
...
public enum AforaComputerScrollDirection: String, Codable, Sendable {
    case up
    case down
    case left
    case right
...
public enum AforaComputerDeliveryMode: String, Codable, Sendable {
    case background
    case foreground
}

public enum AforaComputerEscalationReason: String, Codable, Sendable {
...
public struct AforaComputerActParams: Codable, Sendable, Equatable {
    public var action: AforaComputerAction
    ...
    public var scrollDirection: AforaComputerScrollDirection?
    ...
    public var deliveryMode: AforaComputerDeliveryMode?
    ...
    public var reason: AforaComputerEscalationReason?
    ...
    public init(
        ...
        scrollDirection: AforaComputerScrollDirection? = nil,
        ...
        deliveryMode: AforaComputerDeliveryMode? = nil,
        query: String? = nil,
        depth: Int? = nil,
        maxElements: Int? = nil,
        app: String? = nil,
        ...
        x2: Double? = nil,
        y2: Double? = nil,
        reason: AforaComputerEscalationReason? = nil)
    {
        self.action = action
...
public enum AforaComputerActionEffect: String, Codable, Sendable {
    case confirmed
    case unverifiable
    case suspectedNoop = "suspected_noop"
}

public struct AforaComputerBounds: Codable, Sendable, Equatable {
    public var x: Double
    public var y: Double
...
public struct AforaComputerObservationElement: Codable, Sendable, Equatable {
    public var elementRef: String
    public var role: String
    public var label: String?
    public var value: String?
    public var bounds: AforaComputerBounds
...
public struct AforaComputerObservation: Codable, Sendable, Equatable {
    ...
    public var observationId: String?
    public var elements: [AforaComputerObservationElement]?
    ...
    public init(
        ...
        height: Int? = nil,
        observationId: String? = nil,
        elements: [AforaComputerObservationElement]? = nil)
    {
        self.kind = kind
        self.base64 = base64
        self.format = format
...
public struct AforaComputerEscalation: Codable, Sendable, Equatable {
...
public struct AforaComputerActResult: Codable, Sendable, Equatable {
    public var ok: Bool
    public var cursorX: Double?
    public var cursorY: Double?
    public var effect: AforaComputerActionEffect?
    public var observation: AforaComputerObservation?
    public var escalation: AforaComputerEscalation?
    ...
    public init(
        ok: Bool,
        effect: AforaComputerActionEffect? = nil,
        observation: AforaComputerObservation? = nil,
        escalation: AforaComputerEscalation? = nil,
