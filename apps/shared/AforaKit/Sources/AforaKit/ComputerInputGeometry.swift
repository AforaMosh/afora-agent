...
public struct AforaComputerDisplayGeometry: Sendable, Equatable {
...
public enum AforaComputerInputGeometry {
    ...
    public static func displayFrameId(
        ...
        sourceHeight: Double,
        referenceWidth: Int,
        display: AforaComputerDisplayGeometry) -> String
    {
        let descriptor = [
            String(displayID),
    ...
    public static func isValidMappingGeometry(
        sourceWidth: Double,
        sourceHeight: Double,
        display: AforaComputerDisplayGeometry) -> Bool
    {
    ...
    public static func mapReferencePointToGlobal(
        ...
        display: AforaComputerDisplayGeometry) -> (x: Double, y: Double)
    {
