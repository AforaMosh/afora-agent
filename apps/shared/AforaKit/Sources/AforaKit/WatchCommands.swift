...
public enum AforaWatchCommand: String, Codable, Sendable {
    case status = "watch.status"
    case notify = "watch.notify"
}

public enum AforaWatchPayloadType: String, Codable, Sendable, Equatable {
    case notify = "watch.notify"
...
public enum AforaWatchRisk: String, Codable, Sendable, Equatable {
    case low
    case medium
    case high
}

public enum AforaWatchExecApprovalDecision: String, Codable, Sendable, Equatable {
    case allowOnce = "allow-once"
    case deny
}

public enum AforaWatchExecApprovalCloseReason: String, Codable, Sendable, Equatable {
    case expired
...
public struct AforaWatchAction: Codable, Sendable, Equatable, Identifiable {
...
public struct AforaWatchExecApprovalItem: Codable, Sendable, Equatable, Identifiable {
    public var id: String
    ...
    public var allowedDecisions: [AforaWatchExecApprovalDecision]
    public var risk: AforaWatchRisk?
    ...
    public init(
        ...
        allowedDecisions: [AforaWatchExecApprovalDecision] = [],
        risk: AforaWatchRisk? = nil)
    {
        self.id = id
...
public struct AforaWatchExecApprovalPromptMessage: Codable, Sendable, Equatable {
    public var type: AforaWatchPayloadType
    public var approval: AforaWatchExecApprovalItem
    public var sentAtMs: Int64?
    public var resetResolutionAttemptId: String?

    public init(
        approval: AforaWatchExecApprovalItem,
        sentAtMs: Int64? = nil,
...
public struct AforaWatchExecApprovalResolveMessage: Codable, Sendable, Equatable {
    public var type: AforaWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var decision: AforaWatchExecApprovalDecision
...
public enum AforaWatchExecApprovalOutcome: String, Codable, Sendable, Equatable {
    case allowedOnce
    case allowedAlways
    case denied
}

public struct AforaWatchExecApprovalResolvedMessage: Codable, Sendable, Equatable {
    public var type: AforaWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var decision: AforaWatchExecApprovalDecision?
    public var outcome: AforaWatchExecApprovalOutcome?
    ...
    public init(
        approvalId: String,
        gatewayStableID: String? = nil,
        decision: AforaWatchExecApprovalDecision? = nil,
        outcome: AforaWatchExecApprovalOutcome? = nil,
...
public struct AforaWatchExecApprovalExpiredMessage: Codable, Sendable, Equatable {
    public var type: AforaWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var reason: AforaWatchExecApprovalCloseReason
...
public struct AforaWatchExecApprovalSnapshotMessage: Codable, Sendable, Equatable {
    public var type: AforaWatchPayloadType
    public var approvals: [AforaWatchExecApprovalItem]
    public var gatewayStableID: String?
    public var sentAtMs: Int64?
    ...
    public init(
        approvals: [AforaWatchExecApprovalItem],
        gatewayStableID: String? = nil,
        sentAtMs: Int64? = nil,
...
public struct AforaWatchExecApprovalSnapshotRequestItem: Codable, Sendable, Equatable {
    public var approvalId: String
...
public struct AforaWatchExecApprovalSnapshotRequestMessage: Codable, Sendable, Equatable {
    public var type: AforaWatchPayloadType
    public var requestId: String
    public var sentAtMs: Int64?
    public var gatewayStableID: String?
    public var heldApprovals: [AforaWatchExecApprovalSnapshotRequestItem]

    public init(
        requestId: String,
        sentAtMs: Int64? = nil,
        gatewayStableID: String? = nil,
        heldApprovals: [AforaWatchExecApprovalSnapshotRequestItem] = [])
    {
...
public struct AforaWatchChatItem: Codable, Sendable, Equatable, Identifiable {
    public var id: String
...
public struct AforaWatchChatCompletionMessage: Codable, Sendable, Equatable {
    public var type: AforaWatchPayloadType
...
public enum AforaWatchAppStatusCode: String, Codable, Sendable, Equatable {
...
public struct AforaWatchAppStatus: Codable, Sendable, Equatable {
    public var code: AforaWatchAppStatusCode
    public var localizationKey: String?
    public var arguments: [String]
    public var verbatim: String?

    public init(
        code: AforaWatchAppStatusCode,
...
public struct AforaWatchAppSnapshotMessage: Codable, Sendable, Equatable {
    public var type: AforaWatchPayloadType
    public var gatewayStatus: AforaWatchAppStatus
    ...
    public var gatewayStableID: String?
    public var talkStatus: AforaWatchAppStatus
    ...
    public var chatItems: [AforaWatchChatItem]?
    public var chatStatus: AforaWatchAppStatus?
    public var chatStatusText: String?
    public var sentAtMs: Int64?
    public var snapshotId: String?

    public init(
        gatewayStatus: AforaWatchAppStatus,
        ...
        sessionKey: String,
        gatewayStableID: String? = nil,
        talkStatus: AforaWatchAppStatus,
        talkStatusText: String,
        talkEnabled: Bool,
        talkListening: Bool,
        talkSpeaking: Bool,
        pendingApprovalCount: Int,
        chatItems: [AforaWatchChatItem]? = nil,
        chatStatus: AforaWatchAppStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(AforaWatchPayloadType.self, forKey: .type)
        ...
        self.chatItems = try container.decodeIfPresent([AforaWatchChatItem].self, forKey: .chatItems)
        ...
        {
            self.gatewayStatus = AforaWatchAppStatus(
                code: .legacy,
        ...
        {
            self.talkStatus = AforaWatchAppStatus(
                code: .legacy,
    ...
    private static func decodeLegacyGatewayStatus(
        text: String?,
        connected: Bool) -> AforaWatchAppStatus
    {
        if connected {
        ...
        return AforaWatchAppStatus(code: .legacy, verbatim: text)
    }
    ...
    private static func decodeLegacyTalkStatus(
        ...
        enabled: Bool,
        listening: Bool,
        speaking: Bool) -> AforaWatchAppStatus
    {
        if speaking {
        ...
        guard let text, !text.isEmpty else {
            return AforaWatchAppStatus(code: .talkReady)
        }
        return AforaWatchAppStatus(code: .legacy, verbatim: text)
    }
    ...
    private static func decodeLegacyChatStatus(
        code: String?,
        text: String?) -> AforaWatchAppStatus?
    {
        let statusCode: AforaWatchAppStatusCode? = switch code {
        case "connectIPhone":
            AforaWatchAppStatusCode.chatConnectIPhone
        case "noMessages":
            AforaWatchAppStatusCode.chatNoMessages
        case "unavailable":
            AforaWatchAppStatusCode.chatUnavailable
        default:
            nil
        }
        if let statusCode {
            return AforaWatchAppStatus(code: statusCode)
        }
        guard let text, !text.isEmpty else { return nil }
        return AforaWatchAppStatus(code: .legacy, verbatim: text)
    }

    private static func legacyText(for status: AforaWatchAppStatus) -> String {
    ...
    private static func legacyGatewayText(for code: AforaWatchAppStatusCode) -> String {
        switch code {
    ...
    private static func legacyTalkText(for code: AforaWatchAppStatusCode) -> String {
        switch code {
        case .talkOff: "Off"
    ...
    private static func legacyChatText(for code: AforaWatchAppStatusCode) -> String {
        switch code {
...
public struct AforaWatchAppSnapshotRequestMessage: Codable, Sendable, Equatable {
    public var type: AforaWatchPayloadType
    public var requestId: String
    public var sentAtMs: Int64?
...
public enum AforaWatchAppCommand: String, Codable, Sendable, Equatable {
    case refresh
...
public struct AforaWatchAppCommandMessage: Codable, Sendable, Equatable {
    public var type: AforaWatchPayloadType
    public var command: AforaWatchAppCommand
    public var commandId: String
    public var sessionKey: String?
    public var gatewayStableID: String?
    public var text: String?
...
public struct AforaWatchStatusPayload: Codable, Sendable, Equatable {
...
public struct AforaWatchNotifyParams: Codable, Sendable, Equatable {
    ...
    public var expiresAtMs: Int64?
    public var risk: AforaWatchRisk?
    public var actions: [AforaWatchAction]?
...
public struct AforaWatchNotifyPayload: Codable, Sendable, Equatable {
