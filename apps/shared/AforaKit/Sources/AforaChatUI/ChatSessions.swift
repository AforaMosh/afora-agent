...
public struct AforaChatSessionAgentStatus: Codable, Sendable, Hashable {
    public let note: String
    public let expiresAt: Double
    public let attention: String?
}

public struct AforaChatSessionObserverDigest: Codable, Sendable, Hashable {
...
public struct AforaChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public enum AforaChatFastMode: Sendable, Equatable, Hashable, Codable {
    case off
    case on
    case automatic
...
public struct AforaChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct AforaChatSessionSettingsPatch: Sendable, Equatable {
    /// Outer optional means unchanged; inner optional clears the override.
    public let model: String??
    public let thinkingLevel: String??
    public let fastMode: AforaChatFastMode??
...
public struct AforaChatModelPatchResult: Decodable, Sendable, Equatable {
    public let key: String?
    public let modelProvider: String?
    public let model: String?
    public let thinkingLevel: String?
    public let thinkingLevels: [AforaChatThinkingLevelOption]?
    public let fastMode: AforaChatFastMode?
    public let effectiveFastMode: AforaChatFastMode?
    public let verboseLevel: String?
    ...
    public init(from decoder: Decoder) throws {
        ...
        let entryFastMode = try entry.decodeIfPresent(AforaChatFastMode.self, forKey: .fastMode)
        let entryEffectiveFastMode = try entry.decodeIfPresent(
            AforaChatFastMode.self,
        ...
        if container.contains(.resolved) {
            ...
            self.thinkingLevels = try resolved.decodeIfPresent(
                [AforaChatThinkingLevelOption].self,
                forKey: .thinkingLevels)
            self.fastMode = try resolved.decodeIfPresent(AforaChatFastMode.self, forKey: .fastMode)
                ?? entryFastMode
...
public struct AforaChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
...
public struct AforaChatSessionWorktree: Codable, Sendable, Hashable {
    public let id: String?
...
public struct AforaChatAgentRuntime: Codable, Sendable, Hashable {
    public let id: String
    public let fallback: String?
    public let source: String?
}

public struct AforaChatSessionGroup: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.name
    }
...
public struct AforaChatSessionGroupsResponse: Codable, Sendable, Equatable {
    public let groups: [AforaChatSessionGroup]
}

public struct AforaChatSessionGroupsMutationResponse: Codable, Sendable, Equatable {
    public let ok: Bool
    public let groups: [AforaChatSessionGroup]
    public let updatedSessions: Int?
}

public struct AforaChatAgentChoice: Codable, Identifiable, Sendable, Hashable {
    public let id: String
    public let name: String?
...
public struct AforaChatAgentsListResponse: Codable, Sendable, Equatable {
    public let defaultId: String
    public let agents: [AforaChatAgentChoice]

    public init(defaultId: String, agents: [AforaChatAgentChoice]) {
        self.defaultId = defaultId
        self.agents = agents
    }
}

public struct AforaChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
    ...
    public var agentStatus: AforaChatSessionAgentStatus?
    public var observerDigest: AforaChatSessionObserverDigest?
    ...
    public var worktree: AforaChatSessionWorktree?
    public var startedAt: Double?
    public var endedAt: Double?
    public var runtimeMs: Double?
    public var agentRuntime: AforaChatAgentRuntime?

    public var systemSent: Bool?
    public var abortedLastRun: Bool?
    public var thinkingLevel: String?
    public var verboseLevel: String?
    public var fastMode: AforaChatFastMode?
    public var effectiveFastMode: AforaChatFastMode?
    ...
    public var thinkingLevels: [AforaChatThinkingLevelOption]?
    ...
    public init(
        ...
        swarmLog: String? = nil,
        worktree: AforaChatSessionWorktree? = nil,
        fastMode: AforaChatFastMode? = nil,
        effectiveFastMode: AforaChatFastMode? = nil,
        startedAt: Double? = nil,
        endedAt: Double? = nil,
        runtimeMs: Double? = nil,
        agentRuntime: AforaChatAgentRuntime? = nil,
...
public enum AforaChatSessionListOrganizer {
    public static func organize(_ sessions: [AforaChatSessionEntry]) -> [AforaChatSessionEntry] {
    ...
    public static func filter(
        ...
        search: String) -> [AforaChatSessionEntry]
    {
...
public enum AforaChatChildSessionPager {
    private static let maxCollectedSessions = 100_000
    private static let maxPageRequests = 100

    public static func collect(
        fetchPage: (Int) async throws -> AforaChatSessionsListResponse) async throws
        -> [AforaChatSessionEntry]
    {
        var rowsByKey: [String: AforaChatSessionEntry] = [:]
...
public struct AforaChatSessionsListResponse: Codable, Sendable {
    ...
    public let defaults: AforaChatSessionsDefaults?
    public let sessions: [AforaChatSessionEntry]
