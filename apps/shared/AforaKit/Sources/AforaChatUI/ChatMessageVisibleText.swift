...
public enum ChatMessageVisibleText {
    ...
    static func copyText(in message: AforaChatMessage) -> String {
        let role = message.role.trimmingCharacters(in: .whitespacesAndNewlines).lowercased()
        return role == "assistant" ? self.visibleText(in: message) : self.primaryText(in: message)
    }

    public static func visibleText(in message: AforaChatMessage) -> String {
    ...
    static func hasVisibleText(in message: AforaChatMessage) -> Bool {
        !self.visibleText(in: message)
            .trimmingCharacters(in: .whitespacesAndNewlines)
            .isEmpty
    }

    static func displayText(in message: AforaChatMessage, includeThinking: Bool) -> String {
        ...
        return AforaChatMessage.displayText(
    ...
    private static func primaryText(in message: AforaChatMessage) -> String {
