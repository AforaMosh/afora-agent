...
/// panel keeps using `AforaChatView` directly; this shell is the full
/// window experience.
@MainActor
public struct AforaChatWindowShell: View {
    public nonisolated static let assistantTraceDefaultsKey = "afora.webchat.showAssistantTrace"
    public nonisolated static let assistantReasoningDefaultsKey = "afora.webchat.showAssistantReasoning"
    public nonisolated static let assistantToolActivityDefaultsKey = "afora.webchat.showAssistantToolActivity"
    ...
    private let emptyAssistantPrompts: [AforaChatView.StarterPrompt]
    ...
    public init(
        ...
        emptyAssistantPrompts: [AforaChatView.StarterPrompt] = [],
    ...
    private var activeSessionEntry: AforaChatSessionEntry? {
...
private struct ChatContextUsageMenu: View {
    let usage: AforaChatContextUsage
    let onCompact: () -> Void

    var body: some View {
        Menu {
            Text(self.tokensLine)
                .font(AforaChatTypography.body(size: 13, weight: .regular, relativeTo: .body))
