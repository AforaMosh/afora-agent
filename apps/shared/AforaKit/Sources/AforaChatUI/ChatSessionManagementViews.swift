...
struct ChatSessionInspectorDetails: Equatable {
    ...
    private static func runState(for session: AforaChatSessionEntry) -> String? {
...
struct ChatSessionInspectorSheet: View {
    ...
    @State private var displayedSession: AforaChatSessionEntry
    @State private var groups: [AforaChatSessionGroup] = []
    @State private var isMutatingGroup = false
    @State private var errorText: String?

    init(viewModel: AforaChatViewModel, session: AforaChatSessionEntry) {
...
struct ChatSessionGroupsSheet: View {
    ...
    @State private var renameTarget: AforaChatSessionGroup?
    @State private var renameText = ""
    @State private var deleteTarget: AforaChatSessionGroup?
    @State private var routeLease: AforaChatSessionGroupsRouteLease?
    ...
    private func renameGroup(_ target: AforaChatSessionGroup, to name: String) async {
        defer { self.isMutating = false }
    ...
    private func deleteGroup(_ target: AforaChatSessionGroup) async {
        defer { self.isMutating = false }
...
public struct ChatNewSessionOptionsPopover: View {
    ...
    @State private var agents: [AforaChatAgentChoice] = []
    @State private var selectedAgentID = ""
    @State private var usesWorktree = false
    @State private var baseRef = ""
    @State private var isLoading = true
    @State private var isCreating = false
    @State private var routeLease: AforaChatNewSessionRouteLease?
    @State private var errorText: String?

    public init(viewModel: AforaChatViewModel, onComplete: @escaping () -> Void) {
        self.viewModel = viewModel
        self.onComplete = onComplete
    }

    private var selectedAgent: AforaChatAgentChoice? {
    ...
    public var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            Text("New Thread Options")
                .font(AforaChatTypography.body(size: 15, weight: .semibold, relativeTo: .headline))
