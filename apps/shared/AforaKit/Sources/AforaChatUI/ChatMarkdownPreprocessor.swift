...
enum ChatMarkdownPreprocessor {
    ...
    private static let inboundContextMarker = "\u{27E6}afora:ctx\u{27E7}"
    ...
    private static func inlineImage(label: String, source: String) -> InlineImage? {
        ...
        let image = Data(base64Encoded: b64).flatMap(AforaPlatformImage.init(data:))
