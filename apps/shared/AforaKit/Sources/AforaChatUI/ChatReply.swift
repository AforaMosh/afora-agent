...
public struct AforaChatReplyTarget: Equatable, Sendable {
...
enum ChatReplyQuote {
    ...
    static func prepend(message: String, replyTarget: AforaChatReplyTarget) -> String {
...
extension AforaChatViewModel {
    ...
    func setReplyTarget(messageID: UUID, text: String, senderLabel: String) {
        ...
        self.replyTarget = AforaChatReplyTarget(
            messageID: messageID,
            text: text,
    ...
    func consumeReplyTarget(_ target: AforaChatReplyTarget?) {
