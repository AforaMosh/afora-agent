...
public typealias AforaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AforaPlatformImage = UIImage
#endif

public enum AforaChatCommandFilter: String, CaseIterable, Sendable {
    case all = "All"
    case commands = "Commands"
    case skills = "Skills"
}

public struct AforaChatCommandChoice: Identifiable, Hashable, Sendable {
...
public struct AforaChatUsageCost: Codable, Hashable, Sendable {
...
public struct AforaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AforaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AforaChatUsageCost.self, forKey: .cost)
        self.total =
...
public enum AforaChatPlaybackMode: String, Codable, Hashable, Sendable {
    case native
    case transcode
}

public struct AforaChatMessageContent: Codable, Hashable, Sendable {
    ...
    public let playback: AforaChatPlaybackMode?
    public let content: AnyCodable?
    public let preview: AforaChatCanvasPreview?
    ...
    var mediaKind: AforaChatMediaKind? {
    ...
    public init(
        ...
        content: AnyCodable?,
        preview: AforaChatCanvasPreview? = nil,
        id: String? = nil,
        name: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.playback = try container.decodeIfPresent(AforaChatPlaybackMode.self, forKey: .playback)
        ...
        self.preview = try container.decodeIfPresent(AforaChatCanvasPreview.self, forKey: .preview)
...
public struct AforaChatCanvasPreview: Codable, Hashable, Sendable {
    ...
    public var inlineWidgetPath: String? {
        guard self.kind == "canvas",
              ...
              AforaChatWidgetURLResolver.supportsTarget(url)
        else { return nil }
        return url
    }
...
public struct AforaChatInputProvenance: Codable, Hashable, Sendable {
    public let kind: String
...
public struct AforaChatHistoryMarker: Codable, Hashable, Sendable {
    public let kind: String
    public let id: String?
...
public struct AforaChatMessage: Codable, Hashable, Identifiable, Sendable {
    private struct AforaMetadata: Codable {
        let kind: String?
        let id: String?
    ...
    public let content: [AforaChatMessageContent]
    public let timestamp: Double?
    public let idempotencyKey: String?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AforaChatUsage?
    public let stopReason: String?
    public let errorMessage: String?
    public let details: AnyCodable?
    public let isError: Bool?
    public let provenance: AforaChatInputProvenance?
    public let historyMarker: AforaChatHistoryMarker?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AforaChatMessageContent],
        timestamp: Double?,
        ...
        toolName: String? = nil,
        usage: AforaChatUsage? = nil,
        stopReason: String? = nil,
        errorMessage: String? = nil,
        details: AnyCodable? = nil,
        isError: Bool? = nil,
        provenance: AforaChatInputProvenance? = nil,
        historyMarker: AforaChatHistoryMarker? = nil)
    {
        self.id = id
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedAfora = try container.decodeIfPresent(AforaMetadata.self, forKey: .afora)
        let decodedIdempotencyKey = try decodedAfora?.idempotencyKey ??
        ...
        let decodedUsage = try container.decodeIfPresent(AforaChatUsage.self, forKey: .usage)
        ...
        let decodedProvenance = try? container.decode(
            AforaChatInputProvenance.self,
            forKey: .provenance)

        self.role = decodedRole
        self.transcriptMessageID = decodedAfora?.id
        ...
        self.historyMarker = decodedAfora?.kind.map {
            AforaChatHistoryMarker(
                kind: $0,
                id: decodedAfora?.id,
                tokensBefore: decodedAfora?.tokensBefore,
                tokensAfter: decodedAfora?.tokensAfter)
        }

        let decodedContent: [AforaChatMessageContent] = if let decoded = try? container.decode(
            [AforaChatMessageContent].self,
            forKey: .content)
        {
            decoded
        ...
        let audioAttachments: [AforaChatMessageContent] = alreadyContainsAudio ? [] : mediaPaths
            .enumerated()
            .compactMap { index, mediaPath in
                ...
                return AforaChatMessageContent(
                    type: "file",
                    text: nil,
                    mimeType: mimeType,
        ...
        self.isTruncated = decodedAfora?.truncated == true || decodedContent.contains { content in
...
public struct AforaChatInFlightRun: Codable, Sendable {
    public let runId: String
    public let text: String
    public let plan: AforaChatPlanSnapshot?

    // periphery:ignore - package tests construct history fixtures; app consumers decode this payload.
    public init(runId: String, text: String, plan: AforaChatPlanSnapshot? = nil) {
        self.runId = runId
        self.text = text
        self.plan = plan
    }
...
public struct AforaChatPlanSnapshot: Codable, Sendable {
    public let steps: [AforaChatPlanStep]
    public let explanation: String?

    // periphery:ignore - package tests construct history fixtures; app consumers decode this payload.
    public init(steps: [AforaChatPlanStep], explanation: String? = nil) {
        self.steps = steps
        self.explanation = explanation
    }
}

public struct AforaChatSessionInfo: Codable, Sendable {
...
public struct AforaChatHistoryPayload: Codable, Sendable {
    public let sessionKey: String
    public let sessionId: String?
    public let messages: [AnyCodable]?
    public let thinkingLevel: String?
    public let sessionInfo: AforaChatSessionInfo?
    public let inFlightRun: AforaChatInFlightRun?
    ...
    public init(
        ...
        sessionInfo: AforaChatSessionInfo? = nil,
        inFlightRun: AforaChatInFlightRun? = nil)
    {
...
public struct AforaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AforaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AforaSessionPreviewItem]
}

public struct AforaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AforaSessionPreviewEntry]

    public init(ts: Int, previews: [AforaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AforaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AforaChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct AforaChatEditorAttachment: Codable, Sendable {
    public let mimeType: String
    public let data: String
}

public struct AforaChatRewindResponse: Codable, Sendable {
    public let editorText: String?
    public let editorAttachments: [AforaChatEditorAttachment]?
}

public struct AforaChatForkAtMessageResponse: Codable, Sendable {
    public let sessionKey: String
    public let editorText: String?
    public let editorAttachments: [AforaChatEditorAttachment]?
}

public struct AforaChatSessionBranch: Codable, Sendable, Equatable, Identifiable {
...
public struct AforaChatSessionBranchesResponse: Codable, Sendable {
    public let branches: [AforaChatSessionBranch]

    // periphery:ignore - package tests construct branch fixtures; app consumers decode them.
    public init(branches: [AforaChatSessionBranch]) {
        self.branches = branches
    }
}

public struct AforaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AforaSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: AforaChatMessage?
...
public struct AforaAgentEventPayload: Codable, Sendable, Identifiable {
    public var id: String {
...
public struct AforaChatPlanStep: Codable, Hashable, Sendable {
...
public struct AforaChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct AforaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AforaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AforaPlatformImage?
    public let durationSeconds: Double?
...
public struct AforaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
