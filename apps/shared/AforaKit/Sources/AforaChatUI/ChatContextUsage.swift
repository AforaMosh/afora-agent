...
public struct AforaChatContextUsage: Equatable, Sendable {
...
enum ChatContextUsageCalculator {
    ...
    static func usage(
        ...
        sessionEntry: AforaChatSessionEntry?,
        defaults: AforaChatSessionsDefaults?,
        modelContextWindow: Int?) -> AforaChatContextUsage?
    {
    ...
    private static func latestRunTokens(in messages: [AforaChatMessage]) -> Int? {
    ...
    private static func totalCost(in messages: [AforaChatMessage]) -> Double? {
...
extension AforaChatViewModel {
    public var contextUsage: AforaChatContextUsage? {
    ...
    private func selectedModelContextWindow(sessionEntry: AforaChatSessionEntry?) -> Int? {
