...
public enum ChatTranscriptExporter {
    ...
    public static func markdown(
        sessionTitle: String?,
        sessionKey: String,
        messages: [AforaChatMessage]) -> String
    {
    ...
    private static func shouldExport(_ message: AforaChatMessage) -> Bool {
    ...
    private static func body(for message: AforaChatMessage) -> String {
        var parts: [String] = []
        let text = self.visibleText(in: message)
        if !text.isEmpty {
            parts.append(text)
    ...
    private static func visibleText(in message: AforaChatMessage) -> String {
        ChatMessageVisibleText.visibleText(in: message)
    }

    private static func attachments(in message: AforaChatMessage) -> [AforaChatMessageContent] {
