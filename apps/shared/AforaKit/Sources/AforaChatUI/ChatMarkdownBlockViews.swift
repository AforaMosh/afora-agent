...
struct ChatMathBlockView: View {
    ...
    @ScaledMetric(relativeTo: .body) private var fontSize: CGFloat = AforaChatTypography.bodySize
...
struct ChatMarkdownTableView: View {
    ...
    private func cell(_ text: String, isHeader: Bool) -> some View {
        Text(self.inlineMarkdown(text))
            .font(isHeader ? AforaChatTypography.footnoteSemiBold : AforaChatTypography.footnote)
            .foregroundStyle(AforaChatTheme.assistantText)
            .textSelection(.enabled)
    }
