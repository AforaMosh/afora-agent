...
public enum AforaChatTransportEvent: Sendable {
    case health(ok: Bool)
    case tick
    case sessionsChanged(AforaChatSessionsChangedEvent)
    case sessionObserver(SessionObserverDigest)
    case chat(AforaChatEventPayload)
    case sessionMessage(AforaSessionMessageEventPayload)
    case agent(AforaAgentEventPayload)
    case task(AforaChatTaskEvent)
    case questionRequested(QuestionRecord)
    case questionResolved(AforaQuestionResolvedEvent)
    case routeChanged
    case seqGap
}

public enum AforaChatTaskEvent: Sendable, Decodable {
...
public struct AforaQuestionResolvedEvent: Codable, Sendable {
...
public struct AforaChatSessionsChangedEvent: Codable, Sendable, Equatable {
    ...
    public let session: AforaChatSessionEntry?
    public let updatedAt: Double?
    public let lastReadAt: Double?
    public let agentStatus: AforaChatSessionAgentStatus?
    public let observerDigest: AforaChatSessionObserverDigest?
    ...
    public init(
        ...
        phase: String? = nil,
        runId: String? = nil,
        session: AforaChatSessionEntry? = nil,
        updatedAt: Double? = nil,
        lastReadAt: Double? = nil,
        agentStatus: AforaChatSessionAgentStatus? = nil,
        observerDigest: AforaChatSessionObserverDigest? = nil,
        status: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.session = try container.decodeIfPresent(AforaChatSessionEntry.self, forKey: .session)
        ...
        self.agentStatus = try decode(AforaChatSessionAgentStatus.self, forKey: .agentStatus)
        self.observerDigest = try decode(AforaChatSessionObserverDigest.self, forKey: .observerDigest)
...
public struct AforaChatTransportRouteLease: Sendable {
    public typealias SendMessage = @Sendable (
        _ sessionKey: String,
        _ message: String,
        _ thinking: String,
        _ idempotencyKey: String,
        _ attachments: [AforaChatAttachmentPayload]) async throws -> AforaChatSendResponse
    public typealias RequestHistory = @Sendable (String) async throws -> AforaChatHistoryPayload
    ...
    public typealias RequestTargetedHistory = @Sendable (
        _ sessionKey: String,
        _ agentID: String?) async throws -> AforaChatHistoryPayload
    ...
    public func requestHistory(
        sessionKey: String,
        agentID: String? = nil) async throws -> AforaChatHistoryPayload
    {
        try await self.requestTargetedHistoryImpl(sessionKey, agentID)
    }
}

public enum AforaChatTransportRouteLeaseResult: Sendable {
    case available(AforaChatTransportRouteLease)
...
public struct AforaChatSessionSettingsRouteLease: Sendable {
    public typealias PatchSessionSettings = @Sendable (
        _ sessionKey: String,
        _ agentID: String?,
        _ patch: AforaChatSessionSettingsPatch) async throws -> AforaChatModelPatchResult?
...
public struct AforaChatSessionMutationRouteLease: Sendable {
...
public struct AforaChatSessionGroupsRouteLease: Sendable {
    public typealias ListGroups = @Sendable () async throws -> AforaChatSessionGroupsResponse?
    public typealias PutGroups = @Sendable ([String]) async throws -> AforaChatSessionGroupsMutationResponse
    public typealias RenameGroup = @Sendable (String, String) async throws -> AforaChatSessionGroupsMutationResponse
    public typealias DeleteGroup = @Sendable (String) async throws -> AforaChatSessionGroupsMutationResponse
    ...
    public func listGroups() async throws -> AforaChatSessionGroupsResponse? {
        try await self.listGroupsImpl()
    }

    public func putGroups(names: [String]) async throws -> AforaChatSessionGroupsMutationResponse {
        try await self.putGroupsImpl(names)
    }

    public func renameGroup(name: String, to: String) async throws -> AforaChatSessionGroupsMutationResponse {
        try await self.renameGroupImpl(name, to)
    }

    public func deleteGroup(name: String) async throws -> AforaChatSessionGroupsMutationResponse {
...
public struct AforaChatNewSessionRouteLease: Sendable {
    public typealias ListAgents = @Sendable () async throws -> AforaChatAgentsListResponse?
    public typealias CreateSession = @Sendable (
        ...
        _ worktree: Bool?,
        _ worktreeBaseRef: String?) async throws -> AforaChatCreateSessionResponse
    ...
    public func listAgents() async throws -> AforaChatAgentsListResponse? {
...
public enum AforaChatTransportSendError: Error, Sendable {
    case notDispatched
}

public enum AforaChatTransportUpgradeMessage {
...
public enum AforaChatRunTerminalState: Sendable, Equatable {
    case completed
    case failed(message: String)
}

public enum AforaChatRunObservation: Sendable, Equatable {
    case terminal(AforaChatRunTerminalState)
    case checkAgain
    case unavailable
...
public struct AforaChatMetadataCapabilities: Codable, Sendable, Equatable {
...
public enum AforaChatMediaKind: String, Sendable {
    case image
    case audio
    case video
...
public struct AforaChatMediaData: Sendable {
...
public struct AforaChatMediaStream: Sendable {
    public let url: URL
    public let mimeType: String?
...
public enum AforaChatLoadedMedia: Sendable {
    case data(AforaChatMediaData)
    case stream(AforaChatMediaStream)
    case preparing
}
...
public struct AforaChatSwarmRouteLease: Sendable {
    public typealias IsEnabled = @Sendable (_ sessionKey: String) async throws -> Bool
    public typealias ListChildSessions = @Sendable (_ parentKey: String) async throws -> [AforaChatSessionEntry]
    ...
    public func listChildSessions(parentKey: String) async throws -> [AforaChatSessionEntry] {
        try await self.listChildSessionsImpl(parentKey)
    }
}

public protocol AforaChatTransport: Sendable {
    func createSession(
        key: String,
        label: String?,
        parentSessionKey: String?,
    ...
    func requestFullMessage(sessionKey: String, messageID: String) async throws -> AforaChatMessage?
    ...
    func listAgents() async throws -> AforaChatAgentsListResponse?
    func acquireNewSessionRouteLease() async -> AforaChatNewSessionRouteLease?
    func listSessionGroups() async throws -> AforaChatSessionGroupsResponse?
    func putSessionGroups(names: [String]) async throws -> AforaChatSessionGroupsMutationResponse
    func renameSessionGroup(name: String, to: String) async throws -> AforaChatSessionGroupsMutationResponse
    func deleteSessionGroup(name: String) async throws -> AforaChatSessionGroupsMutationResponse
    ...
    func rewindSession(sessionKey: String, entryId: String) async throws -> AforaChatRewindResponse
    ...
    func waitForRunCompletion(runId: String, timeoutMs: Int) async -> AforaChatRunObservation
...
extension AforaChatTransport {
    public func loadMediaArtifact(
        sessionKey _: String,
        artifactId _: String,
        kind _: AforaChatMediaKind,
        playback _: AforaChatPlaybackMode?) async throws -> AforaChatLoadedMedia?
    {
        nil
    }
    ...
    public func acquireSwarmRouteLease() async -> AforaChatSwarmRouteLease? {
        let transport = self
    ...
    public func requestFullMessage(sessionKey _: String, messageID _: String) async throws -> AforaChatMessage? {
        nil
    }
        ...
        replacing failedResource: AforaChatWidgetResource?) async -> AforaChatWidgetResource?
    {
        ...
        return AforaChatWidgetResource(url: url)
    }
    ...
    public func acquireOutboxRouteLease() async -> AforaChatTransportRouteLeaseResult {
        let transport = self
    ...
    public func acquireSessionSettingsRouteLease() async -> AforaChatSessionSettingsRouteLease? {
        let transport = self
    ...
    public func acquireSessionMutationRouteLease() async -> AforaChatSessionMutationRouteLease? {
        let transport = self
    ...
    public func acquireSessionGroupsRouteLease() async -> AforaChatSessionGroupsRouteLease? {
        let transport = self
    ...
    public func acquireNewSessionRouteLease() async -> AforaChatNewSessionRouteLease? {
        let transport = self
    ...
    public func waitForRunCompletion(runId _: String, timeoutMs _: Int) async -> AforaChatRunObservation {
        .unavailable
    }
    ...
    public func listChildSessions(parentKey _: String) async throws -> [AforaChatSessionEntry] {
        []
    }
    ...
    public func listSessions(limit: Int?) async throws -> AforaChatSessionsListResponse {
        try await self.listSessions(limit: limit, search: nil, archived: false)
    }

    public func listSessions(limit: Int?, archived: Bool) async throws -> AforaChatSessionsListResponse {
    ...
    public func listSessionGroups() async throws -> AforaChatSessionGroupsResponse? {
        nil
    }

    public func putSessionGroups(names _: [String]) async throws -> AforaChatSessionGroupsMutationResponse {
        throw NSError(
            domain: "AforaChatTransport",
            code: 0,
    ...
    public func renameSessionGroup(
        name _: String,
        to _: String) async throws -> AforaChatSessionGroupsMutationResponse
    {
        throw NSError(
            domain: "AforaChatTransport",
            code: 0,
    ...
    public func deleteSessionGroup(name _: String) async throws -> AforaChatSessionGroupsMutationResponse {
        throw NSError(
            domain: "AforaChatTransport",
            code: 0,
    ...
    public func rewindSession(
        sessionKey _: String,
        entryId _: String) async throws -> AforaChatRewindResponse
    {
        throw NSError(
            domain: "AforaChatTransport",
            code: 0,
    ...
    public func forkSessionAtMessage(
        sessionKey _: String,
        entryId _: String) async throws -> AforaChatForkAtMessageResponse
    {
        throw NSError(
            domain: "AforaChatTransport",
            code: 0,
    ...
    public func listSessionBranches(
        sessionKey _: String,
        agentID _: String?) async throws -> AforaChatSessionBranchesResponse
    {
        throw NSError(
            domain: "AforaChatTransport",
            code: 0,
    ...
    public func listModels() async throws -> [AforaChatModelChoice] {
        throw NSError(
            domain: "AforaChatTransport",
            code: 0,
    ...
    public func listCommands(sessionKey _: String) async throws -> [AforaChatCommandChoice] {
        []
    }
...
public enum AforaChatSessionRoutingContract {
