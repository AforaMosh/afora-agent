...
public struct AforaChatGatewayRequest: Sendable, Equatable {
...
public enum AforaChatSessionTargetPolicy: Sendable {
    case preserveBareKeys
    case scopeBareKeysToSelectedAgent
}

public struct AforaChatSessionTarget: Sendable, Equatable {
    ...
    public static func resolve(
        ...
        policy: AforaChatSessionTargetPolicy) -> Self
    {
...
public enum AforaChatGatewayRequests {
    ...
    public static func agentsList(timeoutMs: Double = 15000) -> AforaChatGatewayRequest {
        AforaChatGatewayRequest(method: "agents.list", timeoutMs: timeoutMs)
    }

    public static func modelsList() -> AforaChatGatewayRequest {
        AforaChatGatewayRequest(method: "models.list", timeoutMs: self.defaultTimeoutMs)
    }

    public static func artifactDownload(
        sessionKey: String,
        agentID: String?,
        artifactId: String) -> AforaChatGatewayRequest
    {
        ...
        return AforaChatGatewayRequest(
    ...
    public static func chatMetadata(
        sessionKey: String,
        fallbackAgentID: String?) -> AforaChatGatewayRequest
    {
        var params: [String: AnyCodable] = [:]
        self.add(
            AforaChatSessionKey.agentID(from: sessionKey) ?? fallbackAgentID,
            to: &params,
            key: "agentId")
        return AforaChatGatewayRequest(
    ...
    public static func questionList() -> AforaChatGatewayRequest {
        AforaChatGatewayRequest(method: "question.list", timeoutMs: self.defaultTimeoutMs)
    }

    public static func tasksList(
        sessionKey: String,
        agentID: String?,
        limit: Int = 200) -> AforaChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
            "sessionKey": AnyCodable(sessionKey),
    ...
    public static func questionGet(id: String) -> AforaChatGatewayRequest {
        AforaChatGatewayRequest(
            method: "question.get",
    ...
    public static func resolveQuestion(
        id: String,
        answers: [String: [String]]) -> AforaChatGatewayRequest
    {
    ...
    public static func cancelQuestion(id: String) -> AforaChatGatewayRequest {
        AforaChatGatewayRequest(
            method: "question.resolve",
            params: [
                "id": AnyCodable(id),
    ...
    public static func sessionsList(
        ...
        timeoutMs: Double = 15000) -> AforaChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
    ...
    public static func sessionGroupsList() -> AforaChatGatewayRequest {
        AforaChatGatewayRequest(
            method: "sessions.groups.list",
            timeoutMs: self.defaultTimeoutMs)
    }

    public static func sessionGroupsPut(names: [String]) -> AforaChatGatewayRequest {
        AforaChatGatewayRequest(
    ...
    public static func sessionGroupsRename(
        name: String,
        to: String) -> AforaChatGatewayRequest
    {
        AforaChatGatewayRequest(
    ...
    public static func sessionGroupsDelete(name: String) -> AforaChatGatewayRequest {
        AforaChatGatewayRequest(
    ...
    public static func createSession(
        ...
        worktree: Bool?,
        worktreeBaseRef: String? = nil) -> AforaChatGatewayRequest
    {
    ...
    public static func abortRun(
        ...
        agentID: String?,
        runID: String,
        requestTimeoutMs: Int = 10000) -> AforaChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
            "sessionKey": AnyCodable(sessionKey),
    ...
    public static func patchSessionPreferences(
        ...
        verboseLevel: String?? = nil) -> AforaChatGatewayRequest
    {
    ...
    private static func fastModeValue(_ mode: AforaChatFastMode) -> AnyCodable {
        switch mode {
    ...
    public static func patchSession(
        ...
        pinned: Bool?,
        archived: Bool?,
        unread: Bool?) -> AforaChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
    ...
    public static func deleteSession(
        sessionKey: String,
        agentID: String?) -> AforaChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
    ...
    public static func forkSession(
        parentSessionKey: String,
        agentID: String?,
        fromLastCompleted: Bool = false) -> AforaChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
    ...
    public static func switchSessionBranch(
        sessionKey: String,
        agentID: String?,
        leafEntryId: String) -> AforaChatGatewayRequest
    {
        var params = self.sessionParams(
            sessionKey: sessionKey,
            agentID: agentID,
    ...
    public static func subscribeSessions(timeoutMs: Double = 10000) -> AforaChatGatewayRequest {
        AforaChatGatewayRequest(
    ...
    public static func setSessionObserverVisibility(
        _ visible: Bool,
        timeoutMs: Double = 10000) -> AforaChatGatewayRequest
    {
        AforaChatGatewayRequest(
    ...
    public static func compactSession(
        sessionKey: String,
        agentID: String?,
        maxLines: Int? = nil) -> AforaChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
        if let maxLines {
    ...
    public static func history(
        ...
        limit: Int? = nil,
        maxChars: Int? = nil,
        timeoutMs: Int? = nil) -> AforaChatGatewayRequest
    {
        ...
        fallbackAgentID: String?) -> AforaChatGatewayRequest
    {
        ...
        self.add(
            sessionKey.flatMap(AforaChatSessionKey.agentID) ?? fallbackAgentID,
            to: &params,
            key: "agentId")
        return AforaChatGatewayRequest(
    ...
    public static func sendMessage(
        ...
        requestTimeoutMs: Int = 30000) -> AforaChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
            "sessionKey": AnyCodable(sessionKey),
    ...
    public static func agentWait(
        runID: String,
        timeoutMs: Int,
        requestGraceMs: Int = 5000) -> AforaChatGatewayRequest
    {
        AforaChatGatewayRequest(
            method: "agent.wait",
            params: [
    ...
    public static func health(timeoutMs: Int) -> AforaChatGatewayRequest {
        AforaChatGatewayRequest(
            method: "health",
