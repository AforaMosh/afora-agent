...
struct ChatMessageMediaAttachmentTests {
    ...
    @Test(arguments: [
        (AforaChatMediaKind.image, "artifact_managed_image_11111111-1111-4111-8111-111111111111", true),
        (AforaChatMediaKind.image, "artifact_managed_media_11111111-1111-4111-8111-111111111111", false),
        (AforaChatMediaKind.audio, "artifact_managed_media_11111111-1111-4111-8111-111111111111", true),
        (AforaChatMediaKind.video, "artifact_managed_media_11111111-1111-4111-8111-111111111111", true),
        (AforaChatMediaKind.video, "artifact_managed_image_11111111-1111-4111-8111-111111111111", false),
    ])
    ...
    @Test @MainActor func `distinct images never reconcile as the same final message`() {
        ...
        #expect(
            AforaChatViewModel.finalMessageContentFingerprint(for: first) !=
                AforaChatViewModel.finalMessageContentFingerprint(for: second))
        #expect(
            AforaChatViewModel.messageContentFingerprint(for: first) !=
                AforaChatViewModel.messageContentFingerprint(for: second))
    }
    ...
    private static func message(artifactId: String) -> AforaChatMessage {
        AforaChatMessage(
            role: "assistant",
            content: [
