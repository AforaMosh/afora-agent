...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = AforaChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = AforaChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
