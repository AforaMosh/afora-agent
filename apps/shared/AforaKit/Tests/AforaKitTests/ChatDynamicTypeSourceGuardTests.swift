...
struct ChatDynamicTypeSourceGuardTests {
        ...
        composer: String)
    {
        ...
        return try (
            messageViews: String(
                contentsOf: root.appendingPathComponent("Sources/AforaChatUI/ChatMessageViews.swift"),
                encoding: .utf8),
            chatView: String(
                contentsOf: root.appendingPathComponent("Sources/AforaChatUI/ChatView.swift"),
                encoding: .utf8),
            composer: String(
                contentsOf: root.appendingPathComponent("Sources/AforaChatUI/ChatComposer.swift"),
                encoding: .utf8))
    }
}
