...
internal const val extraWearLaunchTarget = "afora.wear.launchTarget"
...
internal fun AforaWearApp(
  ...
  AforaWearTheme(themeMode = themeMode) {
    AppScaffold {
      AforaWearScreens(
        snapshot = snapshot,
        failure = failure,
        ...
        onTalk = {
          if (!state.connected || snapshot?.activeSessionId == null) return@AforaWearScreens
...
internal const val REPLY_RESULT_KEY = "afora_watch_message"
