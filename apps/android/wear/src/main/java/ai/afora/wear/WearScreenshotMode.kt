...
internal const val extraWearScreenshotMode = "afora.screenshotMode"
internal const val extraWearScreenshotScene = "afora.screenshotScene"
...
@Composable
internal fun AforaWearScreenshotApp(scene: WearScreenshotScene) {
  AforaWearTheme(themeMode = WearThemeMode.Dark) {
    AppScaffold {
      AforaWearScreens(
