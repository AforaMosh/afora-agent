...
import ai.afora.app.ui.AforaTheme
...
class AccessibilityDevActivity : AppCompatActivity() {
  ...
  private fun refreshForegroundPackage() {
    foregroundPackageName = AforaAccessibilityService.instance?.foregroundPackageName()
  }
...
private fun AccessibilityDevScreen(
  ...
  val serviceConnection by AforaAccessibilityService.connection.collectAsState()
