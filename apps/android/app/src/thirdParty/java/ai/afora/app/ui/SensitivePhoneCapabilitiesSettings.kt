...
import ai.afora.app.accessibility.AccessibilityComponentController
  ...
  AlertDialog(
    ...
    text = {
      Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
        Text(
          nativeString(
            "Enabling lets Afora observe and control other apps' screens when armed. Android accessibility access is required.",
          ),
        )
      }
    },
