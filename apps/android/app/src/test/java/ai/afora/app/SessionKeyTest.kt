...
class SessionKeyTest {
  ...
  fun buildAndroidAppSessionLabelIncludesDeviceDisplayName() {
    assertEquals("Afora App · 1234567890ab", buildAndroidAppSessionLabel(null, "1234567890abcdef"))
    assertEquals(
      "Afora App · Pixel · 1234567890ab",
