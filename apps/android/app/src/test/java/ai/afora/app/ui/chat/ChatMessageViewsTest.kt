...
class ChatMessageViewsTest {
  ...
  fun transcriptBubblesExposeSpeakerWithoutReplacingMessageText() {
    ...
    val assistantBubble = composeRule.onNode(hasContentDescription("Afora") and hasText("assistant body")).assertExists()
    composeRule.onNode(hasContentDescription("System") and hasText("system body")).assertExists()
    composeRule.onNode(hasContentDescription("Afora") and hasText("live body")).assertExists()
    ...
    composeRule.onAllNodesWithText("Afora", useUnmergedTree = true).assertCountEquals(0)
    composeRule.onAllNodesWithText("System", useUnmergedTree = true).assertCountEquals(1)
    composeRule.onAllNodesWithText("Afora · Live", useUnmergedTree = true).assertCountEquals(1)
  ...
  fun outboxBubbleExposesSpeakerWithoutReplacingStatusOrActions() {
    ...
    composeRule
      .onNode(
        hasContentDescription("Afora") and
