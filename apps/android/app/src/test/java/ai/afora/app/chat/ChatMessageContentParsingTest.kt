package ai.afora.app.chat

import ai.afora.app.ui.chat.readBoundedWidgetDocument
...
class ChatMessageContentParsingTest {
  ...
  fun parsesCapabilityGatedCanvasWidgets() {
    val content =
      Json.parseToJsonElement(
        """{"type":"canvas","preview":{"kind":"canvas","surface":"assistant_message","render":"url","title":"Status","preferredHeight":240,"url":"/__afora__/canvas/documents/widget-1/index.html","sandbox":"scripts"}}""",
      )
    ...
    assertEquals(
      ChatMessageContent(
        ...
        widget =
          ChatWidgetPreview(
            title = "Status",
            path = "/__afora__/canvas/documents/widget-1/index.html",
            preferredHeight = 240,
            sandbox = "scripts",
          ),
      ),
  ...
  fun dropsCanvasBlocksWithoutWidgetSandbox() {
    val content =
      Json.parseToJsonElement(
        """{"type":"canvas","preview":{"kind":"canvas","surface":"assistant_message","render":"url","url":"/__afora__/canvas/documents/widget-1/index.html"}}""",
      )
  ...
  fun resolvesOnlyCapabilityScopedWidgetDocuments() {
    val surface = "https://gateway.example/__afora__/cap/token"

    assertEquals(
      "https://gateway.example/__afora__/cap/token/__afora__/canvas/documents/widget-1/index.html",
      ChatWidgetUrlResolver.resolve(surface, "/__afora__/canvas/documents/widget-1/index.html"),
    )
    assertEquals(
      "https://gateway.example/__afora__/cap/token/__afora__/canvas/documents/widget-1/index.html",
      ChatWidgetUrlResolver.resolve(
        "HTTPS://gateway.example/__afora__/cap/token",
        "/__afora__/canvas/documents/widget-1/index.html",
      ),
    )
    assertNull(ChatWidgetUrlResolver.resolve("https://gateway.example", "/__afora__/canvas/documents/widget-1/index.html"))
    assertNull(ChatWidgetUrlResolver.resolve(surface, "https://attacker.example/widget.html"))
    assertNull(ChatWidgetUrlResolver.resolve(surface, "/__afora__/a2ui/index.html"))
    assertNull(ChatWidgetUrlResolver.resolve(surface, "/__afora__/canvas/documents/%252e%252e/index.html"))
  }

  @Test
  fun initialResolutionUsesOperatorFallbackWhenNodeUnavailable() {
    val target = "/__afora__/canvas/documents/widget-1/index.html"
    val fallbackSurface = "https://operator.example/__afora__/cap/fallback"
    val surfaces =
  ...
  fun usesReplacementRouteAfterCapabilityRefreshLosesItsLease() =
    runTest {
      val target = "/__afora__/canvas/documents/widget-1/index.html"
      val oldSurface = "https://gateway.example/__afora__/cap/old"
      val newSurface = "https://gateway.example/__afora__/cap/new"
  ...
  fun refreshesOperatorCapabilityWhenNodeUnavailable() =
    runTest {
      val target = "/__afora__/canvas/documents/widget-1/index.html"
      val oldSurface = "https://operator.example/__afora__/cap/old"
      val newSurface = "https://operator.example/__afora__/cap/new"
      val failedResource =
        ChatWidgetResource(
