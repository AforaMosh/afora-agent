...
class CanvasNavigationPolicyTest {
  ...
  fun keepsRemoteEmulatorBridgeAndBundledUrls() {
    val accepted =
      listOf(
        ...
        "http://gateway.local:18789/__afora__/canvas/",
        "http://10.0.2.2:18789/__afora__/canvas/",
  ...
  fun controllerUsesSharedPolicyForDirectLoads() {
    ...
    controller.navigate("http://10.0.2.2:18789/__afora__/canvas/")
    assertEquals("http://10.0.2.2:18789/__afora__/canvas/", controller.currentUrl())
  }
