...
import ai.afora.app.gateway.GatewayClientInfo
...
class ConnectionManager internal constructor(
  ...
  fun buildUserAgent(): String {
    ...
    return "AforaAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "afora-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(
    ...
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "afora-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
