...
enum class GatewayMethod(
  ...
  AforaChat("afora.chat"),
  AforaChatHistory("afora.chat.history"),
  AforaChangesList("afora.changes.list"),
  AforaApprovalList("afora.approval.list"),
  AforaSetupDetect("afora.setup.detect"),
  AforaSetupActivate("afora.setup.activate"),
  AforaSetupAuthStart("afora.setup.auth.start"),
  AforaSetupPrepareStart("afora.setup.prepare.start"),
  ...
  AforaSetupVerify("afora.setup.verify"),
...
enum class GatewayEvent(
  ...
  AforaApprovalRequested("afora.approval.requested"),
  AforaApprovalResolved("afora.approval.resolved"),
