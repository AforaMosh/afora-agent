...
import ai.afora.app.allowsPackage
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("afora.secure", Context.MODE_PRIVATE)
