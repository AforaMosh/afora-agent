...
import ai.afora.app.GatewayDevicePairingCapabilities
import ai.afora.app.GatewayDevicePairingMutation
import ai.afora.app.GatewayDeviceTokenSummary
import ai.afora.app.GatewayNodeApprovalState
import ai.afora.app.GatewayNodeSummary
import ai.afora.app.GatewayNodesDevicesSummary
import ai.afora.app.GatewayPairedDeviceSummary
import ai.afora.app.GatewayPendingDeviceSummary
import ai.afora.app.MainViewModel
import ai.afora.app.canApproveGatewayDevicePairing
...
private fun nodeSubtitle(node: GatewayNodeSummary): String {
  ...
  val version = node.version?.let { "Afora $it" }
...
internal fun devicePairingAdminUnavailableText(): String =
  nativeString(
    "Device pairing actions are unavailable in this Gateway session. Run afora devices list on the Gateway host and manage the request there. Node capability approval is separate and still uses nodes approve <request id>.",
  )
