...
internal const val actionOpenConversationNotification =
  "ai.afora.app.action.OPEN_CONVERSATION_NOTIFICATION"
internal const val actionConsumeConversationNotification =
  "ai.afora.app.action.CONSUME_CONVERSATION_NOTIFICATION"
internal const val actionReplyConversationNotification =
  "ai.afora.app.action.REPLY_CONVERSATION_NOTIFICATION"

private const val extraGatewayStableId = "ai.afora.app.extra.CONVERSATION_GATEWAY_ID"
private const val extraAgentId = "ai.afora.app.extra.CONVERSATION_AGENT_ID"
private const val extraSessionKey = "ai.afora.app.extra.CONVERSATION_SESSION_KEY"
private const val extraRunId = "ai.afora.app.extra.CONVERSATION_RUN_ID"
private const val extraLaunchToken = "ai.afora.app.extra.CONVERSATION_LAUNCH_TOKEN"
private const val remoteInputReply = "ai.afora.app.remote_input.CONVERSATION_REPLY"
private const val notificationIntentScheme = "afora"
...
private const val conversationChannelId = "afora.chat.replies"
private const val conversationNotificationId = 1
private const val conversationNotificationTagPrefix = "afora.chat."
private const val conversationShortcutPrefix = "afora-chat-"
private const val conversationGroup = "afora.chat"
  ...
  private fun replyAction(target: ConversationNotificationTarget): NotificationCompat.Action {
    ...
    val remoteInput =
      RemoteInput
        ...
        .setLabel(nativeString("Reply to Afora…"))
        .build()
  ...
  private fun ensureConversationShortcut(target: ConversationNotificationTarget) {
    val shortcut =
      ShortcutInfoCompat
        ...
        .setShortLabel(nativeString("Afora"))
        .setLongLived(true)
