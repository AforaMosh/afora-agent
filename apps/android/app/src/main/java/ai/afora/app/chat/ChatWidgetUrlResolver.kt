...
internal object ChatWidgetUrlResolver {
  private const val DOCUMENTS_PATH = "/__afora__/canvas/documents"
  ...
  private fun parseCapabilitySurface(raw: String?): URI? {
    ...
    if (segments.size < 3 || segments[segments.lastIndex - 2] != "__afora__" || segments[segments.lastIndex - 1] != "cap") return null
