...
import ai.afora.app.node.CanvasNavigationPolicy
...
internal class CanvasHostView(
  ...
  private fun createWebView(): WebView =
    WebView(context).also { webView ->
      ...
      if (isDebuggable) {
        Log.d("AforaWebView", "userAgent: ${webSettings.userAgentString}")
      }
      ...
      webView.webViewClient =
        object : WebViewClient() {
          ...
          override fun onReceivedError(
            ...
            Log.e("AforaWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
          }
          ...
          override fun onPageFinished(
            ...
            currentPageUrlRef.set(url)
            if (isDebuggable) {
              Log.d("AforaWebView", "onPageFinished: $url")
            }
      ...
      if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
        ...
        Log.w("AforaWebView", "WebMessageListener unsupported; canvas actions disabled")
      }
      addView(
        webView,
...
internal class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "aforaCanvasA2UIAction"
