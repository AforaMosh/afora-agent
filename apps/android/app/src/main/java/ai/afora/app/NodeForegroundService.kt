...
class NodeForegroundService : Service() {
    ...
    runtimeRestoreJob =
      scope.launch(Dispatchers.Default) {
        try {
          ...
          Log.e("AforaNodeService", "Failed to restore node runtime", err)
          withContext(Dispatchers.Main) {
            runtimeRestoreJob = null
          ...
          val title =
            when {
              state.connected && state.mode == VoiceCaptureMode.TalkMode ->
                nativeString("Afora Node · Talk")
              state.connected -> nativeString("Afora Node · Connected")
              else -> nativeString("Afora Node")
            }
  ...
  private fun ensureChannel() {
    ...
    val channel =
      NotificationChannel(
        ...
        description = nativeString("Afora node connection status")
        setShowBadge(false)
      }
  ...
  companion object {
    ...
    private const val ACTION_STOP = "ai.afora.app.action.STOP"
    private const val ACTION_RESUME = "ai.afora.app.action.RESUME"
    private const val ACTION_SET_VOICE_CAPTURE_MODE = "ai.afora.app.action.SET_VOICE_CAPTURE_MODE"
    private const val EXTRA_VOICE_CAPTURE_MODE = "ai.afora.app.extra.VOICE_CAPTURE_MODE"
