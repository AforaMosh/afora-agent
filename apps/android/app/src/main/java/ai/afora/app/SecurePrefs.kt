...
import ai.afora.app.gateway.GatewayCustomHeaders
import ai.afora.app.gateway.GatewayRegistryStore
import ai.afora.app.gateway.GatewayStoreMigration
...
class SecurePrefs(
  ...
  companion object {
    ...
    private const val plainPrefsName = "afora.node"
    private const val securePrefsName = "afora.node.secure"
  ...
  internal fun getNotificationForwardingPolicy(appPackageName: String): NotificationForwardingPolicy {
    ...
    // Always block Afora's own notifications in blocklist mode to prevent forwarding loops.
