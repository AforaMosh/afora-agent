...
struct SettingsViewSmokeTests {
    ...
    @Test func `Afora settings require configured inference`() {
    ...
    @Test func `Afora preserves same route and resets for gateway changes`() {
        let stateDir = URL(fileURLWithPath: "/Users/tester/.afora")
