...
struct DashboardGatewayMenuTests {
    @Test func `connection label names primary only for multiple gateways`() {
        ...
        let cases: [(AppState.ConnectionMode, ControlChannel.ConnectionState, [DashboardGatewayEntry], String)] = [
            (.unconfigured, .degraded("ignored"), [primary], "Afora Not Configured"),
            (.unconfigured, .degraded("ignored"), [primary, profile], "Afora Not Configured — Mac Studio"),
            (.local, .degraded("ignored"), [primary], "Afora Active"),
            (.local, .degraded("ignored"), [primary, profile], "Afora Active — Mac Studio"),
            (.remote, .connected, [primary], "Remote Afora Active"),
            (.remote, .connected, [primary, profile], "Remote Afora Active — Mac Studio"),
            (.remote, .connecting, [primary], "Remote Afora Connecting"),
            (.remote, .degraded("auth failed"), [primary], "Remote Afora Needs Attention"),
            (.remote, .degraded("auth failed"), [primary, profile], "Remote Afora Needs Attention — Mac Studio"),
        ]
