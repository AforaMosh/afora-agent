...
struct ConnectOptions {
    ...
    var clientId: String = "afora-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default: afora-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "Afora macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("Afora macOS Gateway Connect")
...
func gatewayURLDeviceAuthOwner(_ url: URL, mode: String) -> String {
    ...
    return "afora-mac-cli:route:\(fingerprint)"
}
