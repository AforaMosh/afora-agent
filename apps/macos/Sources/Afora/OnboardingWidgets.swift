...
/// Onboarding hero mascot with the afora.ai hero treatment: the animated
...
struct GlowingAforaIcon: View {
    @Environment(\.colorScheme) private var colorScheme

    let size: CGFloat
    let mood: AforaMascotMood
    let accessory: AforaMascotAccessory
    ...
    var body: some View {
        ...
        AforaMascotView(
            ...
            .shadow(
                color: AforaMascotView.heroGlowColor(for: self.colorScheme),
...
extension OnboardingView {
    ...
    var mascotMood: AforaMascotMood {
    ...
    var mascotAccessory: AforaMascotAccessory {
    ...
    static func mascotMood(for snapshot: MascotMoodSnapshot) -> AforaMascotMood {
    ...
    static func mascotAccessory(for page: MascotPage) -> AforaMascotAccessory {
        switch page {
        case .ready: .gradCap
