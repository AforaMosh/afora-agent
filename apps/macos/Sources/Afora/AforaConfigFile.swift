...
enum AforaConfigFile {
    ...
    private static let logger = Logger(subsystem: "ai.afora", category: "config")
    ...
    static func url() -> URL {
        AforaPaths.configURL
    }

    static func stateDirURL() -> URL {
        AforaPaths.stateDirURL
    }
...
extension AforaConfigFile {
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-afora-config-file",
            "event": "config.write",
