...
enum ConfigStore {
    ...
    static func load() async -> [String: Any] {
        ...
        return AforaConfigFile.loadDict()
    }
        ...
        allowGatewayAuthMutation: Bool = false) async throws
    {
        ...
        if await self.isRemoteMode() {
            ...
            if let override = overrides.saveLocal {
                ...
                do {
                    ...
                    guard AforaConfigFile.saveDict(
                        root,
        ...
        #endif
        notificationCenter.post(name: .aforaConfigDidChange, object: nil)
    }
...
extension Notification.Name {
    static let aforaConfigDidChange = Notification.Name("afora.config.did-change")
}
