...
actor MacNodeRuntime {
    ...
    private static let cuaOwnedCommands = Set([
        ...
        AforaComputerCommand.act.rawValue,
    ])
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case AforaCameraCommand.snap.rawValue,
                 ...
                 AforaCameraCommand.ptzStatus.rawValue,
                 AforaCameraCommand.ptzControl.rawValue:
                return try await self.handleCameraInvoke(req)
            case AforaLocationCommand.get.rawValue:
            ...
            case AforaComputerCommand.act.rawValue:
                return try await self.handleComputerActInvoke(req)
            case AforaSystemCommand.notify.rawValue:
            ...
            let code: AforaNodeErrorCode = switch error {
...
extension MacNodeRuntime {
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case AforaCanvasA2UICommand.push.rawValue,
             AforaCanvasA2UICommand.pushJSONL.rawValue:
...
extension MacNodeRuntime {
    private func handleCameraInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case AforaCameraCommand.list.rawValue:
            ...
            return BridgeInvokeResponse(id: req.id, ok: true, payloadJSON: payload)
        case AforaCameraCommand.ptzStatus.rawValue:
            let params: AforaCameraPTZStatusParams
            do {
                params = try Self.decodeParams(AforaCameraPTZStatusParams.self, from: req.paramsJSON)
            } catch {
            ...
            return BridgeInvokeResponse(id: req.id, ok: true, payloadJSON: payload)
        case AforaCameraCommand.ptzControl.rawValue:
            let params: AforaCameraPTZControlParams
            do {
                params = try Self.decodeParams(AforaCameraPTZControlParams.self, from: req.paramsJSON)
            } catch {
    ...
    private func handleComputerActInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        let params: AforaComputerActParams
        do {
            params = try Self.decodeParams(AforaComputerActParams.self, from: req.paramsJSON)
        } catch {
            return Self.errorResponse(
                req,
                code: .invalidRequest,
        ...
        do {
            ...
            case .accessibilityNotTrusted:
                return Self.errorResponse(
                    req,
                    code: .unavailable,
                    message: "ACCESSIBILITY_REQUIRED: grant Accessibility permission to Afora")
            ...
            case .postEventAccessDenied:
                return Self.errorResponse(
                    req,
                    code: .unavailable,
                    message: "POST_EVENT_REQUIRED: macOS denied Event Posting access; re-grant Afora "
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> AforaLocationMode {
        ...
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: AforaNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: AforaCanvasSnapshotFormat,
        maxWidth: Int?,
