...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.afora", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Afora windows, but below the system’s pop-up menus.
