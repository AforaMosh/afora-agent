...
extension OnboardingView {
    ...
    /// when nothing works. Afora becomes available only after inference
    ...
    private var aiSetupSubtitle: String {
        ...
        if state.connectionMode == .remote {
            return "AI access is configured on the remote Gateway. Afora will use that existing setup."
        }
        return "Afora needs an AI account to think. " +
