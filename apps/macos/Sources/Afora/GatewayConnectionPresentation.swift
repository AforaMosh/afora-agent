...
struct GatewayConnectionPresentation: Equatable {
    ...
    init(state: ControlChannel.ConnectionState) {
        ...
        case .connected:
            ...
            self.generalTitle = String(localized: "Afora active")
        ...
        case .connecting:
            ...
            self.generalTitle = String(localized: "Afora connecting")
        ...
        case .disconnected:
            ...
            self.generalTitle = String(localized: "Afora needs attention")
            self
                .generalSubtitle =
...
struct GeneralStatusPresentation: Equatable {
        ...
        localFailure: String? = nil) -> Self
    {
        if mode == .local, let localFailure {
            return Self(
                title: String(localized: "Afora needs attention"),
        ...
        if isPaused {
            return Self(
                title: String(localized: "Afora paused"),
        ...
        case .local:
            return Self(
                title: String(localized: "Afora active"),
