...
extension GatewayConnection {
    func loadMediaArtifact(
        ...
        playback: AforaChatPlaybackMode?,
        ifCurrentServerLease lease: ServerLease) async throws -> AforaChatLoadedMedia?
    {
    ...
    private static func maximumManagedMediaBytes(for kind: AforaChatMediaKind) -> Int {
        switch kind {
