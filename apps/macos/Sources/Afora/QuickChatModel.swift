...
private struct RetryIdentity {
    ...
    let sessionKey: String
    let agentID: String?
    let attachments: [AforaChatAttachmentPayload]
...
final class QuickChatModel {
    ...
    typealias SendProvider = @MainActor (
        ...
        String?,
        String,
        [AforaChatAttachmentPayload]) async throws -> String
    ...
    typealias ModelPatchProvider = @MainActor (
        ...
        String?) async throws -> AforaChatModelPatchResult?
    ...
    private(set) var modelChoices: [AforaChatModelChoice] = []
    ...
    func selectModel(_ selectionID: String) {
        ...
        guard normalized == AforaChatViewModel.defaultModelSelectionID ||
    ...
    private func settleModelPatch(request: ModelPatchRequest, model: String?) async -> Bool {
        ...
        do {
            ...
            if self.isCurrentModelPatchPresentation(request) {
                ...
                } else if request.selectionID != AforaChatViewModel.defaultModelSelectionID {
