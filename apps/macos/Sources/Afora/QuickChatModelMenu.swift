...
enum QuickChatModelMenuPresenter {
    static func present(model: QuickChatModel, panel: NSPanel, contentView: NSView) {
        ...
        defaultItem.representedObject = AforaChatViewModel.defaultModelSelectionID
        defaultItem.state = model.selectedModelSelectionID == AforaChatViewModel.defaultModelSelectionID
            ? .on
            : .off
