...
/// This intentionally ignores AFORA_STATE_DIR: prod, dev, and profile-specific
...
final class PortGuardianRecordStore: @unchecked Sendable {
    ...
    private let database: AforaNativeStateSQLite
    ...
    static var liveRootURL: URL {
        ...
        return base.appendingPathComponent("Afora", isDirectory: true)
    }
        ...
        }) throws
    {
        ...
        let database: AforaNativeStateSQLite
        do {
            database = try AforaNativeStateSQLite(databaseURL: databaseURL)
        } catch {
    ...
    private static func decodeRecord(
        _ statement: AforaNativeStateSQLiteStatement) throws -> PortGuardian.Record
    {
    ...
    private static func bind(
        ...
        to statement: AforaNativeStateSQLiteStatement) throws
    {
    ...
    private static func storeError(_ error: Error) -> Error {
        ...
        if let error = error as? AforaNativeStateError {
