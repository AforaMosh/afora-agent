...
final class ExecApprovalsGatewayPrompter {
    ...
    private let logger = Logger(subsystem: "ai.afora", category: "exec-approvals.gateway")
    ...
    private func handle(push: GatewayPush) async {
        ...
        guard evt.event == "exec.approval.requested" || evt.event == "afora.approval.requested" else { return }
        ...
        do {
            ...
            if evt.event == "afora.approval.requested" {
