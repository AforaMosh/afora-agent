...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            // Hero treatment from afora.ai: coral silhouette glow at 10% of
            ...
            AforaMascotView(interactive: true)
                .frame(width: 160, height: 160)
                .shadow(
                    color: AforaMascotView.heroGlowColor(
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(icon: "globe", title: "Website", url: "https://afora.ai")
                AboutLinkRow(icon: "book", title: "Docs", url: "https://docs.afora.ai")
                AboutLinkRow(
