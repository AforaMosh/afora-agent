...
enum MacGatewayProfileError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case let .unsupportedRegistryVersion(version):
            "Gateway profiles were written by a newer Afora version (schema \(version))."
...
actor MacGatewayProfileStore {
    ...
    static let didChangeNotification = Notification.Name("afora.gateway-profiles.did-change")
    ...
    #if DEBUG
    private static let baseService = "ai.afora.gateway-profiles.debug"
    #else
    private static let baseService = "ai.afora.gateway-profiles"
    #endif
