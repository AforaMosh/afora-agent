...
struct CameraPTZControlResponse: Encodable, Equatable, Sendable {
    let deviceId: String
    let operation: AforaCameraPTZOperation
...
protocol CameraPTZServicing: Sendable {
    ...
    func control(_ params: AforaCameraPTZControlParams) async throws -> CameraPTZControlResponse
}
...
actor CameraPTZService: CameraPTZServicing {
    ...
    func control(_ params: AforaCameraPTZControlParams) throws -> CameraPTZControlResponse {
    ...
    private static func validateControl(
        _ params: AforaCameraPTZControlParams) throws -> AforaCameraPTZAxisValues
    {
        ...
        case .home:
            ...
            return AforaCameraPTZAxisValues()
        case .set:
    ...
    private static func validateAxes(_ axes: AforaCameraPTZAxisValues) throws {
    ...
    private static func planMotion(
        ...
        axes: AforaCameraPTZAxisValues) throws -> WritePlan
    {
    ...
    private static func requestedDegrees(
        value: Double,
        current: Double,
        operation: AforaCameraPTZOperation) -> Double
    {
    ...
    private static func execute(
        ...
        deviceId: String,
        operation: AforaCameraPTZOperation) throws -> CameraPTZControlResponse
    {
