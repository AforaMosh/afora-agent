...
struct GeneralSettings: View {
    ...
    private var generalPage: some View {
        VStack(alignment: .leading, spacing: 20) {
            SettingsPageHeader(
                title: "General",
                subtitle: "Everyday Afora app behavior.")

            self.aforaStatusPanel
            ...
            SettingsCardGroup("App") {
                ...
                SettingsCardToggleRow(
                    ...
                    subtitle: """
                    Keep Afora visible in the Dock. When off, windows still show the Dock icon while open.
                    """,
            ...
            SettingsCardGroup("Cookie sync") {
                SettingsCardToggleRow(
                    ...
                    subtitle: """
                    Continuously copy this Mac's logged-in cookies for the domains below into the remote Afora \
                ...
                if self.state.connectionMode != .remote {
                    SettingsCardRow(
                        ...
                        subtitle: "Cookie sync applies when Afora runs on another computer (remote mode).",
                        showsDivider: false)
                    {
                        EmptyView()
                    }
    ...
    private var aforaStatusPanel: some View {
        ...
        return HStack(alignment: .center, spacing: 14) {
            ...
            Toggle("Afora active", isOn: self.activeBinding)
                .labelsHidden()
                .toggleStyle(.switch)
        }
    ...
    private var connectionStatusSubtitle: String {
        ...
        switch self.state.connectionMode {
        case .local:
            return "Afora starts and monitors the Gateway on this Mac."
        case .remote:
        ...
        SettingsCardGroup("Advanced") {
            DisclosureGroup(isExpanded: self.$showRemoteAdvanced) {
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    self.advancedTextField(
                        "Project root",
                        placeholder: "/home/you/Projects/afora",
                        text: self.$state.remoteProjectRoot)
                    self.advancedTextField(
                        "CLI path",
                        placeholder: "/Applications/Afora.app/.../afora",
...
extension GeneralSettings {
    ...
    private func revealLogs() {
        ...
        Looked for afora logs in /tmp/afora/.
        ...
        isEnabled: Bool) -> Self
    {
        ...
        return Self(
            subtitle: bundleLocationAllowsPersistentIntegration
                ? String(localized: "Automatically start Afora after you sign in.")
                : String(localized: "Move Afora to Applications before enabling launch at login."),
