...
struct ScreenSnapshotResult: Sendable {
    let data: Data
    let format: AforaScreenSnapshotFormat
    let width: Int
    let height: Int
...
final class ScreenSnapshotService {
    ...
    func snapshot(
        ...
        maxWidth: Int?,
        quality: Double?,
        format: AforaScreenSnapshotFormat?) async throws
        ...
        referenceWidth: Int) throws -> String
    {
        ...
        return AforaComputerInputGeometry.displayFrameId(
    ...
    private static func normalize(
        maxWidth: Int?,
        quality: Double?,
        format: AforaScreenSnapshotFormat)
