...
let dashboardWindowLogger = Logger(subsystem: "ai.afora", category: "DashboardWindow")
...
enum DashboardWindowLayout {
    ...
    static let linkBrowserWidthDefaultsKey = "AforaDashboardLinkBrowserWidth"
    static let windowFrameAutosaveName = "AforaDashboardWindow"
...
enum DashboardNativeCommand: String {
    case newSession = "afora:native-new-session"
    case commandPalette = "afora:native-toggle-search"
    ...
    var legacyFallbackEventName: String? {
        switch self {
        case .newSession: nil
        case .commandPalette: "afora:native-open-search"
        }
    }
