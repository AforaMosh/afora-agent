...
enum RuntimeLocator {
    private static let logger = Logger(subsystem: "ai.afora", category: "runtime")
    ...
    static func describeFailure(_ error: RuntimeResolutionError) -> String {
        ...
        case let .notFound(searchPaths):
            [
                "afora needs Node \(self.supportedNodeRange) but found no runtime.",
