...
final class QuickChatReplyBinding {
    typealias ViewModelFactory = @MainActor (QuickChatRoutingTarget) -> AforaChatViewModel

    private(set) var route: QuickChatRoutingTarget?
    private(set) var viewModel: AforaChatViewModel?
    ...
    private static func makeViewModel(route: QuickChatRoutingTarget) -> AforaChatViewModel {
