...
private let dashboardManagerLogger = Logger(subsystem: "ai.afora", category: "DashboardManager")
...
final class DashboardManager {
    ...
    private func autosaveName(for target: DashboardGatewayTarget) -> String {
        ...
        case let .profile(profileID):
            "AforaDashboardWindow-\(profileID)"
        }
    }
...
extension DashboardManager {
        ...
        -> DashboardManager
    {
        let manager = DashboardManager(
            ...
            mainWindowAutosaveName: "AforaDashboardWindow-Test-\(UUID().uuidString)")
