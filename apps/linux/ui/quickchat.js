...
const INLINE_WIDGET_DOCUMENTS_PATH = "/__afora__/canvas/documents";
...
function canonicalInlineWidgetTarget(raw) {
  ...
  try {
    const parsed = new URL(target, "http://afora.invalid");
    return parsed.origin === "http://afora.invalid" && parsed.pathname === path ? target : null;
  } catch {
    return null;
  }
}
