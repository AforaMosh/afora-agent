...
enum ApprovalNotificationBridge {
    ...
    private static func approvalID(from userInfo: [AnyHashable: Any]) -> String? {
        let raw = self.aforaPayload(userInfo: userInfo)?["approvalId"] as? String
    ...
    private static func parsePush(
        ...
        configuration: ApprovalNotificationConfiguration) -> ApprovalNotificationPrompt?
    {
        guard let payload = aforaPayload(userInfo: userInfo),
    ...
    private static func payloadKind(userInfo: [AnyHashable: Any]) -> String {
        let raw = self.aforaPayload(userInfo: userInfo)?["kind"] as? String
        let trimmed = raw?.trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
        return trimmed.isEmpty ? "unknown" : trimmed
    }

    private static func aforaPayload(userInfo: [AnyHashable: Any]) -> [String: Any]? {
...
enum ExecApprovalNotificationBridge {
    ...
    static let categoryIdentifier = "afora.exec-approval"
    static let reviewActionIdentifier = "afora.exec-approval.review"
...
enum PluginApprovalNotificationBridge {
    ...
    static let categoryIdentifier = "afora.plugin-approval"
    static let reviewActionIdentifier = "afora.plugin-approval.review"
