        ...
        return NavigationLink {
            ...
            HStack(spacing: 12) {
                Image(systemName: isDirectory ? "folder" : "doc.text")
                    ...
                    .foregroundStyle(isDirectory ? AforaBrand.accent : Color.secondary)
                    .frame(width: 24)
...
struct AgentWorkspaceFilePreview: View {
    ...
    private var content: some View {
        if let file {
            ...
            .padding(AforaProMetric.pagePadding)
        }
    }
    ...
    private func share() {
        ...
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("AforaWorkspaceFiles", isDirectory: true)
