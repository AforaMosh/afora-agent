...
struct OnboardingModeSelectionSections: View {
    ...
    var body: some View {
        ...
        Section {
            ...
            .buttonStyle(AforaPrimaryActionButtonStyle(height: 48))
    ...
    var body: some View {
        ...
        case let .failedStatus(message, allowsRetry):
            AforaNoticeBanner(
                ...
                tint: AforaBrand.danger,
                primaryActionTitle: allowsRetry ? AforaTextValue.localized("Retry") : nil,
                onPrimaryAction: allowsRetry ? self.onRetry : nil)
        case .ready:
            AforaStatusBadge(label: "Ready to Connect", tone: .muted)
        }
    }
}
