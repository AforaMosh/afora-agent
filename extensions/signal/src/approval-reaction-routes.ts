import { matchesApprovalRequestFilters } from "afora-agent/plugin-sdk/approval-client-runtime";
...
type ApprovalForwardingConfig = NonNullable<NonNullable<AforaConfig["approvals"]>["exec"]>;
