...
import { MediaFetchError, unlinkIfExists } from "afora-agent/plugin-sdk/media-runtime";
...
} from "afora-agent/plugin-sdk/outbound-media";
import type { PluginRuntime } from "afora-agent/plugin-sdk/plugin-runtime";
import { isTransientNetworkError } from "afora-agent/plugin-sdk/retry-runtime";
import { safeEqualSecret, SsrFBlockedError } from "afora-agent/plugin-sdk/security-runtime";
...
const SMS_OUTBOUND_MEDIA_TOKEN_PARAM_PREFIX = "__afora_mms_token";
