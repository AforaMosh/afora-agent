...
import { requireChannelOpenAllowFrom } from "afora-agent/plugin-sdk/extension-shared";
...
export const SmsChannelConfigSchema = buildChannelConfigSchema(SmsConfigSchema, {
  uiHints: {
    ...
    textChunkLimit: {
      ...
      help: "Maximum characters per outbound SMS chunk before Afora splits long replies.",
    },
  },
});
