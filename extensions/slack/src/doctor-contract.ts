...
export const legacyConfigRules: ChannelDoctorLegacyConfigRule[] = [
  ...streamingAliasMigration.legacyConfigRules,
  {
    ...
    message:
      'channels.slack.enterpriseOrgInstall is retired; Slack now detects org-wide installations automatically. Run "afora doctor --fix".',
  },
  {
    path: ["channels", "slack", "accounts"],
    message:
      'channels.slack.accounts.<id>.enterpriseOrgInstall is retired; Slack now detects org-wide installations automatically. Run "afora doctor --fix".',
    match: (value) => hasLegacyAccountStreamingAliases(value, hasEnterpriseOrgInstall),
  },
  {
    path: ["channels", "slack"],
    message:
      'channels.slack.capabilities.interactiveReplies is retired; use typed presentation actions instead. Run "afora doctor --fix".',
    match: hasInteractiveRepliesCapability,
  },
  {
    path: ["channels", "slack", "accounts"],
    message:
      'channels.slack.accounts.<id>.capabilities.interactiveReplies is retired; use typed presentation actions instead. Run "afora doctor --fix".',
    match: (value) => hasLegacyAccountStreamingAliases(value, hasInteractiveRepliesCapability),
  },
  {
    path: ["channels", "slack"],
    message:
      'channels.slack.dm.replyToMode moved to replyToModeByChatType.direct. Run "afora doctor --fix".',
    match: dmReplyModeMigration.hasLegacy,
  },
  {
    path: ["channels", "slack", "accounts"],
    message:
      'channels.slack.accounts.<id>.dm.replyToMode moved to replyToModeByChatType.direct. Run "afora doctor --fix".',
    match: (value) => hasLegacyAccountStreamingAliases(value, dmReplyModeMigration.hasLegacy),
  },
  {
    path: ["channels", "slack"],
    message:
      'channels.slack.thread.requireExplicitMention is legacy; use channels.slack.implicitMentions.threadParticipation instead. Run "afora doctor --fix".',
    match: threadMentionPolicyMigration.hasLegacy,
  },
  {
    path: ["channels", "slack", "accounts"],
    message:
      'channels.slack.accounts.<id>.thread.requireExplicitMention is legacy; use channels.slack.accounts.<id>.implicitMentions.threadParticipation instead. Run "afora doctor --fix".',
    match: (value) =>
  ...
  },
  {
    path: ["channels", "slack"],
    message:
      'channels.slack.channels.<id>.allow is legacy; use channels.slack.channels.<id>.enabled instead. Run "afora doctor --fix".',
    match: channelAllowMigration.hasLegacy,
  },
  {
    path: ["channels", "slack", "accounts"],
    message:
      'channels.slack.accounts.<id>.channels.<id>.allow is legacy; use channels.slack.accounts.<id>.channels.<id>.enabled instead. Run "afora doctor --fix".',
