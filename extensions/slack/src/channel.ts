...
import { adaptScopedAccountAccessor } from "afora-agent/plugin-sdk/channel-config-helpers";
import {
...
//
// `afora/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "afora-agent/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "afora-agent/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as AforaConfig, toolContext as SlackActionContext | undefined),
    }),
