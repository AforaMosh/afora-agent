...
import { resolveTextChunksWithFallback } from "afora-agent/plugin-sdk/reply-payload";
...
const SLACK_DELIVERY_METADATA_EVENT = "afora_delivery";
const SLACK_DELIVERY_METADATA_KEY = "afora_delivery_id";
const SLACK_DELIVERY_METADATA_PART_INDEX_KEY = "afora_delivery_part_index";
const SLACK_DELIVERY_METADATA_PART_COUNT_KEY = "afora_delivery_part_count";
const SLACK_DELIVERY_METADATA_SIGNATURE_KEY = "afora_delivery_signature";
...
function createSlackDeliveryMetadataId(queueId?: string): string | undefined {
  ...
  // store key inside Afora while retaining a stable provider-side marker.
