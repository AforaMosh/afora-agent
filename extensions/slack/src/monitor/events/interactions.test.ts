...
vi.mock("afora-agent/plugin-sdk/system-event-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("afora-agent/plugin-sdk/system-event-runtime")>();
  return {
    ...actual,
...
vi.mock("afora-agent/plugin-sdk/heartbeat-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("afora-agent/plugin-sdk/heartbeat-runtime")>();
  return {
    ...actual,
...
vi.mock("afora-agent/plugin-sdk/question-gateway-runtime", () => ({
...
describe("registerSlackInteractionEvents", () => {
        ...
        message: {
          ...
          blocks: [
            ...
            },
            {
              ...
              elements: [{ type: "button", action_id: "afora:verify" }],
            },
          ],
        },
      },
  ...
  it("registers a matcher that accepts plugin action ids beyond the Afora prefix", () => {
    const { ctx, getActionMatcher } = createContext();
    registerSlackInteractionEvents({ ctx: ctx as never });

    const matcher = getActionMatcher();
    expect(matcher.test("afora:verify")).toBe(true);
  ...
  it("treats Slack reply buttons as plain interaction events instead of plugin dispatch", async () => {
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "afora:reply_button" }],
            },
          ],
        },
      },
    ...
    const eventText = mockCallArg(enqueueSystemEventMock, 0, "enqueueSystemEvent");
    expect(eventText).toContain('"actionId":"afora:reply_button"');
    expectRecordFields(
      requireRecord(
      ...
      {
        contextKey: "slack:interaction:C1:100.200:afora:reply_button:100.201",
        deliveryContext: {
          accountId: "default",
          channel: "slack",
          threadId: "100.100",
  ...
  it("keeps typed callback payloads opaque even when they resemble approval commands", async () => {
    ...
    await getHandler()({
      ...
      action: {
        type: "button",
        action_id: "afora:callback_button:1:1",
  ...
  it("resolves typed exec approvals from Slack-private action data", async () => {
    ...
    await handler({
          ...
          blocks: [
            {
              ...
              elements: [
                { type: "button", action_id: "afora:approval_button:1:1" },
                { type: "button", action_id: "afora:reply_button" },
              ],
            },
          ],
        },
      ...
      action: {
        type: "button",
        action_id: "afora:approval_button:1:1",
        block_id: "exec_actions",
        value:
          'afora:approval:v1:{"approvalId":"plugin:looks-plugin","approvalKind":"exec","decision":"allow-once"}',
        text: { type: "plain_text", text: "Allow once" },
      },
    });
  ...
  it("resolves typed question buttons without enqueueing an agent interaction", async () => {
    ...
    await getHandler()({
      ...
      action: {
        type: "button",
        action_id: "afora:question_button:1:2",
        block_id: "afora_reply_buttons_1",
  ...
  it("cleans stale typed buttons and shows the canonical first-answer winner", async () => {
    ...
    await getHandler()({
      ...
      body: {
        ...
        message: {
          ...
          blocks: [
            {
              type: "section",
              block_id: "afora_approval_header",
            ...
            { type: "section", text: { type: "mrkdwn", text: "Command preview" } },
            {
              ...
              elements: [
                { type: "button", action_id: "afora:approval_button:1:1" },
                { type: "button", action_id: "afora:approval_button:1:2" },
              ],
            },
          ],
        },
      ...
      action: {
        ...
        block_id: "exec_actions",
        value:
          'afora:approval:v1:{"approvalId":"req-123","approvalKind":"exec","decision":"allow-once"}',
        text: { type: "plain_text", text: "Allow once" },
      },
    });
  ...
  it("fails closed for malformed Slack approval envelopes", async () => {
    ...
    await getHandler()({
      ...
      action: {
        ...
        action_id: "afora:approval_button:1:1",
        block_id: "exec_actions",
        value: 'afora:approval:v1:{"approvalId":"req-123","decision":"allow-once"}',
        text: { type: "plain_text", text: "Allow once" },
      },
    });
  ...
  it("uses the typed plugin kind for unprefixed approval ids", async () => {
    ...
    await handler({
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "afora:approval_button:1:1" }],
            },
          ],
        },
      },
      action: {
        ...
        block_id: "plugin_actions",
        value:
          'afora:approval:v1:{"approvalId":"req-123","approvalKind":"plugin","decision":"allow-always"}',
  ...
  it.each([
    { name: "current", actionId: "afora:reply_link:1:1", value: undefined },
    { name: "session", actionId: "afora:session_link", value: undefined },
    {
      name: "legacy",
      actionId: "afora:reply_button:1:1",
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "afora:multi" }],
            },
          ],
        },
      },
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "afora:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "afora:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "afora:datetime" }],
            },
          ],
        },
      },
      ...
      blocks: [
        {
          ...
          elements: [
            {
              type: "mrkdwn",
              text: ":white_check_mark: *afora:datetime* selected by <@U333>",
            },
          ],
        },
      ],
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    expectRecordFields(payload as unknown as Record<string, unknown>, {
      ...
      actionId: "view:afora:deploy_form",
      callbackId: "afora:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("dispatches plugin-owned modal submissions with full view state before compacting events", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V777",
          callback_id: "afora:contract_confirm_hearing",
          private_metadata: JSON.stringify({
            channelId: "D777",
            channelType: "im",
            userId: "U777",
    ...
    expectRecordFields(requireRecord(dispatchCall, "dispatch call"), {
      ...
      dedupeId: "view_submission:afora:contract_confirm_hearing:V777:U777",
    });
    ...
    expectRecordFields(interaction, {
      ...
      namespace: "dean.contract",
      payload: "confirm_hearing",
      callbackId: "afora:contract_confirm_hearing",
      viewId: "V777",
  ...
  it("dispatches callback-id-only plugin modal submissions without agent routing metadata", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V778",
          callback_id: "afora:dean.contract:confirm_hearing",
          state: {
            values: {
              contract: {
    ...
    expectRecordFields(requireRecord(dispatchCall, "dispatch call"), {
      channel: "slack",
      data: "dean.contract:confirm_hearing",
      dedupeId: "view_submission:afora:dean.contract:confirm_hearing:V778:U777",
    });
    ...
    expectRecordFields(requireRecord(registrationCtx.interaction, "registration interaction"), {
      ...
      namespace: "dean.contract",
      payload: "confirm_hearing",
      callbackId: "afora:dean.contract:confirm_hearing",
      viewId: "V778",
    });
    expect(enqueueSystemEventMock).not.toHaveBeenCalled();
  });

  it("dispatches metadata-routed plugin modal submissions with non-afora callback ids", async () => {
    enqueueSystemEventMock.mockClear();
    dispatchPluginInteractiveHandlerMock.mockResolvedValueOnce({
      matched: true,
      handled: true,
  ...
  it("keeps no-channel modal events open when allowFrom is unset", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V444",
          callback_id: "afora:routing_form",
  ...
  it("captures modal input labels and picker values across block types", async () => {
    ...
    expectRecordFields(inputByActionId(inputs, "email_input"), {
      inputKind: "email",
      inputEmail: "team@afora.ai",
    });
    expectRecordFields(inputByActionId(inputs, "url_input"), {
      inputKind: "url",
      inputUrl: "https://docs.afora.ai/",
    });
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "afora:long_richtext",
