...
import type { SessionScope } from "afora-agent/plugin-sdk/config-contracts";
...
import { installRequestBodyLimitGuard } from "afora-agent/plugin-sdk/webhook-request-guards";
import {
  resolveSlackAccount,
...
export async function monitorSlackProvider(opts: MonitorSlackOpts = {}) {
  ...
  // See: AforaMosh/afora-agent#56508
