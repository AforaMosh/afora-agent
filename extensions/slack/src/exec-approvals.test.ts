...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<AforaConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<AforaConfig["channels"]>["slack"]>>,
): AforaConfig {
  return {
    channels: {
      slack: {
