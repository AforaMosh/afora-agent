...
vi.mock("./nostr-profile-http-runtime.js", async () => {
  const webhookIngress = await import("afora-agent/plugin-sdk/webhook-ingress");
  const requestGuards = await import("afora-agent/plugin-sdk/webhook-request-guards");
  return {
