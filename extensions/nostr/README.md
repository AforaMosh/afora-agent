...
Nostr DM channel plugin for Afora using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Afora. It enables your bot to:
...
# Configure afora to use local relay
