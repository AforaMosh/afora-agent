...
import { sessionCatalogPaging } from "afora-agent/plugin-sdk/session-catalog";
import {
  isRecord,
...
// Query results are valid for one immutable Afora config identity, CLI environment, and SQL text.
