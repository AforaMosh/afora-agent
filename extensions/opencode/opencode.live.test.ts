...
import { extractNonEmptyAssistantText, isLiveTestEnabled } from "afora-agent/plugin-sdk/test-live";
...
const LIVE_MODEL_ID =
  process.env.AFORA_LIVE_OPENCODE_DEEPSEEK_MODEL?.trim() || "deepseek-v4-flash-free";
