import type { resolveApiKeyForProvider } from "afora-agent/plugin-sdk/provider-auth-runtime";
import type { fetchWithTimeoutGuarded, postJsonRequest } from "afora-agent/plugin-sdk/provider-http";
