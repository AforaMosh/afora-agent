...
import { asFiniteNumberInRange, asOptionalRecord } from "afora-agent/plugin-sdk/string-coerce-runtime";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: AforaConfig | undefined): string | undefined {
