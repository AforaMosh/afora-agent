...
export function scanPolicyAgentWorkspace(
  ...
  pushAgentWorkspaceEvidence(entries, {
    ...
    tools: defaultTools,
    inheritedTools: {},
    workspaceSourceBase: "oc://afora.config/agents/defaults",
    inheritedWorkspaceSourceBase: "oc://afora.config/agents/defaults",
    toolsSourceBase: "oc://afora.config/tools",
    inheritedToolsSourceBase: "oc://afora.config/tools",
  });
  ...
  list.forEach((agent, index) => {
    ...
    pushAgentWorkspaceEvidence(entries, {
      ...
      workspaceSourceBase: `oc://afora.config/agents/list/#${index}`,
      inheritedWorkspaceSourceBase: "oc://afora.config/agents/defaults",
      toolsSourceBase: `oc://afora.config/agents/list/#${index}/tools`,
      inheritedToolsSourceBase: "oc://afora.config/tools",
    });
  });
  ...
  const sandboxModeSource =
    explicitSandboxMode !== undefined
      ...
      : inheritedSandboxMode !== undefined
        ...
        : "oc://afora.config/agents/defaults/sandbox/mode";
    ...
    source:
      explicitWorkspaceAccess !== undefined
        ...
        : inheritedWorkspaceAccess !== undefined
          ...
          : "oc://afora.config/agents/defaults/sandbox/workspaceAccess",
    scope: params.scope,
