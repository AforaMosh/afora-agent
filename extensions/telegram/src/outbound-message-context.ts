...
export type TelegramOutboundPromptContextMessage = {
  ...
  afora_prompt_context_timestamp_ms?: number;
  text?: string;
  caption?: string;
...
function resolveOutboundCacheMessageTimestamp(
  ...
  if (
    typeof msg.afora_prompt_context_timestamp_ms === "number" &&
    Number.isFinite(msg.afora_prompt_context_timestamp_ms)
  ) {
    return msg.afora_prompt_context_timestamp_ms;
  }
...
function buildOutboundCacheMessage(params: {
  ...
  return {
    ...
    ...(params.promptContextTimestampMs !== undefined
      ? { afora_prompt_context_timestamp_ms: params.promptContextTimestampMs }
      : {}),
    date:
