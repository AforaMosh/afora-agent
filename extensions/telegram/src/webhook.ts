...
import { isDiagnosticsEnabled } from "afora-agent/plugin-sdk/diagnostic-runtime";
import {
  logWebhookError,
  logWebhookProcessed,
  logWebhookReceived,
...
} from "afora-agent/plugin-sdk/logging-core";
import { parseStrictNonNegativeInteger } from "afora-agent/plugin-sdk/number-runtime";
import type { BackoffPolicy, RuntimeEnv } from "afora-agent/plugin-sdk/runtime-env";
import {
  computeBackoff,
  defaultRuntime,
...
import { readJsonBodyWithLimit } from "afora-agent/plugin-sdk/webhook-request-guards";
...
const TELEGRAM_WEBHOOK_ACCEPTED_HEADER = "x-afora-delivery-accepted";
...
function resolveTelegramWebhookClientIp(req: IncomingMessage, config?: AforaConfig): string {
