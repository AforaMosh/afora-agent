...
import { resolveAgentMaxConcurrent } from "afora-agent/plugin-sdk/model-session-runtime";
...
function createTelegramRunnerOptions(cfg: AforaConfig): RunOptions<unknown> {
  return {
    sink: {
