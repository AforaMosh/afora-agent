import { createChannelConfigUiHints } from "afora-agent/plugin-sdk/channel-config-ui-hints";
...
export const telegramChannelConfigUiHints = {
  ...
  execApprovals: {
    ...
    help: "Telegram-native exec approval routing and approver authorization. When unset, Afora auto-enables DM-first native approvals if approvers can be resolved for the selected bot account.",
  },
  ...
  "execApprovals.approvers": {
    ...
    help: "Telegram user IDs allowed to approve exec requests for this bot account. Use numeric Telegram user IDs. If you leave this unset, Afora falls back to numeric owner IDs inferred from commands.ownerAllowFrom when possible.",
  },
