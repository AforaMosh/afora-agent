...
import { isTruthyEnvValue, isWSL2Sync } from "afora-agent/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "afora-agent/plugin-sdk/string-coerce-runtime";

const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "AFORA_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "AFORA_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "AFORA_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable AFORA_TELEGRAM_DNS_RESULT_ORDER
