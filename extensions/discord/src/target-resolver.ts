...
import { buildMessagingTarget, type MessagingTarget } from "afora-agent/plugin-sdk/channel-targets";
import type { DirectoryConfigParams } from "afora-agent/plugin-sdk/directory-runtime";
