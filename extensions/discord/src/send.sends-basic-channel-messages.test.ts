...
vi.mock("afora-agent/plugin-sdk/web-media", () => discordWebMediaMockFactory());
...
let loadWebMedia: typeof import("afora-agent/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("afora-agent/plugin-sdk/web-media"));
