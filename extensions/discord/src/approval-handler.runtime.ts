...
import type { ExecApprovalActionDescriptor } from "afora-agent/plugin-sdk/approval-reply-runtime";
import type {
  DiscordExecApprovalConfig,
  AforaConfig,
} from "afora-agent/plugin-sdk/config-contracts";
import { logDebug, logError } from "afora-agent/plugin-sdk/logging-core";
