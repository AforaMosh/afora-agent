...
import { loadPreparedModelCatalog, resolveAgentDir } from "afora-agent/plugin-sdk/agent-runtime";
import { resolveNativeCommandSessionTargets } from "afora-agent/plugin-sdk/command-auth-native";
import type { AforaConfig } from "afora-agent/plugin-sdk/config-contracts";
import { buildPairingReply } from "afora-agent/plugin-sdk/conversation-runtime";
