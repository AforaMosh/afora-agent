...
import { createSubsystemLogger, formatDurationSeconds } from "afora-agent/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("afora-agent/plugin-sdk/runtime-env").createSubsystemLogger
>;
