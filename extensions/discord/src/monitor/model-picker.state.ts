...
import type { ModelsProviderData } from "afora-agent/plugin-sdk/models-provider-runtime";
import { parseStrictInteger, parseStrictPositiveInteger } from "afora-agent/plugin-sdk/number-runtime";
...
const loadModelsProviderRuntime = createLazyRuntimeModule(
  () => import("afora-agent/plugin-sdk/models-provider-runtime"),
);
