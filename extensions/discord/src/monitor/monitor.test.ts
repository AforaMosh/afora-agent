...
import { registerPluginInteractiveHandler } from "afora-agent/plugin-sdk/plugin-runtime";
import { getActivePluginRegistry } from "afora-agent/plugin-sdk/plugin-test-runtime";
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/afora-sessions-test.json");
