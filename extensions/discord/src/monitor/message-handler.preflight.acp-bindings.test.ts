...
import * as conversationBindingRuntime from "afora-agent/plugin-sdk/conversation-binding-runtime";
...
import { testing as sessionBindingTesting } from "afora-agent/plugin-sdk/conversation-runtime";
  ...
  return {
    ...createDiscordPreflightArgs({
      ...
      discordConfig: {
        ...
        import("afora-agent/plugin-sdk/config-contracts").AforaConfig["channels"]
      >["discord"],
