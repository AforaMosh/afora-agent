...
const SELECT_CONTROLS = {
  string: {
    ...
    customId: "__afora_discord_component_string_select_wildcard__",
    componentLabel: "select menu",
    label: "discord component select",
  },
  user: {
    type: ComponentType.UserSelect,
    customId: "__afora_discord_component_user_select_wildcard__",
    componentLabel: "user select",
    label: "discord component user select",
  },
  role: {
    type: ComponentType.RoleSelect,
    customId: "__afora_discord_component_role_select_wildcard__",
    componentLabel: "role select",
    label: "discord component role select",
  },
  mentionable: {
    type: ComponentType.MentionableSelect,
    customId: "__afora_discord_component_mentionable_select_wildcard__",
    componentLabel: "mentionable select",
    label: "discord component mentionable select",
  },
  channel: {
    type: ComponentType.ChannelSelect,
    customId: "__afora_discord_component_channel_select_wildcard__",
...
class DiscordComponentButton extends Button {
  ...
  override customId = "__afora_discord_component_button_wildcard__";
