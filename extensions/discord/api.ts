...
// Deprecated compatibility surface for existing @afora/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "afora-agent/plugin-sdk/runtime-group-policy";
...
/**
 * @deprecated Shipped `@afora/discord/api` compatibility only. Use native
