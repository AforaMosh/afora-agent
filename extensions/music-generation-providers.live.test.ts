...
const providerFilter = parseCsvFilter(process.env.AFORA_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.AFORA_LIVE_MUSIC_GENERATION_MODELS);
