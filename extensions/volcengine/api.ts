...
import { applyModelCompatPatch } from "afora-agent/plugin-sdk/provider-model-shared";
import type { ModelCompatConfig } from "afora-agent/plugin-sdk/provider-model-shared";
