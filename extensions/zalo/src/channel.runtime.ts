...
import { createAccountStatusSink } from "afora-agent/plugin-sdk/channel-outbound";
...
export async function notifyZaloPairingApproval(params: { cfg: AforaConfig; id: string }) {
