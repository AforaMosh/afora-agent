...
vi.mock("afora-agent/plugin-sdk/channel-pairing", () => ({
...
vi.mock("afora-agent/plugin-sdk/command-auth-native", () => ({
...
vi.mock("afora-agent/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("afora-agent/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("afora-agent/plugin-sdk/channel-inbound");
    vi.doUnmock("afora-agent/plugin-sdk/channel-pairing");
    vi.doUnmock("afora-agent/plugin-sdk/command-auth-native");
    vi.doUnmock("afora-agent/plugin-sdk/runtime-group-policy");
    vi.doUnmock("afora-agent/plugin-sdk/runtime-env");
    vi.doUnmock("afora-agent/plugin-sdk/reply-history");
    vi.doUnmock("afora-agent/plugin-sdk/routing");
