...
export type MatrixStreamingConfig = {
  ...
  block?: import("afora-agent/plugin-sdk/channel-outbound").ChannelStreamingBlockConfig;
  progress?: import("afora-agent/plugin-sdk/channel-outbound").ChannelStreamingProgressConfig;
  preview?: {
...
export type MatrixConfig = {
   ...
   * keys migrate via `afora doctor --fix`.
   * Default: `mode: "off"`.
   */
...
export type CoreConfig = {
  ...
  commands?: AforaConfig["commands"];
  session?: {
    store?: string;
    dmScope?: NonNullable<AforaConfig["session"]>["dmScope"];
  };
  messages?: {
    ackReaction?: string;
    ackReactionScope?: "group-mentions" | "group-all" | "direct" | "all" | "none" | "off";
