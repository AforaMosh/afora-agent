...
import type { OutputRuntimeEnv } from "afora-agent/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "afora-agent/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Afora Gateway",
    },
    confirm: {
