...
describe("discord live qa runtime", () => {
  ...
  it("resolves required Discord QA env vars", () => {
    expect(
      testing.resolveDiscordQaRuntimeEnv({
        AFORA_QA_DISCORD_GUILD_ID: "123456789012345678",
        AFORA_QA_DISCORD_CHANNEL_ID: "223456789012345678",
        AFORA_QA_DISCORD_DRIVER_BOT_TOKEN: "driver",
        AFORA_QA_DISCORD_SUT_BOT_TOKEN: "sut",
        AFORA_QA_DISCORD_SUT_APPLICATION_ID: "323456789012345678",
      }),
    ).toEqual({
  ...
  it("resolves optional Discord QA voice channel env var", () => {
    expect(
      testing.resolveDiscordQaRuntimeEnv({
        AFORA_QA_DISCORD_GUILD_ID: "123456789012345678",
        AFORA_QA_DISCORD_CHANNEL_ID: "223456789012345678",
        AFORA_QA_DISCORD_VOICE_CHANNEL_ID: "523456789012345678",
        AFORA_QA_DISCORD_DRIVER_BOT_TOKEN: "driver",
        AFORA_QA_DISCORD_SUT_BOT_TOKEN: "sut",
        AFORA_QA_DISCORD_SUT_APPLICATION_ID: "323456789012345678",
      }),
  ...
  it("fails when a required Discord QA env var is missing", () => {
    ...
    ).toThrow("AFORA_QA_DISCORD_SUT_APPLICATION_ID");
  });

  it("fails when Discord IDs are not snowflakes", () => {
    expect(() =>
      testing.resolveDiscordQaRuntimeEnv({
        AFORA_QA_DISCORD_GUILD_ID: "qa-guild",
        AFORA_QA_DISCORD_CHANNEL_ID: "223456789012345678",
        AFORA_QA_DISCORD_DRIVER_BOT_TOKEN: "driver",
        AFORA_QA_DISCORD_SUT_BOT_TOKEN: "sut",
        AFORA_QA_DISCORD_SUT_APPLICATION_ID: "323456789012345678",
      }),
    ).toThrow("AFORA_QA_DISCORD_GUILD_ID must be a Discord snowflake.");
  });
