...
export const SLACK_QA_APPROVAL_ACTION_PREFIX = "afora:approval:v1:";
...
export const SLACK_QA_APPROVAL_CHECKPOINT_DIR_ENV = "AFORA_QA_SLACK_APPROVAL_CHECKPOINT_DIR";
export const SLACK_QA_APPROVAL_CHECKPOINT_TIMEOUT_MS_ENV =
  "AFORA_QA_SLACK_APPROVAL_CHECKPOINT_TIMEOUT_MS";
