...
export const whatsappQaGroupOutboundMediaScenario: WhatsAppQaScenarioImplementation = {
  ...
  buildRun: () => {
    ...
    return {
      ...
      configMode: "allowlist",
      expectReply: true,
      input: `aforaqa reply with only this exact marker before group outbound media checks: ${token}`,
      matchText: token,
      target: "group",
    };
  },
...
export const whatsappQaGroupOutboundAudioScenario: WhatsAppQaScenarioImplementation = {
  ...
  buildRun: () => {
    ...
    return {
      ...
      configMode: "allowlist",
      expectReply: true,
      input: `aforaqa reply with only this exact marker before group outbound audio check: ${token}`,
      matchText: token,
      target: "group",
    };
  },
...
export const whatsappQaGroupOutboundPollScenario: WhatsAppQaScenarioImplementation = {
  ...
  buildRun: () => {
    ...
    return {
      ...
      configMode: "allowlist",
      expectReply: true,
      input: `aforaqa reply with only this exact marker before group outbound poll check: ${token}`,
      matchText: token,
      target: "group",
    };
  },
