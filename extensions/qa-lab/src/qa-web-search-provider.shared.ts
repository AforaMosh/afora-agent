...
export const QA_LAB_WEB_SEARCH_DENIED_INPUT_QUERY = "AFORA_QA_WEB_SEARCH_DENIED_INPUT";
...
export function createQaLabWebSearchProviderBase(): Omit<WebSearchProviderPlugin, "createTool"> {
  return {
    ...
    signupUrl: "https://docs.afora.ai/concepts/qa-e2e-automation",
    docsUrl: "https://docs.afora.ai/concepts/qa-e2e-automation",
    credentialPath: "",
    inactiveSecretPaths: [],
