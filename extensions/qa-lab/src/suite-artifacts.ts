...
export async function writeQaSuiteArtifacts(params: {
  ...
  runCrablineChannelDriverSmoke?: (
    params: Parameters<QaCrablineRuntime["runAforaCrablineChannelDriverSmoke"]>[0],
  ...
  const report = renderQaMarkdownReport({
    ...
    notes: createQaSuiteReportNotes({
      ...
      createCrablineChannelReportNotes: crablineRuntime?.createAforaCrablineChannelReportNotes,
    }),
  });
  const evidence =
