...
import { readRequestBodyWithLimit } from "afora-agent/plugin-sdk/webhook-ingress";
...
export const QA_WHATSAPP_BROADCAST_PROMPT_RE =
  /\baforaqa broadcast fanout check\s+([A-Z0-9_]+)\b/i;
...
const QA_GROUP_AUDIO_TRANSCRIPTION_TEXT =
  "aforaqa reply with only this exact marker after group audio preflight: WHATSAPP_QA_GROUP_AUDIO_TRANSCRIPT_OK";
const QA_GROUP_AUDIO_TRIGGER_SENTINEL = "AFORA_QA_GROUP_AUDIO_TRIGGER";
