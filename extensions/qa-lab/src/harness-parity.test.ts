...
const LEFT: HarnessVariant = { id: "left", label: "Left", runtime: "afora" };
const RIGHT: HarnessVariant = { id: "right", label: "Right", runtime: "afora" };
...
describe("harness parity", () => {
  ...
  it("labels mock token estimates separately from live usage", () => {
    const sourceCell = makeCell("afora", {
