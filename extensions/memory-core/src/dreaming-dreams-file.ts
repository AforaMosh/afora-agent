...
import { createAsyncLock } from "afora-agent/plugin-sdk/async-lock-runtime";
...
import { replaceManagedMarkdownBlock } from "afora-agent/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "afora-agent/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- afora:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- afora:dreaming:deep:end -->";
