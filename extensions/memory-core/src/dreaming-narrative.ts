...
const DIARY_START_MARKER = "<!-- afora:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- afora:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "afora:dreaming:backfill-entry";
