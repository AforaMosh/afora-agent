...
import { root } from "afora-agent/plugin-sdk/memory-core-host-engine-fs";
...
export async function collectLegacyMemoryHostEventSources(
  ...
  const { resolveMemoryHostEventLogPath } = await import("afora-agent/plugin-sdk/memory-host-events");
