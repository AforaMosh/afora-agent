...
const EXACT_PATH_SPECIFICITY_SQL_FUNCTION = "afora_memory_exact_path_specificity";
const NORMALIZED_PATH_CONTAINS_SQL_FUNCTION = "afora_memory_normalized_path_contains";
