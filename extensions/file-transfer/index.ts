// File Transfer plugin entrypoint registers its Afora integration.
import {
  definePluginEntry,
  type AnyAgentTool,
  type AforaPluginNodeHostCommand,
...
const fileTransferNodeHostCommands: AforaPluginNodeHostCommand[] = [
  {
    command: "file.fetch",
    cap: "file",
    dangerous: true,
