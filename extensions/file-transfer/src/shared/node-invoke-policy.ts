...
type PreflightResult =
  ...
  | {
      ok: false;
      result: AforaPluginNodeInvokePolicyResult;
    };
...
async function handleFileTransferInvoke(
  ctx: AforaPluginNodeInvokePolicyContext,
): Promise<AforaPluginNodeInvokePolicyResult> {
...
export function createFileTransferNodeInvokePolicy(): AforaPluginNodeInvokePolicy {
  return {
