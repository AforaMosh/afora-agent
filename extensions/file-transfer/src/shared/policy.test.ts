...
vi.mock("afora-agent/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("afora-agent/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("afora-agent/plugin-sdk/config-mutation");
  vi.resetModules();
});
