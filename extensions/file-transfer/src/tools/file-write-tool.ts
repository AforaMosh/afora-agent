...
import type { AnyAgentTool } from "afora-agent/plugin-sdk/agent-harness-runtime";
import { readMediaBuffer } from "afora-agent/plugin-sdk/media-store";
import { asBoolean, asNonArrayRecord } from "afora-agent/plugin-sdk/string-coerce-runtime";
