...
import { FsSafeError, root as fsRoot } from "afora-agent/plugin-sdk/security-runtime";
import {
  asNonArrayRecord,
...
const GENERATED_START = "<!-- afora:wiki:generated:start -->";
const GENERATED_END = "<!-- afora:wiki:generated:end -->";
const HUMAN_START = "<!-- afora:human:start -->";
const HUMAN_END = "<!-- afora:human:end -->";
