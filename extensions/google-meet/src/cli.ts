...
import { generateHexPkceVerifierChallenge } from "afora-agent/plugin-sdk/provider-auth";
import { generateOAuthState } from "afora-agent/plugin-sdk/provider-auth-runtime";
...
export function registerGoogleMeetCli(params: {
  ...
  const root = params.program
    ...
    .addHelpText("after", () => `\nDocs: https://docs.afora.ai/plugins/google-meet\n`);
