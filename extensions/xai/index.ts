...
// Xai plugin entrypoint registers its Afora integration.
...
import { defaultToolStreamExtraParams } from "afora-agent/plugin-sdk/provider-stream-shared";
import { jsonResult } from "afora-agent/plugin-sdk/provider-web-search";
import {
...
function createLazyCodeExecutionTool(ctx: AforaPluginToolContext) {
...
function createLazyXSearchTool(ctx: AforaPluginToolContext) {
  const effectiveConfig = ctx.runtimeConfig ?? ctx.config;
