...
export async function resolveXaiRealtimeApiKey(
  ...
  throw new Error(
    "xAI credentials missing for realtime voice. Sign in with `afora onboard --auth-choice xai-oauth`, run `afora onboard --auth-choice xai-api-key`, or set XAI_API_KEY.",
  );
}
