...
async function resolveXaiRealtimeApiKey(
  ...
  throw new Error(
    "xAI credentials missing for realtime STT. Sign in with `afora onboard --auth-choice xai-oauth`, or run `afora onboard --auth-choice xai-api-key`, or set XAI_API_KEY.",
  );
}
