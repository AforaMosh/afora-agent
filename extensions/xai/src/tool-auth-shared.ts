...
} from "afora-agent/plugin-sdk/secret-ref-readonly";
...
function readPluginXaiWebSearchApiKeyResult(cfg?: AforaConfig): ReadOnlyEnvSecretRefResolution {
...
export function resolveFallbackXaiAuth(cfg?: AforaConfig): XaiFallbackAuth | undefined {
