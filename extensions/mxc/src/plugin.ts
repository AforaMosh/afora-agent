import type { AforaPluginApi, AforaPluginService } from "afora-agent/plugin-sdk/plugin-entry";
...
export function registerMxcPlugin(api: AforaPluginApi): void {
  ...
  const cleanupService: AforaPluginService = {
