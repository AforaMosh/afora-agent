...
type AgentDefaultsModel = NonNullable<NonNullable<AforaConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<AforaConfig["agents"]>["defaults"]>["models"];
