...
// Intentionally NOT mocked: afora/plugin-sdk/ssrf-runtime, global fetch, and
// afora/plugin-sdk/logging-core (redactSensitiveText is the unit under proof).
...
function withRedactionDisabledConfig(): () => void {
  ...
  return () => {
    if (previous === undefined) {
      ...
      process.env.AFORA_CONFIG_PATH = previous;
    }
