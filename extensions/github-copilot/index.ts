// Github Copilot plugin entrypoint registers its Afora integration.
...
function resolveCopilotConfiguredPrimary(cfg: AforaConfig): string {
...
function applyCopilotDefaultModel(cfg: AforaConfig, modelRef: string): AforaConfig {
...
function buildGithubCopilotDomainConfigPatch(domain: string): Partial<AforaConfig> {
  ...
  } as unknown as Partial<AforaConfig>;
}
...
function clearGithubCopilotDomainConfigPatch(): Partial<AforaConfig> {
  return {
    models: {
      providers: {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: AforaConfig): GithubCopilotPluginConfig {
