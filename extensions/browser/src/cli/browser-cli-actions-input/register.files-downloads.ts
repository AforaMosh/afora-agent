...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload from Afora temp uploads or managed inbound media (e.g. /tmp/afora/uploads/file.pdf or media://inbound/<id>)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within afora temp downloads dir (default: /tmp/afora/downloads/...; fallback: os.tmpdir()/afora/downloads/...)",
    )
    .option("--target-id <id>", BROWSER_TAB_REFERENCE_HELP)
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within afora temp downloads dir (e.g. report.pdf or /tmp/afora/downloads/report.pdf)",
    )
    .option("--target-id <id>", BROWSER_TAB_REFERENCE_HELP)
    .option(
      "--timeout-ms <ms>",
