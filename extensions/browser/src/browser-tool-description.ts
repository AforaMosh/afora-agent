...
export function describeBrowserTool(opts: {
  ...
  return [
    "Control the browser via Afora's browser control server (status/start/stop/profiles/tabs/open/snapshot/screenshot/pdf print-to-PDF/download/console logs/dialog accept-dismiss/actions incl. act:evaluate to run JS in the page).",
    "Browser choice: omit profile to use the configured default (normally the isolated Afora-managed `afora` browser).",
