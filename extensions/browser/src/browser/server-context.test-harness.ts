...
/** Mocks a launched Afora Chrome process with the supplied pid. */
export function mockLaunchedChrome(
  launchAforaChrome: { mockResolvedValue: (value: RunningChrome) => unknown },
  pid: number,
) {
  const proc = new EventEmitter() as unknown as ChildProcessWithoutNullStreams;
  launchAforaChrome.mockResolvedValue({
    pid,
