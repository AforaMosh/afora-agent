...
const volatileAliasStateSymbol = Symbol.for("afora.browser.session-tabs.volatile-aliases");
const volatileExactStateSymbol = Symbol.for("afora.browser.session-tabs.exact-volatile-aliases");
