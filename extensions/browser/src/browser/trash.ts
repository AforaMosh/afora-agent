...
import { movePathToTrash as movePathToTrashWithAllowedRoots } from "afora-agent/plugin-sdk/browser-config";
...
export async function movePathToTrash(targetPath: string): Promise<string> {
  return await movePathToTrashWithAllowedRoots(targetPath, {
    // Managed browser data follows AFORA_STATE_DIR/AFORA_CONFIG_PATH, which
