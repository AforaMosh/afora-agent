...
// Afora operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that Afora itself navigated to a blocked URL.
...
/** Quarantine and close a tab that Afora navigated to a blocked URL. */
