 ...
 *
 * The relay authenticates the loopback link between Afora and the paired
...
} from "afora-agent/plugin-sdk/secret-file";
 ...
 * startup and `afora browser extension pair` — both run on the machine that
