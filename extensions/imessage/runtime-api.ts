...
import type { AforaConfig as RuntimeApiAforaConfig } from "afora-agent/plugin-sdk/config-contracts";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiAforaConfig["channels"]>["imessage"]>,
