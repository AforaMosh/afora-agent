// Webhooks plugin entrypoint registers its Afora integration.
...
function registerWebhookRoutes(api: AforaPluginApi): void {
...
export default definePluginEntry({
  ...
  name: "Webhooks",
  description:
    "Authenticated inbound webhooks that bind external automation to Afora TaskFlows.",
