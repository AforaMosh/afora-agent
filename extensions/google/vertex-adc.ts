...
const VERTEX_ADC_TEST_API_KEY = Symbol.for("afora.google.vertexAdcTestApi");
 ...
 *      Afora, included for completeness).
 ...
 * existing fetchImpl test seam and the Afora upstream behaviour); when the
