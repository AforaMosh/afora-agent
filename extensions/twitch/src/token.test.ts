...
describe("token", () => {
  const originalAccessToken = process.env.AFORA_TWITCH_ACCESS_TOKEN;
  ...
  afterEach(() => {
    ...
    if (originalAccessToken === undefined) {
      ...
      process.env.AFORA_TWITCH_ACCESS_TOKEN = originalAccessToken;
    }
  });
  ...
  describe("resolveTwitchToken", () => {
    ...
    it("should prioritize config token over env var (simplified config)", () => {
      process.env.AFORA_TWITCH_ACCESS_TOKEN = "oauth:env-token";
