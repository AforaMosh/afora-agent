...
describe("irc inbound behavior", () => {
  ...
  it("issues a DM pairing challenge and sends the reply to the sender nick", async () => {
    ...
    expect(sendReply).toHaveBeenCalledWith(
      ...
      [
        ...
        "```",
        "afora pairing approve irc CODE",
        "```",
      ].join("\n"),
      undefined,
    );
  ...
  it.each([
    { label: "ordinary nick", nick: "Afora", text: "Afora: hello", mentioned: true },
    { label: "ASCII case folding", nick: "Afora", text: "afora: hello", mentioned: true },
