...
describe("codex package manifest", () => {
  it("keeps runtime dependencies in the package manifest", () => {
    ...
    expect(packageJson.devDependencies).toHaveProperty("@afora/plugin-sdk");
    ...
    expect(packageJson.afora?.release?.requireLatestDependencies).toEqual(["@openai/codex"]);
    expect(packageJson.afora?.install?.requiredPlatformPackages).toEqual([
