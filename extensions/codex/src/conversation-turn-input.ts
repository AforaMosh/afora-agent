...
import type { PluginHookInboundClaimEvent } from "afora-agent/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "afora-agent/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // Afora channels expose either local staged files or remote URLs. Keep
