...
import { wrapToolWithBeforeToolCallHook } from "afora-agent/plugin-sdk/agent-harness-runtime";
import {
...
// Codex tests cover afora owned tool runtime contract plugin behavior.
...
describe("Afora-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetAforaOwnedToolHooks();
  });
