/**
 * Native Codex app-server compaction bridge for bound Afora sessions.
 */
...
import { resolveDefaultAgentId } from "afora-agent/plugin-sdk/agent-scope-runtime";
...
export async function maybeCompactCodexAppServerSession(
  ...
  warnIfIgnoringAforaCompactionOverrides(params);
...
function warnIfIgnoringAforaCompactionOverrides(
  params: CompactEmbeddedAgentSessionParams,
): void {
        ...
        const completionWatch = watchCodexNativeCompactionCompletion({
          ...
          retireUnconfirmed: async () => {
            ...
            if (usesSupervisionConnection) {
              ...
              // Afora-owned remote binding. Keep the lifecycle fence held
