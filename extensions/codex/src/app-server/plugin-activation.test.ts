...
describe("Codex plugin activation", () => {
  ...
  it("requires workspace-directory plugins to be activated outside Afora", async () => {
    ...
    expect(result.diagnostics[0]?.message).toContain("installed and enabled outside Afora");
