...
const ARTIFACT_HASH_DOMAIN = "afora-codex-app-server-runtime-artifact-v1\0";
...
const ARTIFACT_BINDINGS_SYMBOL = Symbol.for("afora.codexAppServerRuntimeArtifactBindings");
