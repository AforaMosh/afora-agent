...
import type { ManagedProcess, AforaExecServer } from "./sandbox-exec-server/types.js";
...
function createExecServer(sandbox: SandboxContext): AforaExecServer {
  return { sandbox } as AforaExecServer;
}
