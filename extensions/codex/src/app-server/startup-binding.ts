...
import { root as openSafeFilesystemRoot } from "afora-agent/plugin-sdk/file-access-runtime";
...
// Codex owns proactive auto-compaction, but Afora must not resume a native
