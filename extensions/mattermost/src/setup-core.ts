...
import { createSetupInputPresenceValidator } from "afora-agent/plugin-sdk/setup-runtime";
import {
...
export function resolveMattermostAccountWithSecrets(cfg: AforaConfig, accountId: string) {
