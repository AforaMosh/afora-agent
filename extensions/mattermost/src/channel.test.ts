...
vi.mock("afora-agent/plugin-sdk/ssrf-runtime", async () => {
  const original = (await vi.importActual("afora-agent/plugin-sdk/ssrf-runtime")) as Record<
    string,
    unknown
  >;
