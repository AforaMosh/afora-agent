 ...
 */
const ACCOUNT_STATES_KEY = Symbol.for("afora.mattermost.slash-account-states");
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("./runtime-api.js").AforaConfig;
 ...
 */
export function registerSlashCommandRoute(api: AforaPluginApi) {
