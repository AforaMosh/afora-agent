...
function mergeZalouserAccountConfig(cfg: AforaConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: AforaConfig; accountId?: string | null }) {
