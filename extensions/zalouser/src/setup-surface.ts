...
function ensureZalouserPluginEnabled(cfg: AforaConfig): AforaConfig {
      ...
      await prompter.note(
        [
          ...
          t("wizard.zalouser.peersLookupTip", {
            command: formatCliCommand("afora directory peers list --channel zalouser"),
          }),
        ].join("\n"),
        ...
        await prompter.note(
          [
            ...
            t("wizard.zalouser.groupsLookupTip", {
              command: formatCliCommand("afora directory groups list --channel zalouser"),
            }),
