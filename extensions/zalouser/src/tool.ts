...
import { stringEnum } from "afora-agent/plugin-sdk/channel-actions";
import type { AnyAgentTool, AforaPluginToolContext } from "afora-agent/plugin-sdk/core";
import { formatErrorMessage } from "afora-agent/plugin-sdk/error-runtime";
import { jsonResult as json, type AgentToolResult } from "afora-agent/plugin-sdk/tool-results";
...
type ZalouserToolContext = Pick<AforaPluginToolContext, "deliveryContext">;
