...
import type { RealtimeVoiceSessionConnection } from "afora-agent/plugin-sdk/realtime-voice";
import { normalizeRealtimeVoiceResponseOutcome } from "afora-agent/plugin-sdk/realtime-voice";
