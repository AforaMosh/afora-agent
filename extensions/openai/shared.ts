...
import { findCatalogTemplate } from "afora-agent/plugin-sdk/provider-catalog-shared";
import {
...
export function resolveConfiguredOpenAIBaseUrl(cfg: AforaConfig | undefined): string {
