# GitHub Copilot agent runtime (Afora plugin)

External Afora plugin that registers a `copilot` agent harness backed by `@github/copilot-sdk` and the GitHub Copilot CLI.
...
entry; `auto` never picks it. Afora remains the default embedded runtime.
