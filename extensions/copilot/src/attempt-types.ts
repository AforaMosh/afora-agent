...
import type { TranscriptEntryAnchor } from "afora-agent/plugin-sdk/session-transcript-runtime";
...
export const COPILOT_SETTLED_FINALIZATION_SYSTEM_MESSAGE =
  "You are Afora's isolated final-answer stage. Produce exactly one concise final " +
