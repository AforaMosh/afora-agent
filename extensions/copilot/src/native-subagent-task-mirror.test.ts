...
vi.mock("afora-agent/plugin-sdk/agent-harness-task-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("afora-agent/plugin-sdk/agent-harness-task-runtime")>();
  return {
    ...actual,
