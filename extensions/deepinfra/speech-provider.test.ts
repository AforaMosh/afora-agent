...
import { requireFirstPostJsonRequest } from "afora-agent/plugin-sdk/test-fixtures";
...
vi.mock("afora-agent/plugin-sdk/provider-http", () => ({
...
afterAll(() => {
  vi.doUnmock("afora-agent/plugin-sdk/provider-http");
  vi.resetModules();
});
