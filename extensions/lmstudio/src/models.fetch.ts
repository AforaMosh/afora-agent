...
import { SELF_HOSTED_DEFAULT_COST } from "afora-agent/plugin-sdk/provider-setup";
...
/** Discovers LLM models from LM Studio and maps them to Afora model definitions. */
