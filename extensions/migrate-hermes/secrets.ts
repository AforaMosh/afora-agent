...
import { updateAuthProfileStoreWithLock } from "afora-agent/plugin-sdk/provider-auth";
...
async function buildOpenCodeSecretCandidates(
  ...
  // Afora's Copilot token profile cannot preserve OpenCode enterprise routing yet.
