...
import { getPluginRuntimeGatewayRequestScope } from "afora-agent/plugin-sdk/plugin-runtime";
import { buildControlUiCatalogSessionUrl } from "afora-agent/plugin-sdk/session-catalog-runtime";
import {
