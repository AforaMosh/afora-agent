...
import { createReplyToFanout } from "afora-agent/plugin-sdk/channel-outbound";
import {
  attachChannelToResult,
  createAttachedChannelResultAdapter,
} from "afora-agent/plugin-sdk/channel-send-result";
import type { MessagePresentationBlock } from "afora-agent/plugin-sdk/interactive-runtime";
import {
...
import { statRegularFileSync } from "afora-agent/plugin-sdk/security-runtime";
import {
  isRecord,
  normalizeLowercaseStringOrEmpty,
  normalizeStringEntries,
} from "afora-agent/plugin-sdk/string-coerce-runtime";
import { convertMarkdownTables } from "afora-agent/plugin-sdk/text-chunking";
...
const RENDERED_FEISHU_CARD = Symbol("afora.renderedFeishuCard");
const FEISHU_PRESENTATION_FALLBACK_MARKER = "__aforaPresentationFallback";
