...
type FeishuReadContext = FeishuActionReadContext | AforaPluginToolContext;
...
function resolveFeishuReadGroupPolicy(cfg: AforaConfig, account: ResolvedFeishuAccount) {
