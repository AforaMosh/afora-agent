...
import { isRecord, readStringValue as readString } from "afora-agent/plugin-sdk/string-coerce-runtime";
...
export function registerFeishuDriveTools(api: AforaPluginApi) {
  if (!api.config) {
    return;
  }
