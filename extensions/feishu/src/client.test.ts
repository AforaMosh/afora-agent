...
const FEISHU_HTTP_TIMEOUT_ENV_VAR = "AFORA_FEISHU_HTTP_TIMEOUT_MS";
...
describe("createFeishuClient HTTP timeout", () => {
  ...
  it("uses Afora's ambient proxy agent for Feishu HTTP API requests", async () => {
