...
import { buildApprovalReactionPromptPayloadForRequest } from "afora-agent/plugin-sdk/approval-reaction-runtime";
import { buildTypedApprovalPresentation } from "afora-agent/plugin-sdk/approval-reply-runtime";
import type {
  ExecApprovalRequest,
