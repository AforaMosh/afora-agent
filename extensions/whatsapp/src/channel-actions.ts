...
function areWhatsAppAgentReactionsEnabled(params: { cfg: AforaConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: AforaConfig) {
