...
const WHATSAPP_TEST_CFG: AforaConfig = {
  channels: { whatsapp: {} },
};
...
vi.mock("afora-agent/plugin-sdk/outbound-media", async () => {
...
describe("web outbound", () => {
  ...
  it("redacts recipients and poll text in outbound logs", async () => {
    const logPath = path.join(os.tmpdir(), `afora-outbound-${crypto.randomUUID()}.log`);
