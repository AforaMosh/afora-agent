...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "afora-agent/plugin-sdk/config-contracts";
...
export function listWhatsAppAuthDirs(cfg: AforaConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AforaConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AforaConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AforaConfig): ResolvedWhatsAppAccount[] {
