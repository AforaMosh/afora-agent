...
import { normalizeOptionalAccountId } from "afora-agent/plugin-sdk/account-core";
import { resolveOutboundSendDep } from "afora-agent/plugin-sdk/channel-outbound";
import {
...
import { sendTextMediaPayload } from "afora-agent/plugin-sdk/reply-payload";
...
function resolveQuoteLookupAccountId(cfg?: AforaConfig, accountId?: string | null): string {
