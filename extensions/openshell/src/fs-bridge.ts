...
import { root as fsRoot } from "afora-agent/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "afora-agent/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "afora-agent/plugin-sdk/sandbox";
import { FsSafeError, isPathInside } from "afora-agent/plugin-sdk/security-runtime";
...
const MATERIALIZED_SKILLS_CONTAINER_PARTS = [".afora", "sandbox-skills", "skills"] as const;
