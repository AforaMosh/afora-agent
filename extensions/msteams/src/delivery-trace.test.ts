...
import { chunkMarkdownTextWithMode, resolveChunkMode } from "afora-agent/plugin-sdk/reply-chunking";
import { convertMarkdownTables } from "afora-agent/plugin-sdk/text-chunking";
import { describe, it } from "vitest";
import type { AforaConfig, ReplyPayload } from "../runtime-api.js";
...
function setupMSTeamsTrace(recorder: WireRecorder, traceCase: MSTeamsTraceCase) {
  ...
  const created = createMSTeamsReplyDispatcher({
    cfg: { channels: { msteams: {} } } as AforaConfig,
    agentId: "agent",
    ...
    conversationRef: {
      ...
      agent: { id: "28:trace-bot", name: "Afora" },
      conversation: {
