...
import type { ChannelDirectoryAdapter } from "afora-agent/plugin-sdk/channel-contract";
import { listDirectoryEntriesFromSources } from "afora-agent/plugin-sdk/directory-runtime";
