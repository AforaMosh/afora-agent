...
metadata: { "afora": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- Afora CLI path: `node --inspect-brk afora.mjs ...`
- Afora test path: `AFORA_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
