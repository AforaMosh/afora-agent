...
1. Download the runtime for your OS (extracts into `$AFORA_STATE_DIR/tools/sherpa-onnx-tts/runtime`, default `~/.afora/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `$AFORA_STATE_DIR/tools/sherpa-onnx-tts/models`, default `~/.afora/tools/sherpa-onnx-tts/models`)
