// Minimal @afora/ai consumer: one isolated runtime, built-in providers,
// one streamed completion. Uses only the public package surface — no Afora
...
const prompt =
  ...
  "Reply with one short sentence: what is @afora/ai?";
