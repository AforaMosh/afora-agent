# @afora/ai example: minimal chat completion

Smallest possible consumer of the published `@afora/ai` package: creates an
isolated runtime, registers the built-in API providers, and streams one
completion. No Afora application code is involved — inside this repo the
