      ...
      exa: {
        config: {
          webSearch: {
            ...
            baseUrl: "https://api.exa.ai", // optional; Afora appends /search
          },
        },
      },
    },
