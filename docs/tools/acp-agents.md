...
| Run OpenClaw itself as an ACP agent for an editor or client                                     | [`openclaw acp`](/cli/acp)            | Self-contained mode: the ACP client launches the local OpenClaw agent and tools over stdio                                                                                  |
...
| `openclaw`   | Self-contained OpenClaw agent through `openclaw acp` | Runs the local OpenClaw agent loop and tools without a Gateway.                     |
...
- [`openclaw acp` (self-contained agent)](/cli/acp)
