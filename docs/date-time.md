...
Afora uses the configured **user timezone** for message envelopes, system events, and
...
Rendered clock values follow the operating system and locale preference. Afora
