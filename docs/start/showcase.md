---
summary: "Community-built projects and integrations powered by Afora"
title: "Showcase"
description: "Real-world Afora projects from the community"
read_when:
  - Looking for real Afora usage examples
  - Updating community project highlights
---

Community-built Afora projects: PR review loops, mobile apps, home automation, voice systems, devtools, and memory workflows, built chat-native on Telegram, WhatsApp, Discord, and terminals.

<Info>
**Want to be featured?** Share your project in [#self-promotion on Discord](https://discord.gg/clawd) or [tag @afora on X](https://x.com/afora).
</Info>
...
Keeps Afora usable on 2-4 GB machines: checks free memory and trims heavy features before the box starts swapping. [Source on GitHub](https://github.com/mirajmahmudul/afora-lite-mode).
</Card>

<Card title="tokenomics cost tracker" icon="coins" href="https://github.com/ncz-os/tokenomics">
  **@ncz-os** • `devtools` `costs` `tokens`

Token cost tracker from an NVIDIA engineer with first-class Afora support: see exactly where your agent spend goes, per model and per session.
</Card>
...
Had Afora build its own Google Analytics query tool, then packaged and published it to ClawHub.
</Card>
...
OpenCode finishes the change, opens a PR, Afora reviews the diff and replies in Telegram with suggestions plus a clear merge verdict.

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="Afora PR review feedback delivered in Telegram" />
</Card>

<Card title="Wine Cellar Skill in Minutes" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

Asked "Robby" (@afora) for a local wine cellar skill. It requests a sample CSV export and a store path, then builds and tests the skill (962 bottles in the example).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="Afora building a local wine cellar skill from CSV" />
</Card>
...
Desktop app to manage skills and commands across Agents, Claude, Codex, and Afora.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Useful for remote Afora instances.
...
CLI for Linear that integrates with agentic workflows (Claude Code, Afora). Manage issues, projects, and workflows from the terminal.
</Card>
...
Claude Code discovered and confirmed the purifier controls, then Afora takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via Afora" />
</Card>

<Card title="Pretty sky camera shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill`

Triggered by a roof camera: ask Afora to snap a sky photo whenever it looks pretty. It designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by Afora" />
</Card>

<Card title="Visual morning briefing scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `telegram`

A scheduled prompt generates one scene image each morning (weather, tasks, date, favorite post or quote) via an Afora persona.
</Card>
...
Afora connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `todoist` `skill` `telegram`

Automated Todoist tasks and had Afora generate the skill directly in Telegram chat.
</Card>
...
Set Afora loose on car dealers: it handled the back-and-forth negotiation and knocked $4,200 off the price.
</Card>
...
Chinese learning engine with pronunciation feedback and study flows via Afora.
...
<Card title="Obsidian second brain" icon="book" href="https://notesbylex.com/afora-the-missing-piece-for-obsidians-second-brain">
...
One tap on a Pebble Ring starts a voice conversation with Afora — agent access from a wearable.
</Card>
...
iPhone Action Button wired to Afora: press, talk, and the agent talks back like a walkie-talkie.
</Card>

<Card title="Clawdia phone bridge" icon="phone" href="https://github.com/alejandroOPI/clawdia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`

Vapi voice assistant to Afora HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
Packaging, deployment, and integrations that make Afora easier to run and extend.

<CardGroup cols={2}>

<Card title="Home Assistant add-on" icon="home" href="https://github.com/ngutman/afora-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`

Afora gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>

<Card title="Home Assistant skill" icon="toggle-on" href="https://clawhub.ai/homeofe/skills/afora-homeassistant">
...
<Card title="Nix packaging" icon="snowflake" href="https://github.com/afora/nix-afora">
  **@afora** • `nix` `packaging` `deployment`

Batteries-included nixified Afora configuration for reproducible deployments.
</Card>
...
The physical-world side of Afora: homes, sensors, cameras, vacuums, and other devices.
...
Afora found the HomePods on the local network and wrote itself a skill to control them.
</Card>
...
Nix-native home automation with Afora as the interface, plus Grafana dashboards.
...
Full astronomy gear marketplace. Built with and around the Afora ecosystem.
</Card>
...
<Steps>
  <Step title="Share it">
    Post in [#self-promotion on Discord](https://discord.gg/clawd) or [tweet @afora](https://x.com/afora).
  </Step>
...
- [Afora](/start/afora)
- [Full X showcase on afora.ai](https://afora.ai/showcase/)
