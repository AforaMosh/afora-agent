...
```bash
afora plugins install @afora/fish-audio-speech
```
...
notes, and raw PCM at 8 kHz for telephony. For Discord voice, Afora consumes
...
Fish voice library. Afora lists your voices first, then a bounded page of
...
The first utterance downloads about 6.8 GB of model and codec data. Afora
