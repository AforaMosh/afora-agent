---
summary: "Azure AI Speech text-to-speech for Afora replies"
read_when:
...
Azure Speech is a bundled Azure AI Speech text-to-speech provider. Afora
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Afora synthesizes the audio
...
<AccordionGroup>
  <Accordion title="Authentication">
    ...
    is sent as `Ocp-Apim-Subscription-Key`; Afora derives
  ...
  <Accordion title="Audio outputs">
    ...
    `ogg-24khz-16bit-mono-opus`, and `riff-24khz-16bit-mono-pcm`. Afora
