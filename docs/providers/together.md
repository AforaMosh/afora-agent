...
title: "Together AI"
read_when:
  - You want to use Together AI with Afora
...
Afora bundles it as the `together` provider.
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    afora onboard --auth-choice together-api-key
    ```
  </Step>
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.afora/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `afora models list --provider together`
