---
summary: "Afora Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
Afora Anthropic Vertex provider plugin for Claude models on Google Vertex AI.

## Distribution

- Package: `@afora/anthropic-vertex-provider`
...
`/think off` or the native `/think xhigh|max` levels. Afora publishes its
