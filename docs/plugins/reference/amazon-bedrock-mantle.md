---
summary: "Afora Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing."
read_when:
...
Afora Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing.

## Distribution

- Package: `@afora/amazon-bedrock-mantle-provider`
