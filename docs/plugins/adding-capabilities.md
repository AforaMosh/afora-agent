---
summary: "Contributor guide for adding a new shared capability to the Afora plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Afora core developers. If you are
...
Use this when Afora needs a new shared domain such as embeddings, image
