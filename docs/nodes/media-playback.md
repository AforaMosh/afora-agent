...
read_when:
  ...
  - Comparing media format support across Afora clients
  - Debugging playback metadata, transcoding, or codec availability
title: "Media playback"
---

Afora chat clients play assistant audio and video attachments inline. The
...
This page covers playback in Afora clients. Channel delivery, inbound media
...
table above is the cross-client contract Afora targets.
...
Afora also uses `ffprobe`, when available, to fill audio duration and video
...
rendition. If either step cannot safely handle the source, Afora serves the
