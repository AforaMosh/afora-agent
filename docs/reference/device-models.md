---
summary: "How Afora vendors Apple device model identifiers for friendly names in the macOS app."
read_when:
...
Files in `apps/macos/Sources/Afora/Resources/DeviceModels/`:
...
2. Update `apps/macos/Sources/Afora/Resources/DeviceModels/NOTICE.md` with the new SHAs.
...
curl -fsSL "https://raw.githubusercontent.com/kyle-seongwoo-jun/apple-device-identifiers/${IOS_COMMIT}/ios-device-identifiers.json" \
  -o apps/macos/Sources/Afora/Resources/DeviceModels/ios-device-identifiers.json

curl -fsSL "https://raw.githubusercontent.com/kyle-seongwoo-jun/apple-device-identifiers/${MAC_COMMIT}/mac-device-identifiers.json" \
  -o apps/macos/Sources/Afora/Resources/DeviceModels/mac-device-identifiers.json
```
