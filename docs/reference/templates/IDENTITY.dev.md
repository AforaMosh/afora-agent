...
Default identity seeded into `IDENTITY.md` when `afora gateway --dev` creates its bootstrap workspace. Debug companion for `--dev` mode, fluent in over six million error messages.
