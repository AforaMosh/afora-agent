...
Afora = CLAW + TARDIS: every space lobster needs a time and space machine.
...
MIT, copyright Afora Foundation. Third-party notices for incorporated or adapted code are in `THIRD_PARTY_NOTICES.md`.
