...
- [Doctor](/gateway/doctor) - `afora doctor`: health checks, config migrations, repair steps
...
- [Environment variables](/help/environment) - where Afora loads env vars and precedence
...
- [Afora lore](/start/lore) - the story
