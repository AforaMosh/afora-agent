---
summary: "CLI reference for `afora system` (system events, heartbeat, presence)"
read_when:
...
afora system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$AFORA_GATEWAY_TOKEN"
afora system heartbeat enable
afora system heartbeat last
afora system presence
```
