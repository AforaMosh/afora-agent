---
summary: "CLI reference for `afora voicecall` (voice-call plugin command surface)"
read_when:
...
afora voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
afora voicecall call     -m <text> [-t <phone>] [--mode <m>]
afora voicecall start    --to <phone> [--message <text>] [--mode <m>]
afora voicecall continue --call-id <id> --message <text>
afora voicecall speak    --call-id <id> --message <text>
afora voicecall dtmf     --call-id <id> --digits <digits>
afora voicecall end      --call-id <id>
afora voicecall status   [--call-id <id>] [--json]
afora voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
afora voicecall latency  [--file <path>] [--last <n>]
afora voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `Afora voice call smoke test.` | Message to speak during the smoke call. |
...
afora voicecall smoke --to "+15555550123"        # dry run
afora voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
afora voicecall call --to "+15555550123" --message "Hello"
afora voicecall call -m "Heads up" --mode notify
```
...
```bash
afora voicecall expose --mode serve
afora voicecall expose --mode funnel
afora voicecall expose --mode off
```
