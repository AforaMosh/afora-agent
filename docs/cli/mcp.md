...
| Give Codex app-server scoped OpenClaw-managed MCP tools             | `mcp.servers.<name>.codex`                                           | OpenClaw keeps the server and credentials, then exposes policy-filtered dynamic tools to eligible Codex runs. |
