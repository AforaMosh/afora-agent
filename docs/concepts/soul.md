---
summary: "Use SOUL.md to give your Afora agent an actual voice instead of generic assistant sludge"
read_when:
...
`SOUL.md` is where your agent's voice lives. Afora injects it into normal
...
written once and forgotten. For Afora, `SOUL.md` is that layer: write
...
<CardGroup cols={2}>
  <Card title="Agent workspace" href="/concepts/agent-workspace" icon="folder-open">
    Workspace files Afora injects into model context.
  </Card>
  <Card title="System prompt" href="/concepts/system-prompt" icon="message-lines">
    How `SOUL.md` is composed into Afora and Codex runtime context.
  </Card>
