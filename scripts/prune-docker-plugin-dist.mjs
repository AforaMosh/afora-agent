...
/**
 * Parses AFORA_EXTENSIONS into the bundled plugin ids that Docker should keep.
 */
...
export function pruneDockerPluginDist(params = {}) {
  ...
  const bundledPluginDir = env.AFORA_BUNDLED_PLUGIN_DIR ?? "extensions";
  const keepPluginIds = parseDockerPluginKeepList(env.AFORA_EXTENSIONS);
