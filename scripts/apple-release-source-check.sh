...
EXPECTED_COMMIT="$(afora_trim_build_metadata_value "${EXPECTED_COMMIT}")"
if ! afora_is_full_git_commit "${EXPECTED_COMMIT}"; then
...
if ! afora_is_full_git_commit "${CHECKOUT_COMMIT}"; then
