// Macos Discord script supports Afora repository automation.
...
${this.input.guestNode} ${this.input.guestAforaEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestAforaEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestAforaEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestAforaEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestAforaEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestAforaEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestAforaEntry} gateway restart
${this.input.guestNode} ${this.input.guestAforaEntry} channels status --probe --json`);
  }
