...
const pluginRecordSnapshot = () => {
  const config = readJson(aforaPath("afora.json"));
...
function aforaPath(...parts) {
  return path.join(home, ".afora", ...parts);
}
...
function seedInstallState() {
  const pluginRoot = aforaPath("extensions", "lossless-claw");
  const pluginSource = path.join(pluginRoot, "index.js");
  const pluginManifest = path.join(pluginRoot, "afora.plugin.json");
  ...
  writeJson(process.env.AFORA_CONFIG_PATH, { plugins: {} });
  writePluginInstallIndexForE2E({
    version: 1,
    warning: "DO NOT EDIT. This file is generated by Afora plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("Afora will continue without it")
  );
}
...
function assertCorruptPluginDetails(plugins, pluginId) {
  ...
  const expectedFragments = disabledAfterFailure
    ? [
        ...
        "Afora will continue without it",
