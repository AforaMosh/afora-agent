...
const allowDegradedReady =
  ...
  process.env.AFORA_UPGRADE_SURVIVOR_READYZ_ALLOW_DEGRADED === "1";
const timeoutOption = optionValue(
  "--timeout-ms",
  "AFORA_UPGRADE_SURVIVOR_PROBE_TIMEOUT_MS",
  "60000",
);
const attemptTimeoutOption = optionValue(
  "--attempt-timeout-ms",
  "AFORA_UPGRADE_SURVIVOR_PROBE_ATTEMPT_TIMEOUT_MS",
  "5000",
);
const maxBodyOption = optionValue(
  "--max-body-bytes",
  "AFORA_UPGRADE_SURVIVOR_PROBE_MAX_BODY_BYTES",
  "1048576",
);
