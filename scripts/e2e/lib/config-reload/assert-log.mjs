...
const logPath = process.env.AFORA_CONFIG_RELOAD_LOG_PATH ?? "/tmp/config-reload-e2e.log";
const deadlineMs = Date.now() + readPositiveIntEnv("AFORA_CONFIG_RELOAD_LOG_TIMEOUT_MS", 30_000);
const maxReadBytes = readPositiveIntEnv("AFORA_CONFIG_RELOAD_LOG_MAX_READ_BYTES", 256 * 1024);
