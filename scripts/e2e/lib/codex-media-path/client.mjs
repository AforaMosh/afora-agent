...
const appServerLog =
  process.env.AFORA_CODEX_MEDIA_PATH_APP_SERVER_LOG ??
  "/tmp/afora-codex-media-path-app-server.jsonl";
const timeoutSeconds = readPositiveIntEnv("AFORA_CODEX_MEDIA_PATH_TIMEOUT_SECONDS", 180);
const logTailMaxBytes = readPositiveIntEnv(
  "AFORA_CODEX_MEDIA_PATH_LOG_TAIL_MAX_BYTES",
  2 * 1024 * 1024,
);
