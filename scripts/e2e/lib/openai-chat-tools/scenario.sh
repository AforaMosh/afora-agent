...
MODEL_REF="${AFORA_OPENAI_CHAT_TOOLS_MODEL:?missing AFORA_OPENAI_CHAT_TOOLS_MODEL}"
GATEWAY_LOG="/tmp/afora-openai-chat-tools-gateway.log"
CLIENT_LOG="/tmp/afora-openai-chat-tools-client.log"
gateway_pid=""
...
PORT="$PORT" AFORA_GATEWAY_TOKEN="$TOKEN" MODEL_REF="$MODEL_REF" \
