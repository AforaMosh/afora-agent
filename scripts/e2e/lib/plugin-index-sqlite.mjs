...
const JSON_ARTIFACT_MAX_BYTES = readPositiveIntEnv(
  "AFORA_PLUGIN_INDEX_JSON_MAX_BYTES",
  1024 * 1024,
);
...
function sqlitePath(root = stateDir()) {
  return path.join(root, "state", "afora.sqlite");
}
...
export function writePluginInstallIndexForE2E(index, options = {}) {
  ...
  try {
    ...
    db.prepare(
      ...
      index.warning ?? "DO NOT EDIT. This row is generated by Afora plugin registry commands.",
      now,
    );
  } finally {
    db.close();
