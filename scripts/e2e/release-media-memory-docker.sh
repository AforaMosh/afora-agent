...
IMAGE_NAME="$(docker_e2e_resolve_image "afora-release-media-memory-e2e" AFORA_RELEASE_MEDIA_MEMORY_E2E_IMAGE)"
SKIP_BUILD="${AFORA_RELEASE_MEDIA_MEMORY_E2E_SKIP_BUILD:-0}"
run_log=""
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-media-memory "${AFORA_CURRENT_PACKAGE_TGZ:-}")"
...
AFORA_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-media-memory empty)"
