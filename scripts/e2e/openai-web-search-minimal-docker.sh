...
IMAGE_NAME="$(docker_e2e_resolve_image "afora-openai-web-search-minimal-e2e" AFORA_OPENAI_WEB_SEARCH_MINIMAL_E2E_IMAGE)"
SKIP_BUILD="${AFORA_OPENAI_WEB_SEARCH_MINIMAL_E2E_SKIP_BUILD:-0}"
...
AFORA_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 openai-web-search-minimal empty)"
...
docker_e2e_run_logged_with_harness openai-web-search-minimal \
  ...
  -e "OPENAI_API_KEY=sk-afora-web-search-minimal-e2e" \
