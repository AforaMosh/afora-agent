...
const LIVEISH_INPUTS = Object.freeze([
  ...
  },
  {
    ...
    env: ["TELEGRAM_BOT_TOKEN", "AFORA_TELEGRAM_BOT_TOKEN"],
  },
  {
    probe: "channel-discord",
    env: ["DISCORD_TOKEN", "AFORA_DISCORD_TOKEN"],
  },
  {
    probe: "channel-slack",
    env: ["SLACK_BOT_TOKEN", "AFORA_SLACK_BOT_TOKEN"],
  },
  {
    probe: "channel-whatsapp",
    env: ["WHATSAPP_ACCESS_TOKEN", "AFORA_WHATSAPP_ACCESS_TOKEN"],
  },
]);
