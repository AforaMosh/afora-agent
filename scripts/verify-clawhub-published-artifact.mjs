...
async function main() {
  ...
  const retryOptions = {
    attempts: positiveInteger(
      process.env.AFORA_CLAWHUB_VERIFY_ATTEMPTS,
      DEFAULT_ATTEMPTS,
      "AFORA_CLAWHUB_VERIFY_ATTEMPTS",
      MAX_ATTEMPTS,
    ),
    delayMs: positiveInteger(
      process.env.AFORA_CLAWHUB_VERIFY_DELAY_MS,
      DEFAULT_DELAY_MS,
      "AFORA_CLAWHUB_VERIFY_DELAY_MS",
      MAX_DELAY_MS,
    ),
    timeoutMs: positiveInteger(
      process.env.AFORA_CLAWHUB_VERIFY_ATTEMPT_TIMEOUT_MS,
      DEFAULT_ATTEMPT_TIMEOUT_MS,
      "AFORA_CLAWHUB_VERIFY_ATTEMPT_TIMEOUT_MS",
    ),
  };
  const directMode = [
