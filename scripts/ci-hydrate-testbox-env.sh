...
profile_path="${1:-$HOME/.afora-testbox-live.profile}"
helper_path="${2:-$HOME/.local/bin/afora-testbox-env}"
...
profile_path="\${AFORA_TESTBOX_PROFILE_FILE:-\$default_profile_path}"
