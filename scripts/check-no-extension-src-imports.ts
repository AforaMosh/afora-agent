// Check No Extension Src Imports script supports Afora repository automation.
...
function main() {
  ...
  if (offenders.length > 0) {
    ...
    console.error(
      "Publish a focused afora/plugin-sdk/<subpath> surface or use the extension's own public barrel instead.",
    );
    process.exit(1);
  }
