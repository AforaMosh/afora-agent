...
if [[ -z "$version_content" ]]; then
  echo "<h2>Afora $VERSION</h2>"
  echo "<p>Latest Afora update.</p>"
  echo "<p><a href=\"https://github.com/AforaMosh/afora-agent/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
