...
import { buildAforaReleaseClawHubRuntimeState } from "./lib/afora-release-clawhub-plan.ts";
...
try {
  const state = buildAforaReleaseClawHubRuntimeState(parseArgs(process.argv.slice(2)));
