            ...
            hosts: [
              {
                ...
                sessions: [
                  ...
                  {
                    threadId: "codex-thread-projectless-owner",
                    name: "Provider auth triage",
                    createdActor: MOCK_CREATOR_PETER,
                    status: "idle",
                    updatedAt: baseTime - 52 * 60_000,
                    archived: false,
                    canContinue: true,
                    canArchive: false,
                  },
                  {
                    threadId: "codex-thread-projectless-unowned",
                    name: "One-off model probe",
                    status: "idle",
                    updatedAt: baseTime - 58 * 60_000,
                    archived: false,
                    canContinue: true,
                    canArchive: false,
                  },
            ...
            hosts: [
              {
                ...
                sessions: [
                  ...
                  {
                    threadId: "claude-thread-projectless-owner",
                    name: "Prompt handoff",
                    createdActor: MOCK_CREATOR_MIRA,
                    status: "idle",
                    updatedAt: baseTime - 38 * 60_000,
                    archived: false,
                    canContinue: true,
                    canArchive: false,
                  },
