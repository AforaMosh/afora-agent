...
// Summarizes Afora performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node --import tsx scripts/afora-performance-source-summary.mts --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes Afora-native performance probe artifacts for CI reports.`);
}
