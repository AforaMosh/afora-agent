...
export function shouldInstallPlaywrightSystemDependencies(
  ...
  return (
    ...
    parsePermissiveBooleanToken(env.AFORA_TESTBOX) === true
  );
}
...
export function ensurePlaywrightChromium(options: ChromiumInstallOptions = {}) {
  ...
  if (env.AFORA_UI_E2E_ALLOW_MISSING_CHROMIUM === "1") {
    log(
      `[ui-e2e] Playwright Chromium is missing at ${executablePath}; AFORA_UI_E2E_ALLOW_MISSING_CHROMIUM=1 leaves the lane skipped.`,
    );
    return 0;
  }
