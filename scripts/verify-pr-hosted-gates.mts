...
import { isRecord, readStringField } from "@afora/normalization-core/record-coerce";
...
const CI_GATE_CHECK_NAME = "afora-agent/ci-gate";

/**
 * True when this run's own afora/ci-gate job already succeeded on the
