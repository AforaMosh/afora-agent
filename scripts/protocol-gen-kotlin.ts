// Protocol Gen Kotlin script supports Afora repository automation.
...
const gatewayOutputPath = path.join(
  repoRoot,
  "apps/android/app/src/main/java/ai/afora/app/gateway/GatewayProtocol.kt",
);
const constantsOutputPath = path.join(
  repoRoot,
  "apps/android/app/src/main/java/ai/afora/app/protocol/AforaProtocolConstants.kt",
);
...
const androidEnums: EnumSpec[] = [
  ...
  enumSpec("AforaCanvasCommand", "canvas.", [
    ["Present", "present"],
    ["Hide", "hide"],
    ["Navigate", "navigate"],
    ["Eval", "eval"],
  ...
  enumSpec("AforaCanvasA2UICommand", "canvas.a2ui.", [
    ["Push", "push"],
    ["PushJSONL", "pushJSONL"],
    ["Reset", "reset"],
  ]),
  enumSpec("AforaCameraCommand", "camera.", [
    ["List", "list"],
    ["Snap", "snap"],
    ["Clip", "clip"],
  ]),
  enumSpec("AforaSmsCommand", "sms.", [
    ["Send", "send"],
    ["Search", "search"],
  ]),
  enumSpec("AforaTalkCommand", "talk.", [
    ["PttStart", "ptt.start"],
    ["PttStop", "ptt.stop"],
    ["PttCancel", "ptt.cancel"],
    ["PttOnce", "ptt.once"],
  ]),
  enumSpec("AforaLocationCommand", "location.", [["Get", "get"]]),
  enumSpec("AforaDeviceCommand", "device.", [
    ["Status", "status"],
    ["Info", "info"],
  ...
  enumSpec("AforaNotificationsCommand", "notifications.", [
    ["List", "list"],
    ["Actions", "actions"],
  ]),
  enumSpec("AforaSystemCommand", "system.", [["Notify", "notify"]]),
  enumSpec("AforaPhotosCommand", "photos.", [["Latest", "latest"]]),
  enumSpec("AforaContactsCommand", "contacts.", [
    ["Search", "search"],
    ["Add", "add"],
  ]),
  enumSpec("AforaCalendarCommand", "calendar.", [
    ["Events", "events"],
    ["Add", "add"],
  ]),
  enumSpec("AforaMotionCommand", "motion.", [
    ["Activity", "activity"],
    ["Pedometer", "pedometer"],
  ]),
  enumSpec("AforaCallLogCommand", "callLog.", [["Search", "search"]]),
  enumSpec("AforaMobileUiCommand", "mobile.ui.", [
    ["Observe", "observe"],
    ["Act", "act"],
  ]),
];
