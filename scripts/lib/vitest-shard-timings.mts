...
const TIMINGS_FILE_ENV_KEY = "AFORA_TEST_PROJECTS_TIMINGS_PATH";
const TIMINGS_DISABLE_ENV_KEY = "AFORA_TEST_PROJECTS_TIMINGS";
const SHARD_NAME_ENV_KEY = "AFORA_VITEST_SHARD_NAME";
