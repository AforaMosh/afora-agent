// Android Version script supports Afora repository automation.
...
export function renderAndroidVersionProperties(
  ...
  return `# Shared Android version defaults.\n# Source of truth: apps/android/version.json\n# Generated by scripts/android-sync-versioning.ts.\n\nAFORA_ANDROID_VERSION_NAME=${version.canonicalVersion}\nAFORA_ANDROID_VERSION_CODE=${version.versionCode}\n`;
}
