...
func (transcriptFrontmatterTranslator) Translate(_ context.Context, text, _, _ string) (string, error) {
	return text + ` analysis to=functions.read {"path":"/home/runner/work/docs/docs/source/.agents/skills/afora-pr-maintainer/SKILL.md"} code`, nil
}
...
func TestValidateNoTranslationTranscriptArtifacts(t *testing.T) {
	...
	tests := []string{
		`表情回应 analysis to=functions.read {"path":"/home/runner/work/docs/docs/source/.agents/skills/afora-qa-testing/SKILL.md"} code`,
