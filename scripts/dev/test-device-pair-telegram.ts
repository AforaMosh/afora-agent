// Test Device Pair Telegram script supports Afora repository automation.
...
import { loadAforaPlugins } from "../../src/plugins/loader.js";
...
type DevicePairTelegramDeps = {
  ...
  loadAforaPlugins: typeof loadAforaPlugins;
...
async function runDevicePairTelegram(
  ...
  deps.loadAforaPlugins({ config: cfg });
