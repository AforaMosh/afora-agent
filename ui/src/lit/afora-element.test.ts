...
import {
  AforaLightDomContentsElement,
  AforaLightDomElement,
  AforaLitElement,
} from "./afora-element.ts";

const LIGHT_ELEMENT_NAME = "test-afora-light-dom-element";
const LIGHT_CONTENTS_ELEMENT_NAME = "test-afora-light-dom-contents-element";
const SHADOW_ELEMENT_NAME = "test-afora-shadow-dom-element";

class TestLightDomElement extends AforaLightDomElement {
  renderCount = 0;
...
class TestShadowDomElement extends AforaLitElement {
  override render() {
    return html`<span>shadow content</span>`;
  }
}

class TestLightDomContentsElement extends AforaLightDomContentsElement {
  override render() {
