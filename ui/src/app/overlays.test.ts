...
describe("application approval overlays", () => {
  ...
  it.each([
    ...
    expect(request).not.toHaveBeenCalledWith("afora.approval.list", {});
  ...
  it.each([
    ...
    expect(request).toHaveBeenCalledWith("afora.approval.list", {});
    overlays.dispose();
  });
  ...
  it("resolves Afora changes through unified human approval", async () => {
