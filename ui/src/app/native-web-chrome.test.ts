...
afterEach(() => {
  ...
  Reflect.deleteProperty(window, "__AFORA_NATIVE_HISTORY__");
});
...
describe("native web chrome capability", () => {
  it("requires the document-start capability flag", () => {
    ...
    (window as TestNativeWindow)["__AFORA_NATIVE_WEB_CHROME__"] = true;
  ...
  it("reads native history state and defaults safely", () => {
    ...
    (window as TestNativeWindow)["__AFORA_NATIVE_HISTORY__"] = {
      canGoBack: true,
      canGoForward: false,
    };
