...
const LAST_SEEN_KEY = "afora.control.serverPrefs.v1";
...
const PENDING_KEY = "afora.control.serverPrefs.pending.v1";
...
const RETAINED_LOCAL_KEY = "afora.control.serverPrefs.retained-local.v1";
