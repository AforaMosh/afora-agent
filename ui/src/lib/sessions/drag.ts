...
export const SESSION_DRAG_MIME = "application/x-afora-session-key";
const SIDEBAR_SECTION_DRAG_MIME = "application/x-afora-session-group";
const SIDEBAR_ROUTE_DRAG_MIME = "application/x-afora-sidebar-route";
