import { asNullableRecord as recordOrNull } from "@afora/normalization-core/record-coerce";
import { normalizeOptionalString as stringValue } from "@afora/normalization-core/string-coerce";
