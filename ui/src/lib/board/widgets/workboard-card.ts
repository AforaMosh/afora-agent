...
class AforaWorkboardCardWidget extends WorkboardWidgetElement {
...
if (!customElements.get("afora-workboard-card-widget")) {
  customElements.define("afora-workboard-card-widget", AforaWorkboardCardWidget);
}
...
declare global {
  interface HTMLElementTagNameMap {
    "afora-workboard-card-widget": AforaWorkboardCardWidget;
  }
}
