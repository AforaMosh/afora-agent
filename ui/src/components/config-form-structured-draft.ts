...
class ConfigFormStructuredDraft extends AforaLightDomElement {
...
if (!customElements.get("afora-config-form-structured-draft")) {
  customElements.define("afora-config-form-structured-draft", ConfigFormStructuredDraft);
}
