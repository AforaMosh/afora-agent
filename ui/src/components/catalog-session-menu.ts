...
class CatalogSessionMenu extends AforaLightDomElement {
    ...
    return html`
      ...
      >
        ...
        <wa-dropdown-item class="session-menu__item" value="viewer">
          ...
          >
          <span class="session-menu__text">${t("chat.catalog.openInAfora")}</span>
        </wa-dropdown-item>
        <wa-dropdown-item
...
if (!customElements.get("afora-catalog-session-menu")) {
  customElements.define("afora-catalog-session-menu", CatalogSessionMenu);
}
