...
class UpdateBanner extends AforaLightDomContentsElement {
...
if (!customElements.get("afora-update-banner")) {
  customElements.define("afora-update-banner", UpdateBanner);
}
