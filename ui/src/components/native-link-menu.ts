...
export class NativeLinkMenu extends AforaLightDomElement {
...
if (!customElements.get("afora-native-link-menu")) {
  customElements.define("afora-native-link-menu", NativeLinkMenu);
}
