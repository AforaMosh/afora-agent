...
class GatewayUrlConfirmation extends AforaLightDomContentsElement {
...
if (!customElements.get("afora-gateway-url-confirmation")) {
  customElements.define("afora-gateway-url-confirmation", GatewayUrlConfirmation);
}
