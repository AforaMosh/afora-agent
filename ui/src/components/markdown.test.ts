...
function withControlUiBasePath<T>(basePath: string, fn: () => T): T {
  ...
  Object.defineProperty(window, "__AFORA_CONTROL_UI_BASE_PATH__", {
    value: basePath,
    writable: true,
    configurable: true,
  });
  try {
    ...
    delete testWindow["__AFORA_CONTROL_UI_BASE_PATH__"];
  }
}
...
describe("toSanitizedMarkdownHtml", () => {
  ...
  it("does not stamp presentation classes on links whose href contains 'tail'", () => {
    const fragment = htmlFragment(
      toSanitizedMarkdownHtml("[tailscale docs](https://docs.afora.ai/tailscale)"),
    );
    const link = fragment.querySelector("a");
    expect(link?.getAttribute("href")).toBe("https://docs.afora.ai/tailscale");
...
`;
  ...
  describe("security", () => {
    ...
    it("strips href from host-local absolute file paths", () => {
      const html = toSanitizedMarkdownHtml(
        "[report.docx](/Users/test/.afora/data/skills/output/report.docx)",
      );
    ...
    it("rewrites docs-root links to the public docs host", () => {
      ...
      expect(html).toBe(
        '<p><a href="https://docs.afora.ai/concepts/agent-workspace" rel="noreferrer noopener" target="_blank">workspace</a> <a href="https://docs.afora.ai/automation/hooks#session-memory" rel="noreferrer noopener" target="_blank">hooks</a> <a href="https://docs.afora.ai/channels/telegram?tab=setup" rel="noreferrer noopener" target="_blank">telegram</a> <a href="https://docs.afora.ai/telegram" rel="noreferrer noopener" target="_blank">shortlink</a> <a href="https://docs.afora.ai/openai" rel="noreferrer noopener" target="_blank">openai</a> <a href="https://docs.afora.ai/images" rel="noreferrer noopener" target="_blank">images</a> <a href="https://docs.afora.ai/groups" rel="noreferrer noopener" target="_blank">groups</a> <a href="https://docs.afora.ai/nodes/camera" rel="noreferrer noopener" target="_blank">camera</a> <a href="https://docs.afora.ai/platforms/macos" rel="noreferrer noopener" target="_blank">macOS</a> <a href="https://docs.afora.ai/cli/sessions" rel="noreferrer noopener" target="_blank">cliSessions</a> <a href="https://docs.afora.ai/tools/skills" rel="noreferrer noopener" target="_blank">toolSkills</a> <a href="https://docs.afora.ai/plugins/reference/diffs" rel="noreferrer noopener" target="_blank">pluginDocs</a> <a href="https://docs.afora.ai/prose" rel="noreferrer noopener" target="_blank">prose</a> <a href="https://docs.afora.ai/channels/access-groups" rel="noreferrer noopener" target="_blank">access</a></p>\n',
      );
    });
