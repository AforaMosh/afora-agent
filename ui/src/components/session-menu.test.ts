...
async function mountMenu(
  ...
  const element = container.querySelector("afora-session-menu") as SessionMenuElement | null;
  if (!element) {
...
describe("session menu", () => {
  ...
  it("dispatches open-pr with the resolved URL from click or the G shortcut", async () => {
    const url = "https://github.com/AforaMosh/afora-agent/pull/12345";
