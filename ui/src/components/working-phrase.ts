...
class WorkingPhrase extends AforaLightDomContentsElement {
...
if (!customElements.get("afora-working-phrase")) {
  customElements.define("afora-working-phrase", WorkingPhrase);
}
