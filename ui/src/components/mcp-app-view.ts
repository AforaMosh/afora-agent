...
import { isMcpAppViewExpiredError } from "@afora/gateway-protocol";
...
class AforaAppBridge extends AppBridge {
...
export class McpAppView extends LitElement {
  ...
  private async setupResources(
    ...
    try {
      ...
      const bridge = new AforaAppBridge(
        null,
        { name: "Afora", version: "1.0.0" },
        buildMcpAppHostCapabilities(
          payload.csp,
