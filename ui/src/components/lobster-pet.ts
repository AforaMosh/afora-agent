...
// Drawn in the smooth Afora lobster style (see the dreams scene and
...
if (!customElements.get("afora-lobster-pet")) {
  customElements.define("afora-lobster-pet", LobsterPet);
}
