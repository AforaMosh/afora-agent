...
type AforaBoardWidgetCell = HTMLElementTagNameMap["afora-board-widget-cell"];
...
export async function settleCells(view: AforaBoardView): Promise<AforaBoardWidgetCell[]> {
