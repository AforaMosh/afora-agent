...
describeControlUiE2e("session pull request chips", () => {
  ...
  it("pins detected PR chips above the composer with rate-limit staleness", async () => {
        ...
        [watchedKey]: {
          pullRequests: [
            ...
            },
            {
              ...
              url: "https://github.com/AforaMosh/afora-agent/pull/103438",
              state: "merged",
            },
            {
              number: 103200,
              ...
              url: "https://github.com/AforaMosh/afora-agent/pull/103200",
              state: "merged",
            },
          ],
          rateLimited: true,
    ...
    await expect
      ...
      .toBe("https://github.com/AforaMosh/afora-agent/pull/103469/checks");
  ...
  it("offers a Create PR row with the stale warning while rate limited pre-PR", async () => {
    ...
    await expect.poll(() => row.locator(".chat-pr__repo").textContent()).toBe("afora");
    await expect
    ...
    await expect
      ...
      .toBe("https://github.com/AforaMosh/afora-agent/pull/new/claude/cloud-workers-live-events");
