...
class MemoryMemoriesElement extends AforaLightDomElement {
...
if (!customElements.get("afora-memory-memories")) {
  customElements.define("afora-memory-memories", MemoryMemoriesElement);
}
