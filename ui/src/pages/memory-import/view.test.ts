        ...
        items: [
          {
            ...
            target: "/tmp/afora-research/memory/imports/codex/MEMORY.md",
            details: {
              collectionId: "codex",
          ...
          },
          {
            ...
            target: "/tmp/afora-research/memory/imports/codex/memory_summary.md",
            details: {
              collectionId: "codex",
              collectionLabel: "Codex",
...
describe("renderMemoryImport", () => {
  ...
  it("groups memory by source collection without rendering file contents", () => {
    ...
    expect(container.textContent).toContain("/tmp/afora-research/memory/imports/");
  ...
  it("hides the agent row when only one agent is configured", () => {
    ...
    expect(container.querySelector('afora-agent-select[name="memory-import-agent"]')).toBeNull();
  ...
  it("renders the avatar agent picker and routes agent changes", async () => {
    ...
    >('afora-agent-select[name="memory-import-agent"]');
  ...
  it("disables confirmation actions while an import is running", () => {
    ...
    container
      .querySelector("afora-modal-dialog")
  ...
  it("shows partial import failures with the saved report", () => {
              ...
              items: [
                {
                  ...
                  details: {
                    recoveryPath: "/tmp/workspace/.afora-memory-import-staging/MEMORY.md",
    ...
    expect(result?.textContent).toContain(
      "/tmp/workspace/.afora-memory-import-staging/MEMORY.md",
    );
