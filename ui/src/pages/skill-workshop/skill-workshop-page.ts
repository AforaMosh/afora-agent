...
class SkillWorkshopPage extends AforaLightDomElement {
...
if (!customElements.get("afora-skill-workshop-page")) {
  customElements.define("afora-skill-workshop-page", SkillWorkshopPage);
}
