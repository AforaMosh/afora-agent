...
describe("gateway source replacement across reconnect with a reused client", () => {
  it("preserves matching sessions route data on the first bind", async () => {
    ...
    const page = createPage("afora-sessions-page", context) as TestPage & {
  ...
  it("preserves matching usage route data on the first bind", async () => {
    ...
    const page = createPage("afora-usage-page", context) as TestPage & {
  ...
  it("gates same-client usage reconnects by payload age and page visibility", async () => {
    ...
    const page = createPage("afora-usage-page", harness.context) as TestPage & {
      routeData: UsageRouteData;
  ...
  it("preserves matching skills route data on the first bind", async () => {
    ...
    const page = createPage("afora-skills-page", context) as TestPage & {
  ...
  it("clears sessions loaded by the previous provider", async () => {
    const client = {} as GatewayBrowserClient;
    const page = createPage("afora-sessions-page", contextWithClient(client)) as TestPage & {
      result: unknown;
  ...
  it("clears usage loaded by the previous provider", async () => {
    const client = {} as GatewayBrowserClient;
    const page = createPage("afora-usage-page", contextWithClient(client)) as TestPage & {
      usageResult: unknown;
  ...
  it("clears skills loaded by the previous provider", async () => {
    const client = {} as GatewayBrowserClient;
    const page = createPage("afora-skills-page", contextWithClient(client)) as TestPage & {
  ...
  it("clears logs loaded by the previous provider", async () => {
    const client = {} as GatewayBrowserClient;
    const page = createPage("afora-logs-page", contextWithClient(client)) as TestPage & {
      logsEntries: unknown[];
  ...
  it("clears diagnostics data and errors loaded by the previous provider", async () => {
    const client = {} as GatewayBrowserClient;
    const page = createPage("afora-debug-page", contextWithClient(client)) as TestPage & {
      debugStatus: unknown;
      debugHealth: unknown;
      debugModels: unknown[];
  ...
  it("discards diagnostics from a replaced provider that reuses its client", async () => {
    ...
    const client = { request } as unknown as GatewayBrowserClient;
    const context = contextWithClient(client, { connected: true });
    const page = createPage("afora-debug-page", context) as TestPage & {
      debugStatus: unknown;
  ...
  it("clears cron data loaded by the previous provider", async () => {
    const client = {} as GatewayBrowserClient;
    const page = createPage("afora-cron-page", contextWithClient(client)) as TestPage & {
      cron: {
  ...
  it("clears tasks loaded by the previous provider", async () => {
    const client = {} as GatewayBrowserClient;
    const page = createPage("afora-tasks-page", contextWithClient(client)) as TestPage & {
      tasks: unknown[];
      error: string | null;
