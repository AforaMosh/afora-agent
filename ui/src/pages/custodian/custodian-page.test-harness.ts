import { GATEWAY_SERVER_CAPS } from "@afora/gateway-protocol";
...
export async function mountPage(
  ...
  const page = document.createElement("afora-custodian-page") as TestCustodianPage;
