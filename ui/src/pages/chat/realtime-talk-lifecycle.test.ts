...
describe("RealtimeTalkSession lifecycle", () => {
  ...
  it("closes a committed stale candidate before starting the queued replacement", async () => {
    ...
    expect(requestOrder.indexOf("talk.client.close:allocation-2")).toBeLessThan(
