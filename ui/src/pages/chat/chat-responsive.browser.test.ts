...
describeBrowserLayout.concurrent("chat responsive browser layout", () => {
  ...
  it("keeps provider marks muted in conversations and branded on new session", async () => {
          ...
          <body>
            <div class="agent-chat__composer-shell">
              <div class="agent-chat__input">
                <span class="provider-brand-icon chat-controls__trigger-provider-icon" data-provider-icon="codex" data-provider-mark="chat"></span>
                <span data-provider-mark="muted" style="color: var(--chat-composer-tertiary)"></span>
              </div>
            </div>
            <div class="agent-chat__composer-shell new-session-page__composer">
              <div class="agent-chat__input">
                <span class="provider-brand-icon chat-controls__trigger-provider-icon" data-provider-icon="codex" data-provider-mark="new"></span>
                <span data-provider-mark="brand" style="color: var(--brand-codex)"></span>
              </div>
            </div>
            <div class="agent-chat__input chat-session-rail__composer">
              <span class="provider-brand-icon chat-controls__trigger-provider-icon" data-provider-icon="codex" data-provider-mark="companion"></span>
            </div>
          </body>
        </html>
      `);
