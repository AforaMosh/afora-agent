...
describe("renderSkills ClawHub", () => {
  ...
  it("opens detail dialogs and routes ClawHub actions", async () => {
          ...
          clawhubResults: [
            {
              ...
              slug: "github",
              displayName: "GitHub",
              summary: "GitHub integration for Afora",
    ...
    expect(resultItem?.querySelector(".settings-row__desc")?.textContent?.trim()).toBe(
      "GitHub integration for Afora · github",
    );
    ...
    expect(normalizeText(container.querySelector(".md-preview-dialog__body")!)).toBe(
      "GitHub integration for Afora By Afora (@afora) Latest: v1.2.3 Added search support Platforms: macos, linux Install GitHub",
    );
  ...
  it("renders installed ClawHub verdicts and the local Skill Card tab", async () => {
        ...
        createProps({
          ...
          clawhubVerdicts: {
            [verdictKey]: {
              ...
              requestedOwnerHandle: "afora",
              requestedVersion: "1.2.3",
              slug: "agentreceipt",
              version: "1.2.3",
              securityAuditUrl:
                "https://clawhub.ai/afora/skills/agentreceipt/security-audit?version=1.2.3",
    ...
    expect(normalizeText(container)).toContain("@afora/agentreceipt@1.2.3");
