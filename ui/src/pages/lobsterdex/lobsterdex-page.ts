...
class LobsterdexPage extends AforaLightDomElement {
...
if (!customElements.get("afora-lobsterdex-page")) {
  customElements.define("afora-lobsterdex-page", LobsterdexPage);
}
