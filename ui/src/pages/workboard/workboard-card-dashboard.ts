...
class WorkboardCardDashboard extends AforaLightDomElement {
...
if (!customElements.get("afora-workboard-card-dashboard")) {
  customElements.define("afora-workboard-card-dashboard", WorkboardCardDashboard);
}

declare global {
  interface HTMLElementTagNameMap {
    "afora-workboard-card-dashboard": WorkboardCardDashboard;
  }
}
