      ...
      createPluginsRouteData(
        ...
        createResult(
          createPlugin({
            ...
            name: "BlueBubbles",
            packageName: "@afora/bluebubbles",
            installed: false,
            enabled: false,
            state: "not-installed",
            install: { source: "official", pluginId: "@afora/bluebubbles" },
          }),
        ),
      ),
    );
    const installIdentity = "plugin:@afora/bluebubbles";
    const catalogRequest = {
      source: "official",
      pluginId: "@afora/bluebubbles",
