...
export const ja_JP: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "更新リクエストは受け付けられた可能性がありますが、Gateway は再接続後に最終結果を報告しませんでした。再試行の前に `openclaw update status` を実行してください。",
    failureReasons: {
  ...
  configForm: {
    ...
    draftRejected: "この設定は保存できませんでした。ドラフトはそのまま残っています。",
