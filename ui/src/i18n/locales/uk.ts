...
export const uk: TranslationMap = {
  ...
  dashboardsPage: {
    emptyTitle: "Панелей керування ще немає",
    emptyDescription:
      "Відкрийте гілку та перейдіть до подання «Панель керування», щоб додати її сюди.",
    loadError: "Не вдалося завантажити панелі керування: {error}",
  },
  sessionsView: {
  ...
  subtitles: {
    ...
    dashboards: "Гілки, що відкриваються в поданні панелі керування.",
  ...
  memoryPage: {
    ...
    engine: {
      title: "Рушій",
      description:
        "Слотом пам’яті керує лише один плагін пам’яті. Вибір рушія вмикає його та вимикає інші.",
      rowTitle: "Рушій пам’яті",
      off: "Вимкнено",
      autoHint:
        "У конфігурації не закріплено жодного рушія, тому слот повертається до стандартного власника.",
      explicitHint: "Цей рушій закріплено в конфігурації в plugins.slots.memory.",
      offHint:
        "Пам’ять вимкнено в конфігурації: для plugins.slots.memory встановлено значення none.",
    ...
    backend: {
      title: "Бекенд",
      description: "Спосіб зберігання та отримання даних пам’яті для вибраного рушія.",
      rowTitle: "Механізм пошуку",
      builtin: "Вбудований",
      qmd: "QMD",
      builtinHint: "Файли пам’яті індексує та шукає сам OpenClaw.",
      qmdHint: "Пошук делеговано QMD. Його налаштування наведено нижче.",
    },
    addons: {
      title: "Доповнення",
      description:
        "Ці плагіни працюють поверх механізму, а не конкурують за місце, тому будь-яка їх комбінація може працювати одночасно.",
      activeMemory: {
      ...
      manage: "Увімкнути або вимкнути доповнення",
      manageLink: "Відкрити плагіни",
    },
    import: {
      title: "Імпортувати",
      description: "Імпортуйте наявну пам’ять з інших асистентів у робочий простір агента.",
      link: "Відкрити імпорт пам’яті",
    },
    search: {
      intro:
        "Типові налаштування вбудовування та пошуку, спільні для всіх агентів без перевизначених налаштувань пам’яті.",
    },
    dreaming: {
      intro:
        "Сновидіння запускається як одне кероване завдання cron у всіх робочих просторах агентів, тому ці налаштування є глобальними. Ними керує плагін {plugin}.",
      schedule: {
        title: "Розклад",
        description: "Коли запускається повний цикл і яка модель його описує.",
      },
      frequency: {
        label: "Частота сновидінь",
        help: "Періодичність cron для повного циклу сновидінь (легкий сон, REM, потім глибокий сон). Залиште порожнім, щоб використовувати типове значення плагіна.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Часовий пояс",
        help: "Часовий пояс IANA, що використовується для інтерпретації періодичності cron.",
        placeholder: "Europe/Vienna",
      },
      model: {
        label: "Модель сновидінь",
        help: "Перевизначення постачальника/моделі для оповіді щоденника сновидінь. Потрібно дозволити перевизначення моделей субагентів.",
        placeholder: "anthropic/claude-sonnet-4-6",
      },
      verboseLogging: {
        label: "Детальне журналювання",
        help: "Докладно записувати кожну фазу сновидінь у журнал. Корисно під час налаштування порогових значень.",
      },
      storage: {
        title: "Сховище",
        description: "Місце, куди записуються перенесені спогади та звіти про сновидіння.",
        modeLabel: "Режим зберігання",
        modeHelp:
          "Вбудований режим записує дані у файл пам’яті; окремий режим зберігає їх у спеціальному файлі звітів.",
        modes: {
          inline: "Вбудований",
          separate: "Окремий",
          both: "Обидва",
        ...
        separateReportsHelp: "Зберігати звіти про сновидіння поза основним файлом пам’яті.",
      },
      phases: {
        light: {
          title: "Легка фаза",
          description:
            "Малозатратний прохід нещодавньої активності, що готує кандидатів для повторного відтворення.",
        },
        deep: {
          title: "Глибока фаза",
          description:
            "Прохід перенесення на основі оцінювання, що переводить короткострокові записи до пам’яті.",
        },
        rem: {
          title: "REM-фаза",
          description:
            "Етап пошуку закономірностей, що виявляє повторювані теми протягом періоду ретроспективного аналізу.",
        },
      },
      phaseFields: {
        enabled: "Увімкнено",
        enabledHelp: "Запускати цей етап під час проходу.",
        lookbackDays: "Дні ретроспективного аналізу",
        lookbackDaysHelp:
          "Наскільки далеко в минуле цей етап зчитує дані. Залиште порожнім, щоб використати стандартне значення плагіна.",
        limit: "Ліміт",
        limitHelp: "Максимальна кількість записів, які цей етап обробляє за один запуск.",
        dedupeSimilarity: "Подібність для усунення дублікатів",
        dedupeSimilarityHelp: "Рівень подібності, вище якого два кандидати вважаються дублікатами.",
        minScore: "Мінімальна оцінка",
        minScoreHelp: "Оцінка підвищення, якої має досягти запис.",
        minRecallCount: "Мінімальна кількість згадувань",
        minRecallCountHelp:
          "Скільки разів запис має бути згаданий, перш ніж його можна буде підвищити.",
        minUniqueQueries: "Мінімальна кількість унікальних запитів",
        minUniqueQueriesHelp: "У скількох різних запитах має з’явитися запис.",
        recencyHalfLifeDays: "Період напіврозпаду актуальності (дні)",
        recencyHalfLifeDaysHelp: "Як швидко давніші сигнали згадування втрачають вагу.",
        maxAgeDays: "Максимальний вік (дні)",
        maxAgeDaysHelp: "Ігнорувати короткострокові записи, старіші за цей термін.",
        maxPromotedSnippetTokens: "Максимальна кількість токенів у підвищеному фрагменті",
        maxPromotedSnippetTokensHelp:
          "Бюджет токенів для кожного підвищеного фрагмента. Дані про походження зберігаються.",
        minPatternStrength: "Мінімальна вираженість шаблону",
        minPatternStrengthHelp:
          "Рівень вираженості, якого має досягти повторюваний шаблон, щоб про нього було повідомлено.",
      },
      agentScope: {
        title: "Подання агента",
        description:
          "Наведені вище налаштування є глобальними. Щоденник сновидінь, короткострокові лічильники та наведені нижче дії з обслуговування належать одному агенту.",
        rowTitle: "Агент",
      },
      unsupported: {
        ...
        description:
          "Плагін {plugin} використовує слот пам’яті, а його схема конфігурації не містить розділу сновидінь, тому ці налаштування неможливо зберегти. Щоб змінити їх, перемкніть рушій на вкладці «Огляд».",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      ...
      description:
        "Залишайте видимим обмежений каталог інструментів, а решту надавайте через пошук, щоб великі каталоги MCP і плагінів не перевантажували запит.",
    },
    localModelLean: {
      title: "Полегшений набір інструментів для локальних моделей",
      description:
        "Вилучіть ресурсомісткі стандартні інструменти, з якими невеликі локальні моделі працюють погано, залишивши коротший набір, який вони можуть надійно використовувати.",
    },
    auditMessages: {
      title: "Метадані аудиту повідомлень",
      description:
        "Записуйте метадані без вмісту для прямих розмов у журналі аудиту. Вміст повідомлень ніколи не зберігається.",
    },
  },
  aboutPage: {
