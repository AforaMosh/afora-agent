...
export const de: TranslationMap = {
  ...
  agents: {
    ...
    files: {
      ...
      createHint:
        "Diese Datei ist noch nicht vorhanden. Beim Speichern wird sie im Arbeitsbereich des Agenten erstellt.",
      content: "Content",
      words: "{count} words",
      lines: "lines",
    },
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      multipleMatches: "Mehr als eine Sitzung stimmt mit {shortId} überein.",
      additionalMatches:
        "Es sind noch Suchergebnisse vorhanden. Verwenden Sie ein längeres ID-Präfix.",
    },
    sessionSharing: {
