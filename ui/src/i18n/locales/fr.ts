...
export const fr: TranslationMap = {
  ...
  updates: {
    ...
    outcomeUnknown:
      "La demande de mise à jour a peut-être été acceptée, mais le Gateway n'a pas signalé de résultat final après reconnexion. Exécutez `openclaw update status` avant de réessayer.",
    failureReasons: {
  ...
  mcpServers: {
    ...
    sessionUnavailable: "La session active n'est pas disponible ; actualisez et réessayez.",
  ...
  labsPage: {
    ...
    loopDetection: {
      ...
      description:
        "Activez des garde-fous basés sur l'historique glissant qui avertissent ou bloquent les appels d'outils répétés lorsqu'un agent cesse de progresser.",
    },
    localModelLean: {
  ...
  dreaming: {
    ...
    wiki: {
      ...
      emptyWiki: "Le wiki de mémoire n'est pas encore renseigné",
      emptyWikiHint:
    ...
    phrases: {
      ...
      defragmentingMemoryLane: "défragmentation de la mémoire…",
