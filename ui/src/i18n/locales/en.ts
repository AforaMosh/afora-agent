...
export const en: TranslationMap = {
  ...
  devices: {
    pairing: {
      ...
      routeLanInsecurePage: "An HTTPS page cannot check a plaintext local address.",
      routePublic: "Public address",
      routePublicHint: "A secure wss:// address you already route to this Gateway.",
      noticeReverted: "The previous network setting was restored.",
      publicTitle: "Public address",
      publicHint: "The address must already reach this Gateway; OpenClaw does not create one.",
      publicTrust:
        "OpenClaw cannot confirm the responder is this Gateway, so only enter an address you control.",
      ...
      conflictHint: "Another change was saved while you were reviewing this one.",
