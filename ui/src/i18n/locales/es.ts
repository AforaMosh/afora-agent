...
export const es: TranslationMap = {
  ...
  custodian: {
    ...
    nudge: {
      ...
      channelSetupTitle: "Contacta con OpenClaw fuera de esta app",
      channelSetupBody:
        "La aplicación web ya funciona. Añade un canal solo si quieres enviar mensajes a OpenClaw desde otro servicio.",
