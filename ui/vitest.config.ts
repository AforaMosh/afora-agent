...
const workspaceSourceAliases = [
  ...
  {
    find: "afora-agent/plugin-sdk/test-fixtures",
    replacement: path.resolve(repoRoot, "src/plugin-sdk/test-fixtures.ts"),
  },
  {
    find: /^@afora\/model-catalog-core\/(.+)$/u,
