...
// the embedding application (Afora core installs its implementations via
...
import type { Api, Context, Model, StreamFn } from "@afora/llm-core";
...
/** Transport-safe provider policy input kept independent of Afora config types. */
