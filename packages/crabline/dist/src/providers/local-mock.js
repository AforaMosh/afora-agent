...
import { appendRecordedInbound, cloneRecordedInboundCursor, createRecordedInboundCursor, waitForRecordedInbound, watchRecordedInbound, } from "./recorder.js";
...
function normalizeWebhookPayload(payload) {
    ...
    for (const [label, envelope] of [
        ...
        for (const field of ["id", "text", "threadId"]) {
...
export class LocalMockProviderAdapter {
    ...
    async #handleWebhook(request) {
        ...
        try {
            ...
            return respond((await this.#options.createWebhookSuccessResponse?.(rawPayload, id)) ??
