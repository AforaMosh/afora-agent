...
import { canonicalizeWhatsAppChatJid, canonicalizeWhatsAppUserCorrelationJid, canonicalizeWhatsAppUserJid, } from "../../servers/whatsapp-jid.js";
...
export const WHATSAPP_AFORA_CRABLINE_PROVIDER_BRIDGE = createAforaCrablineProviderBridge({
    provider: "whatsapp",
            ...
            createBinding() {
                return {
                    ...
                    createChannelDriverSmokeEnv: (env) => ({
                        ...
                        AFORA_WHATSAPP_WEB_SOCKET_URL: whatsapp.endpoints.baileysWebSocketUrl,
                    }),
