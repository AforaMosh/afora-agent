...
const TELEGRAM_SYMBOLIC_GROUP_ID_BASE = 1000000000000n;
const TELEGRAM_SYMBOLIC_GROUP_ID_RANGE = 10000000000n;
...
function normalizeTelegramChatId(kind, id) {
    const value = id.trim();
    if (!value) {
...
export const TELEGRAM_AFORA_CRABLINE_PROVIDER_BRIDGE = createAforaCrablineProviderBridge({
    provider: "telegram",
        ...
        return {
            ...
            createBinding() {
                return {
                    ...
                    createGatewayConfig: (aforaConfig = {}) => {
                        ...
                        const messages = isRecord(aforaConfig.messages) ? aforaConfig.messages : {};
            ...
            createOutboundFromRecorderEvent({ event, targetByProviderTarget }) {
                ...
                return {
                    ...
                    senderName: "Afora QA",
                    text,
                    to: targetByProviderTarget.get(providerTargetKey) ??
