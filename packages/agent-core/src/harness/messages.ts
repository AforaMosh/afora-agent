...
import type { ImageContent, Message, TextContent } from "@afora/llm-core";
import { parseDateStringTimestampMs as parseSessionTimestampMs } from "@afora/normalization-core/number-coercion";
import type {
  AgentMessage,
