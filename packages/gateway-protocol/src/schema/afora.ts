// Gateway Protocol schema module defines Afora chat payloads.
...
/**
 * Afora chat lets clients (macOS app onboarding, future UIs) hold the
...
/** One Afora reply; `action` tells clients about conversation handoffs. */
