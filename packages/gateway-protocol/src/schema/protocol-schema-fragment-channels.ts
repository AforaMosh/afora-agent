...
export const ChannelProtocolSchemas = {
  ...
  TalkClientAllocationParams: channels.TalkClientAllocationParamsSchema,
  TalkClientTerminalPayload: channels.TalkClientTerminalPayloadSchema,
  TalkClientAllocationTerminalEvent: channels.TalkClientAllocationTerminalEventSchema,
  TalkClientAllocationCommittedResult: channels.TalkClientAllocationCommittedResultSchema,
  TalkClientAllocationAbortedResult: channels.TalkClientAllocationAbortedResultSchema,
  TalkClientAllocationTerminalResult: channels.TalkClientAllocationTerminalResultSchema,
  TalkClientAllocationMutationResult: channels.TalkClientAllocationMutationResultSchema,
