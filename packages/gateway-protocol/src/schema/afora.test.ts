...
describe("Afora chat params protocol", () => {
...
describe("Afora chat question protocol", () => {
  const question = {
...
describe("Afora chat history protocol", () => {
...
describe("Afora setup detection protocol", () => {
      ...
      unavailableCandidates: [
        {
          ...
          reason: "Reconnect through Afora or use a Gemini API key.",
...
describe("Afora setup verification protocol", () => {
