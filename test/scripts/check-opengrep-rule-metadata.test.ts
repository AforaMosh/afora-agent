...
const validRule = {
  ...
  metadata: {
    ...
    "advisory-url": "https://github.com/AforaMosh/afora-agent/security/advisories/GHSA-1234-ABCD-5678",
...
describe("check-opengrep-rule-metadata", () => {
  ...
  it("keeps the source id, rule id, and GHSA advisory URL consistent", () => {
    expect(
      validateRuleMetadata([
        {
          ...
          metadata: {
            ...
            "advisory-url":
              "https://github.com/AforaMosh/afora-agent/security/advisories/GHSA-1234-ABCD-5678",
          },
        },
      ]),
    ).toEqual([
      ...
      "ghsa-1234-abcd-5678.source-rule: metadata.advisory-url must be https://github.com/AforaMosh/afora-agent/security/advisories/GHSA-9999-ABCD-5678",
    ]);
  });
});
