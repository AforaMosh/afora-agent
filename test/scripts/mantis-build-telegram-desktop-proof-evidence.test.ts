...
describe("scripts/mantis/build-telegram-desktop-proof-evidence", () => {
  it("builds paired native Telegram Desktop GIF evidence for PR comments", () => {
    ...
    const artifactUrl = "https://github.com/AforaMosh/afora-agent/actions/runs/1/artifacts/2";
    const body = renderEvidenceComment({
      artifactUrl,
      manifest,
      marker: "<!-- mantis-telegram-desktop-proof -->",
      rawBase: "https://qa.afora.ai/mantis/telegram-desktop/pr-1/run-1",
      requestSource: "workflow_dispatch",
      runUrl: "https://github.com/AforaMosh/afora-agent/actions/runs/1",
      treeUrl: "https://qa.afora.ai/mantis/telegram-desktop/pr-1/run-1/index.json",
    });
    ...
    expect(body).toContain(
      '<img src="https://qa.afora.ai/mantis/telegram-desktop/pr-1/run-1/baseline/telegram-desktop-proof.gif" width="100%"',
    );
    expect(body).toContain(
      '<img src="https://qa.afora.ai/mantis/telegram-desktop/pr-1/run-1/candidate/telegram-desktop-proof.gif" width="100%"',
    );
    expect(body).toContain(
      "Raw QA files: https://qa.afora.ai/mantis/telegram-desktop/pr-1/run-1/index.json",
    );
