...
describe("release upgrade baseline resolver", () => {
  ...
  it("compares prerelease versions with semver ordering", () => {
    expect(compareAforaVersions("2026.6.7-beta.2", "2026.6.7-beta.10")).toBeLessThan(0);
    expect(compareAforaVersions("2026.6.7", "2026.6.7-beta.10")).toBeGreaterThan(0);
  });
});
