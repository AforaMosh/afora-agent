...
describe("package artifact reuse", () => {
  ...
  it("includes package acceptance in release checks", () => {
    ...
    expect(workflow).toContain(
      'contains(fromJSON(\'["all","cross-os","package","windows-node"]\'), needs.resolve_target.outputs.rerun_group) || (needs.resolve_target.outputs.rerun_group == \'live-e2e\' && needs.resolve_target.outputs.repo_live_suite_filter == \'\')',
    );
    expect(workflow).toContain(
  ...
  it("binds both Windows-node release E2E calls to the resolved asset tuple", () => {
    ...
    const reusableWorkflow =
      "openclaw/openclaw-windows-node/.github/workflows/release-candidate-e2e.yml@2aaefd8bb1c9baf1939a2ee926dd0e7385426212";
    ...
    expect(prerelease.with).toMatchObject({
      ...
      windows_node_sha: "2aaefd8bb1c9baf1939a2ee926dd0e7385426212",
    });
