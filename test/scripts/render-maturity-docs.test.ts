...
describe("maturity docs renderer CLI", () => {
  ...
  it("still requires QA evidence artifacts when rendering generated docs", () => {
    const outputDir = tempDirs.make("afora-maturity-docs-test-");
  ...
  it("rejects scorecard evidence with failed or blocked entries", () => {
    const outputDir = tempDirs.make("afora-maturity-docs-output-");
    const evidenceDir = tempDirs.make("afora-maturity-docs-evidence-");
    writeQaEvidence({
      dir: evidenceDir,
      entries: [
