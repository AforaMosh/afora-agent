...
export const OPENAI_LONG_CONTEXT_LIVE_ENV = "AFORA_LIVE_OPENAI_LONG_CONTEXT";
export const OPENAI_LONG_CONTEXT_PROFILE_ENV = "AFORA_LIVE_OPENAI_LONG_CONTEXT_PROFILE";
export const OPENAI_LONG_CONTEXT_METRICS_ENV = "AFORA_LIVE_OPENAI_LONG_CONTEXT_METRICS";
export const OPENAI_LONG_OUTPUT_ENV = "AFORA_LIVE_OPENAI_LONG_CONTEXT_OUTPUT";
const OPENAI_LONG_TOOL_OUTPUT_ENV = "AFORA_LIVE_OPENAI_LONG_CONTEXT_TOOL_OUTPUT";
export const OPENAI_LONG_TOOL_BYTES_ENV = "AFORA_LIVE_OPENAI_LONG_CONTEXT_TOOL_BYTES";

const OFFICIAL_OPENAI_BASE_URL = "https://api.openai.com/v1";
const OPENAI_RESPONSES_API = "openai-responses";
const AFORA_RUNTIME = "afora";
...
export function resolveOpenAILongContextLiveSettings(
  ...
  if (!liveEnabled) {
    throw new Error(`${OPENAI_LONG_CONTEXT_LIVE_ENV}=1 also requires AFORA_LIVE_TEST=1`);
  }
