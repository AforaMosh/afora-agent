...
const openAiCodexTokenRefreshTestHook = "__AFORA_TEST_REFRESH_OPENAI_CODEX_TOKEN__";
...
// arbitrary AFORA_BUNDLED_PLUGINS_DIR overrides unless this Vitest-only opt-in is present.
