---
name: afora-refactor-docs
description: Refactor an existing Afora docs page with source-audited preservation, restructuring, and verification.
---
...
Use this skill when the user gives a target Afora docs page and asks to
