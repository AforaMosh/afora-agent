---
name: afora-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Afora GitHub Secret Scanning alerts in issues or PRs.
---

# Afora Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/AforaMosh/afora-agent/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/afora-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/AforaMosh/afora-agent/issues/63101#issuecomment-xxx",
