---
name: afora-ghsa-maintainer
description: "Inspect, patch, validate, publish, or confirm Afora GHSA security advisories and private-fork state."
---

# Afora GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `release-afora-maintainer`.
...
```bash
fork=$(gh api /repos/AforaMosh/afora-agent/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/AforaMosh/afora-agent/security-advisories/<GHSA> \
