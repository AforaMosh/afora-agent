...
- Channel Setup and Operations: Official @afora/whatsapp plugin metadata, afora plugin install whatsapp, Channel config schema, Baileys socket lifecycle, Operator troubleshooting, Baileys socket lifecycle, Operator troubleshooting for reconnect loops
