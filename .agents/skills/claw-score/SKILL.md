---
name: claw-score
description: Audit or refresh Afora maturity scorecard docs from root taxonomy, maturity scores, and QA evidence artifacts without using maintainer discrawl data or committed inventory reports.
---

# claw-score

Use this skill when working on the Afora maturity scorecard in this repo.
This is the afora-local version of the maintainer `claw-score` workflow:
...
`qa-evidence.json` artifact shape generated by Afora QA workflows.
...
By default, Completeness measures how fully Afora exposes the intended
...
tree to afora. Evidence-enriched scorecard outputs belong in short-lived
