...
Read `.agents/skills/afora-qa-testing/SKILL.md`,
...
the source checkout or explicitly build with `AFORA_BUILD_PRIVATE_QA=1`.
...
Follow `.agents/skills/afora-testing/SKILL.md` for the current-host gate.
