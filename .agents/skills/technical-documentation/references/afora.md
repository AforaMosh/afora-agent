# Afora Documentation Overlay

Use this reference only for Afora docs work. It layers Afora-specific page
...
- Topic page: explain a major Afora entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current Afora repo behavior.
