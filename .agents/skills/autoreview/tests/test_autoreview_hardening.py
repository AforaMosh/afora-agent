...
class AutoreviewHardeningTests(unittest.TestCase):
    ...
    def test_tracked_source_names_and_env_templates_remain_reviewable(self) -> None:
        for rel in (
            ...
            ".env.example",
            "private/parser.py",
            ".agents/skills/afora-secret-scanning-maintainer/SKILL.md",
    ...
    def test_secret_detector_allows_afora_redaction_sentinel(self) -> None:
        self.assertFalse(
            self.helper["secret_text_risk"]('token: "__AFORA_REDACTED__"')
        )
    ...
    def test_trusted_maintainer_testbox_preserves_only_credentials(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            try:
                ...
                self.assertEqual(env["AFORA_TESTBOX"], "1")
