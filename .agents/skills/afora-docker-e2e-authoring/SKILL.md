---
name: afora-docker-e2e-authoring
description: "Author Afora Docker E2E and live provider Docker lanes."
---

# Afora Docker E2E Authoring
...
AFORA_SKIP_DOCKER_BUILD=1 pnpm test:docker:<lane>
```
