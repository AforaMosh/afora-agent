...
export type ChannelAgentToolFactory = (params: { cfg?: AforaConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AforaConfig; accountId?: string | null }) => string[];
  messageToolCapabilities?: (params: {
    cfg: AforaConfig;
    accountId?: string | null;
  }) => string[] | undefined;
  inboundFormattingHints?: (params: { cfg: AforaConfig; accountId?: string | null }) =>
    | {
        text_markup: string;
        rules: string[];
      }
