...
- Keep extension-facing channel surfaces flowing through `afora-agent/plugin-sdk/*`
...
- For bundled plugin channel changes that can affect startup/import cost, run:
  `AFORA_LOCAL_CHECK=0 node --import tsx scripts/profile-extension-memory.mts --extension <id> --skip-combined --concurrency 1`
