...
function listPackageRoots(): string[] {
  // Source checkouts and packaged installs can resolve Afora from different roots; scan both
  // once so channel metadata works in dev, linked packages, and published CLI layouts.
  return uniqueStrings(
    [
      resolveAforaPackageRootSync({ cwd: process.cwd() }),
      resolveAforaPackageRootSync({ moduleUrl: import.meta.url }),
