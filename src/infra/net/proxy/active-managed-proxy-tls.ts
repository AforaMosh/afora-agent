// Resolves Afora-managed proxy TLS trust for non-Undici transports.
...
const MANAGED_PROXY_ENV_PREFIX = ["AFORA", "PROXY"].join("_");
...
/** Resolves managed proxy TLS trust only when the target proxy is Afora's active proxy. */
