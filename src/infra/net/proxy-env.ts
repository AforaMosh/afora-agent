...
// adding Afora NO_PROXY CIDR/wildcard bypass checks.
 ...
 * - Afora extension: IPv4 CIDR and octet-wildcard entries
 ...
 * in provider HTTP helpers; see afora#64974 review thread on NO_PROXY
 * SSRF bypass.
 */
