...
// Afora HTTP/1, timeout, proxy TLS, and IP-safe proxy policies.
import {
...
/** Creates a direct undici Agent with Afora's HTTP/1-only dispatcher policy. */
...
/**
 * Creates an EnvHttpProxyAgent with Afora proxy TLS, IP-safe proxy pools,
