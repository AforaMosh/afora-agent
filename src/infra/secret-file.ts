...
import { FsSafeError, type FsSafeErrorCode } from "@afora/fs-safe";
import {
...
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@afora/fs-safe/secret"; // Sanctioned domain alias.
