...
export const DEFAULT_WEB_PUSH_VAPID_SUBJECT = "https://afora.ai";
...
function webPushStateDatabaseOptions(stateDir?: string): AforaStateDatabaseOptions {
  return stateDir
...
export function listWebPushSubscriptions(stateDir?: string): WebPushSubscription[] {
  const database = openAforaStateDatabase(webPushStateDatabaseOptions(stateDir));
