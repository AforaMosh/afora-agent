...
describe("staging", () => {
  ...
  it("replays converted transparent images with the encoded filename while preserving SQLite artifact ownership", async () => {
    ...
    // SQLite owns this exact preplanned path; only the public image filename changes.
