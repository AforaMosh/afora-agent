...
import { normalizeUniqueStringEntriesLower } from "@afora/normalization-core/string-normalization";
import type { AforaConfig } from "../config/types.afora.js";

const DIAGNOSTICS_ENV = "AFORA_DIAGNOSTICS";
...
/** Resolves enabled diagnostic flags from config plus `AFORA_DIAGNOSTICS` overrides. */
