// Migrates Afora-owned SQLite tables to canonical STRICT schemas.
...
const STRICT_MIGRATION_TABLE_PREFIX = "__afora_strict_migration_";
...
/** Atomically upgrade Afora-owned tables described by a canonical STRICT schema. */
