...
const WINDOWS_DIRECTORY_EXISTS_MARKER = "AFORA_SQLITE_DIRECTORY_EXISTS";
...
public static class AforaPrivateDirectory
{
...
function resolvePrivateDirectoryPowerShell(directoryPath: string): {
  ...
  const command = [
    ...
    "$errorCode = [AforaPrivateDirectory]::Create($path, $sddl)",
