...
export type SystemEvent = {
  /**
   * Afora-assigned opaque identity for one queued occurrence. Preserve it when returning a
...
const SYSTEM_EVENT_QUEUES_KEY = Symbol.for("afora.systemEvents.queues");
