// Resolves the LAN host Afora should advertise to nearby devices.
import { isRfc1918Ipv4Address } from "@afora/net-policy/ip";
import { normalizeLowercaseStringOrEmpty as normalizeInterfaceName } from "@afora/normalization-core/string-coerce";
