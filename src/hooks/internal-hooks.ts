/**
 * Hook system for Afora agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("afora.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("afora.internalHooksEnabled");
