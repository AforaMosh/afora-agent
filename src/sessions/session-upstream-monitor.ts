...
type SessionUpstreamMonitorOptions = AforaStateDatabaseOptions & {
...
function databaseOptions(options: SessionUpstreamMonitorOptions): AforaStateDatabaseOptions {
  return {
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[
    Symbol.for("afora.sessionUpstreamMonitorTestApi")
