// Browser control auth helpers resolve plugin browser credentials from Afora config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: AforaConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
