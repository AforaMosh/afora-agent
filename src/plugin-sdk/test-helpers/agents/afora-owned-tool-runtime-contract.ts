// Afora-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installAforaOwnedToolHooks(params?: {
 ...
 * Pair with `installAforaOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetAforaOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
