...
export { canonicalizeBase64, estimateBase64DecodedBytes } from "@afora/media-core/base64";
export { parseMediaContentLength } from "@afora/media-core/content-length";
export { MAX_AUDIO_BYTES } from "@afora/media-core/constants";
...
export { kindFromMime } from "@afora/media-core/mime";
export {
  MAX_IMAGE_BYTES,
  maxBytesForKind,
  mediaKindFromMime,
} from "@afora/media-core/constants";
export type { MediaKind } from "@afora/media-core/constants";
