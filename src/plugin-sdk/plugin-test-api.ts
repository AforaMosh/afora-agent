...
import {
  ...
  type AforaPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { AforaPluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<AforaPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): AforaPluginApi {
  ...
  const mergedApi = {
    ...
    on() {},
    ...flatApi,
  } satisfies AforaPluginApiWithoutFacades;
