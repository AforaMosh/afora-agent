...
type ExecToolConfig = NonNullable<NonNullable<AforaConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<AforaConfig> {
