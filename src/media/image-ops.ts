...
/** Afora-facing image backend availability error, preserving the failed operation and causes. */
...
/** Creates a Rastermill processor with Afora temp-dir, pixel-limit, and command trust policy. */
...
/** Detects either Afora's wrapper error or Rastermill's native unavailable error. */
