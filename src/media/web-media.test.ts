...
describe("loadWebMedia", () => {
  ...
  it("renames transparent WebP images converted to PNG across direct, local, and remote image owners", async () => {
    const { optimizeImageBufferForWebMedia } = await import("./web-media.js");
  ...
  it("reconciles sniffed image filenames without optimization while preserving raw-loader metadata", async () => {
  ...
  it("preserves equivalent JPEG filename aliases and unknown image MIME types", async () => {
