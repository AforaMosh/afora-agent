...
/**
 * Runtime context resolver for Afora plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking Afora plugin tools. */
...
export function resolveAforaPluginToolInputs(params: {
  options?: AforaPluginToolOptions;
