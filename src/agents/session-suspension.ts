 ...
 */
const SESSION_SUSPENSION_STATE_KEY = Symbol.for("afora.sessionSuspensionRuntimeState");
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("afora.sessionSuspensionTestApi")] = {
