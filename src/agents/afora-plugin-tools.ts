...
import {
  resolveAforaPluginToolInputs,
  type AforaPluginToolOptions,
} from "./afora-tools.plugin-context.js";
...
type ResolveAforaPluginToolsOptions = AforaPluginToolOptions & {
...
export function resolveAforaPluginToolsForOptions(params: {
  options?: ResolveAforaPluginToolsOptions;
  ...
  const pluginToolInputs = resolveAforaPluginToolInputs({
