...
function buildSessionMcpConfigDiscoveryCacheKey(params: {
  ...
  return JSON.stringify({
    ...
    config: resolveRuntimeConfigCacheKey(params.cfg ?? EMPTY_AFORA_CONFIG),
