...
export function createSubagentRegistryLifecycleShared(params: SubagentRegistryLifecycleParams) {
...
export type SubagentRegistryLifecycleShared = ReturnType<
  typeof createSubagentRegistryLifecycleShared
>;
