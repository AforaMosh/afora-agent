...
export function buildSystemPrompt(options: BuildSystemPromptOptions): string {
  ...
  let prompt = `You are an expert coding assistant operating inside Afora's embedded coding agent harness. You help users by reading files, executing commands, editing code, and writing new files.
