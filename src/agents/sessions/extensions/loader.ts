...
import { installAforaInternalCorePackageNativeResolver } from "../../../plugins/plugin-sdk-native-resolver.js";
import {
...
const VIRTUAL_MODULES: Record<string, unknown> = {
  ...
  "afora-agent/plugin-sdk/agent-core": bundledAgentCore,
  "@afora/plugin-sdk/agent-core": bundledAgentCore,
  "afora-agent/plugin-sdk/llm": bundledLlm,
  "@afora/plugin-sdk/llm": bundledLlm,
  "afora-agent/plugin-sdk/agent-sessions": bundledAgentSessions,
  "@afora/plugin-sdk/agent-sessions": bundledAgentSessions,
};
...
function getExtensionLoaderAliases(): Record<string, string> {
  ...
  aliases = {
    ...
    "afora-agent/plugin-sdk/agent-sessions": agentSessionsEntry,
    "@afora/plugin-sdk/agent-sessions": agentSessionsEntry,
...
async function loadExtensionSourceTransformModule(
  ...
  if (!context.sourceTransformLoader) {
    installAforaInternalCorePackageNativeResolver({ moduleUrl: import.meta.url });
