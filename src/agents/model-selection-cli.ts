...
export function prepareCliProviderClassifier(cfg?: AforaConfig): CliProviderClassifier {
...
export function isCliProvider(provider: string, cfg?: AforaConfig): boolean {
