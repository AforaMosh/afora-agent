...
export function coerceImageModelConfig(cfg?: AforaConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: AforaConfig; ref: string }): string[] {
