...
function resolveFetchConfig(cfg?: AforaConfig): WebFetchConfig {
 ...
 * authority (e.g. `https:// docs.afora.ai`), which causes `new URL()` to
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("afora.webFetchTestApi")] = {
    sanitizeWebFetchUrl,
  };
}
