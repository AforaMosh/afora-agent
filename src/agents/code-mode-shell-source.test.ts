...
describe("isShellLikeCodeModeSource", () => {
  ...
  it.each([
    ...
    'const result = await tools.callValue("afora:core:exec", { command: "ls" }); return result;',
    'return await tools.callValue("afora:core:read", { path: "/workspace" });',
    "console.log(await tools.callValue('afora:core:read', { path: '/workspace' }));",
