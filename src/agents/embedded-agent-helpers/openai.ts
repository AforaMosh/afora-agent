 ...
 * pairs directly into the provider payload, so Afora must normalize here.
 */
 ...
 *
 * Afora persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
