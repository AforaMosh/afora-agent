...
describe("handleToolExecutionEnd cron mutation tracking", () => {
  ...
  it.each([
    ...
    ["exec", "pnpm dlx afora@latest cron add --at +1h --message 'follow up'"],
    ["exec", "npx afora@latest cron add --at +1h --message 'follow up'"],
    ["exec", "bunx afora@latest cron add --at +1h --message 'follow up'"],
  ...
  it.each([
    ...
    ["afora@latest cron add --at +1h", "a package spec without a package runner"],
    ["pnpm exec afora@latest cron add --at +1h", "a package spec passed to pnpm exec"],
