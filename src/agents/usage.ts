 ...
 * Converts provider-specific usage shapes into Afora's normalized input,
...
/** Normalize provider-specific token usage fields into Afora usage buckets. */
 ...
 * recombine Afora's separately priced buckets and retain their details.
