...
type EmbeddedRunAttemptToolTerminalObservation = {
  ...
  >;
  /** Protocol-owned mutation facts for native tools that do not use Afora definitions. */
  nativeMutation?: {
...
export type EmbeddedRunAttemptParams = EmbeddedRunAttemptBase & {
  ...
  /** Afora-owned runtime policy prepared by the orchestrator for this attempt. */
  ...
  /** Storage-aware trajectory recorder owned by the Afora host. */
  ...
  /**
   * Full auth profile store for Afora tool availability.
...
export type EmbeddedRunAttemptResult = {
  ...
  settledTurnFinalizationContext?: {
    readonly source: "afora-transcript";
