...
export async function prepareEmbeddedRunRuntime(input: {
  ...
  pluginHarnessOwnsTransport = agentHarness.id !== "afora";
  ...
  const pluginHarnessNeedsAforaAuthBootstrap =
  ...
  if (!pluginHarnessOwnsTransport || pluginHarnessNeedsAforaAuthBootstrap) {
