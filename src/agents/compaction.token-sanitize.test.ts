...
import { serializeConversation, type AgentMessage } from "afora-agent/plugin-sdk/agent-core";
...
vi.mock("afora-agent/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof import("afora-agent/plugin-sdk/agent-sessions")>(
    "afora-agent/plugin-sdk/agent-sessions",
  );
  return {
    ...actual,
