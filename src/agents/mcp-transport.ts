 ...
 * streamable-HTTP SDK transports with Afora auth, redirect, and logging rules.
 */
import {
  SSEClientTransport,
...
function attachStderrLogging(serverName: string, transport: AforaStdioClientTransport) {
