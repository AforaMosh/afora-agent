...
type SandboxRegistryTable = AforaStateKyselyDatabase["sandbox_registry_entries"];
type SandboxRegistryDatabase = Pick<AforaStateKyselyDatabase, "sandbox_registry_entries">;
