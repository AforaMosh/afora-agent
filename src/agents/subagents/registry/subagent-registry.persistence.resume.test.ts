...
import { closeAforaStateDatabaseForTest as closeSeedStateDatabase } from "../../../state/afora-state-db.js";
...
let registryStateDbModule: typeof import("../../../state/afora-state-db.js");
...
describe("subagent registry persistence resume", () => {
  ...
  beforeAll(async () => {
    ...
    registryStateDbModule = await import("../../../state/afora-state-db.js");
  });
  ...
  afterEach(async () => {
    ...
    registryStateDbModule.closeAforaStateDatabaseForTest();
    mod.testing.setDepsForTest();
    mod.resetSubagentRegistryForTests({ persist: false });
