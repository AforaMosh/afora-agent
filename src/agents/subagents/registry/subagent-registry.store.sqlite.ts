...
import { asFiniteNumber as normalizeFiniteNumber } from "@afora/normalization-core/number-coercion";
...
type SubagentRunsTable = AforaStateKyselyDatabase["subagent_runs"];
