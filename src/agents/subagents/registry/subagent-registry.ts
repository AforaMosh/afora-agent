...
function resolveSubagentWaitTimeoutMs(cfg: AforaConfig, runTimeoutSeconds?: number) {
...
const SUBAGENT_REGISTRY_TEST_HANDLE = Symbol.for("afora.subagentRegistryTestApi");
