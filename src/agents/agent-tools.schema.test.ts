import { normalizeToolParameterSchema } from "@afora/ai/internal/openai";
 ...
 */
import { runAgentLoop, type AgentEvent, type StreamFn } from "afora-agent/plugin-sdk/agent-core";
import { createAssistantMessageEventStream, validateToolArguments } from "afora-agent/plugin-sdk/llm";
