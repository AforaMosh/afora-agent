...
export function resolveImageFallbackDefaultProvider(cfg: AforaConfig | undefined): string {
...
function resolveFallbackCandidateModelProviderCacheParts(cfg: AforaConfig | undefined): unknown {
