...
/**
 * Applies Codex-only agent scoping before Afora resolves credentials or opens transports.
...
/** Async runtime projection that resolves Afora-managed MCP bearer tokens. */
