...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  [contractPluginPath({
    ...
    'export type { AforaPluginServiceContext } from "./api.js";',
  ],
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin } from "afora-agent/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "afora-agent/plugin-sdk/status-helpers";',
      'export { formatTrimmedAllowFromEntries } from "afora-agent/plugin-sdk/channel-config-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiAforaConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [contractPluginPath({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "afora-agent/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema, GoogleChatConfigSchema } from "./config-api.js";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "afora-agent/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "afora-agent/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "afora-agent/plugin-sdk/channel-outbound";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "afora-agent/plugin-sdk/runtime-group-policy";',
    ...
    'export type { GoogleChatAccountConfig, GoogleChatConfig } from "afora-agent/plugin-sdk/config-contracts";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "afora-agent/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "afora-agent/plugin-sdk/webhook-request-guards";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "msteams", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export { mergeAllowlist, resolveAllowlistMatchSimple, summarizeMapping } from "afora-agent/plugin-sdk/allow-from";',
      'export type { BaseProbeResult, ChannelDirectoryEntry, ChannelGroupContext, ChannelMessageActionName, ChannelOutboundAdapter } from "afora-agent/plugin-sdk/channel-contract";',
      ...
      'export { createChannelMessageReplyPipeline } from "afora-agent/plugin-sdk/channel-outbound";',
      'export { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary, createDefaultChannelRuntimeState } from "afora-agent/plugin-sdk/channel-status";',
      'export { buildChannelKeyCandidates, normalizeChannelSlug, resolveChannelEntryMatchWithFallback, resolveNestedAllowlistDecision } from "afora-agent/plugin-sdk/channel-targets";',
      'export type { GroupPolicy, GroupToolPolicyConfig, MSTeamsChannelConfig, MSTeamsCloudName, MSTeamsConfig, MSTeamsReplyStyle, MSTeamsTeamConfig, MarkdownTableMode, AforaConfig } from "afora-agent/plugin-sdk/config-contracts";',
      'export { isDangerousNameMatchingEnabled } from "afora-agent/plugin-sdk/dangerous-name-runtime";',
      ...
      'export { detectMime, extensionForMime, extractOriginalFilename, getFileExtension, resolveChannelMediaMaxBytes } from "afora-agent/plugin-sdk/media-runtime";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "afora-agent/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext } from "afora-agent/plugin-sdk/channel-contract";',
    'export type { AforaConfig } from "afora-agent/plugin-sdk/config-contracts";',
    ...
    'export type { RuntimeEnv } from "afora-agent/plugin-sdk/runtime-env";',
  ...
  [contractPluginPath({
    ...
    'export { createChannelPairingController } from "afora-agent/plugin-sdk/channel-pairing";',
    'export type { BlockStreamingCoalesceConfig, DmConfig, DmPolicy, GroupPolicy, GroupToolPolicyConfig, AforaConfig } from "afora-agent/plugin-sdk/config-contracts";',
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "afora-agent/plugin-sdk/runtime-group-policy";',
    'export { createChannelMessageReplyPipeline } from "afora-agent/plugin-sdk/channel-outbound";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export type { AforaPluginService, AforaPluginServiceContext, PluginLogger } from "afora-agent/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "afora-agent/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "afora-agent/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "afora-agent/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "afora-agent/plugin-sdk/channel-plugin-common";',
      'export { clearAccountEntryFields } from "afora-agent/plugin-sdk/channel-core";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "afora-agent/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "afora-agent/plugin-sdk/channel-actions";',
      ...
      'export type { ChannelPlugin } from "afora-agent/plugin-sdk/channel-core";',
      'export type { AforaConfig } from "afora-agent/plugin-sdk/config-contracts";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeAforaConfig["channels"]>["telegram"] >;',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "twitch", relativePath: "runtime-api.ts" })]: [
    'export type { ChannelAccountSnapshot, ChannelCapabilities, ChannelGatewayContext, ChannelLogSink, ChannelMessageActionAdapter, ChannelMessageActionContext, ChannelMeta, ChannelOutboundAdapter, ChannelOutboundContext, ChannelResolveKind, ChannelResolveResult, ChannelStatusAdapter } from "afora-agent/plugin-sdk/channel-contract";',
    'export type { ChannelPlugin } from "afora-agent/plugin-sdk/channel-core";',
    'export type { OutboundDeliveryResult } from "afora-agent/plugin-sdk/channel-send-result";',
    'export type { AforaConfig } from "afora-agent/plugin-sdk/config-contracts";',
    'export type { RuntimeEnv } from "afora-agent/plugin-sdk/runtime";',
    'export type { WizardPrompter } from "afora-agent/plugin-sdk/setup";',
  ],
  [contractPluginPath({
    ...
    'export { isRequestBodyLimitError, readRequestBodyWithLimit, requestBodyErrorToText } from "afora-agent/plugin-sdk/webhook-request-guards";',
    ...
    'export { TtsAutoSchema, TtsConfigSchema, TtsModeSchema, TtsProviderSchema } from "afora-agent/plugin-sdk/tts-runtime";',
...
describe("runtime api guardrails", () => {
  ...
  it("keeps bundled runtime api barrels off their own branded sdk facades", () => {
    for (const [pluginId, rootDir] of getBundledPluginRoots().entries()) {
      ...
      ).not.toContain(`"afora-agent/plugin-sdk/${pluginId}"`);
      expect(
        source,
        `${pluginId} runtime api should use generic sdk subpaths or local exports`,
      ).not.toContain(`'afora-agent/plugin-sdk/${pluginId}'`);
