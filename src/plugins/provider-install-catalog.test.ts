...
const loadAforaProviderIndex = vi.hoisted(() =>
  vi.fn<LoadAforaProviderIndex>(() => ({ version: 1, providers: {} })),
);
...
function vllmPluginWithPackageInstall(): InstalledPluginIndexRecord {
  return {
    pluginId: "vllm",
    origin: "global",
    manifestPath: "/Users/test/.afora/plugins/vllm/afora.plugin.json",
    manifestHash: "hash",
    rootDir: "/Users/test/.afora/plugins/vllm",
    enabled: true,
    startup: {
      sidecar: false,
      memory: false,
    ...
    packageInstall: {
      npm: {
        spec: "@afora/vllm-fork@1.0.0",
        packageName: "@afora/vllm-fork",
        selector: "1.0.0",
...
describe("provider install catalog", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    loadAforaProviderIndex.mockReturnValue({ version: 1, providers: {} });
      ...
      plugins: [
        {
          pluginId: "openai",
          origin: "bundled",
          manifestPath: "/repo/extensions/openai/afora.plugin.json",
          manifestHash: "hash",
          ...
          compat: [],
          packageName: "@afora/openai",
          packageInstall: {
            defaultChoice: "npm",
            npm: {
              spec: "@afora/openai@1.2.3",
              packageName: "@afora/openai",
              selector: "1.2.3",
              selectorKind: "exact-version",
              exactVersion: true,
  ...
  it("preserves durable ClawHub install records for provider setup reinstall hints", () => {
      ...
      registrySnapshot({
        installRecords: {
          vllm: {
            ...
            clawhubPackage: "afora-agent/vllm",
          },
        },
        plugins: [vllmPluginWithPackageInstall()],
      }),
    ...
    expect(resolveProviderInstallCatalogEntry("vllm")).toEqual({
      ...
      origin: "global",
      install: {
        clawhubSpec: "clawhub:afora/vllm@2026.5.2",
      ...
      plugins: [
        {
          ...
          origin: "global",
          manifestPath: "/Users/test/.afora/plugins/demo-provider/afora.plugin.json",
          manifestHash: "hash",
          rootDir: "/Users/test/.afora/plugins/demo-provider",
          enabled: true,
          startup: {
            sidecar: false,
            memory: false,
      ...
      plugins: [
        {
          pluginId: "demo-provider",
          origin: "workspace",
          manifestPath: "/repo/extensions/demo-provider/afora.plugin.json",
          manifestHash: "hash",
  ...
  it("surfaces provider-index install metadata when the provider plugin is not installed", () => {
    loadAforaProviderIndex.mockReturnValue({
      version: 1,
      providers: {
        moonshot: {
          id: "moonshot",
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@afora/plugin-moonshot@1.2.3",
          packageName: "@afora/plugin-moonshot",
          selector: "1.2.3",
          selectorKind: "exact-version",
          exactVersion: true,
          expectedIntegrity: "sha512-moonshot",
  ...
  it("surfaces provider-index ClawHub install metadata as the preferred source", () => {
        ...
        moonshot: {
          ...
          plugin: {
            ...
            install: {
              ...
              npmSpec: "@afora/plugin-moonshot@2026.5.2",
              defaultChoice: "clawhub",
              expectedIntegrity: "sha512-moonshot",
            },
          },
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@afora/plugin-moonshot@2026.5.2",
          packageName: "@afora/plugin-moonshot",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
      ...
      plugins: [
        {
          pluginId: "moonshot",
          origin: "bundled",
          manifestPath: "/repo/extensions/moonshot/afora.plugin.json",
          manifestHash: "hash",
  ...
  it("keeps missing provider-index entries visible when only some provider plugins are installed", () => {
    ...
    loadAforaProviderIndex.mockReturnValue({
      ...
      providers: {
        groq: {
          ...
          plugin: {
            id: "groq",
            package: "@afora/plugin-groq",
            install: {
              npmSpec: "@afora/plugin-groq@1.0.0",
              defaultChoice: "npm",
            },
          },
          authChoices: [
        ...
        vllm: {
          ...
          plugin: {
            id: "vllm",
            package: "@afora/plugin-vllm",
            install: {
              clawhubSpec: "clawhub:afora/vllm@2026.5.2",
              npmSpec: "@afora/plugin-vllm@2026.5.2",
              defaultChoice: "clawhub",
            },
          },
          authChoices: [
    ...
    expect(resolveProviderInstallCatalogEntry("vllm-server")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@afora/plugin-vllm@2026.5.2",
          packageName: "@afora/plugin-vllm",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
