...
export const PLUGIN_INSTALL_OVERRIDES_ENV = "AFORA_PLUGIN_INSTALL_OVERRIDES";
/** Env var gate that must be enabled before install overrides are honored. */
export const ALLOW_PLUGIN_INSTALL_OVERRIDES_ENV = "AFORA_ALLOW_PLUGIN_INSTALL_OVERRIDES";
