...
import type { AforaPackageBuild, PluginPackageChannel } from "./manifest.js";
...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Afora from plugin manifests, install records, and config policy. Use `afora plugins registry --refresh`, `afora plugins install/update/uninstall`, or `afora plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored afora.install metadata. This describes catalog/package
