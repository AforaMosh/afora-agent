...
/** Returns true when a command name is owned by built-in Afora command handling. */
...
function listPluginInvocationKeys(command: AforaPluginCommandDefinition): string[] {
