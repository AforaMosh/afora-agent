...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.afora.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.afora.js").AforaConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.afora.js").AforaConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.afora.js").AforaConfig>;
    /**
  ...
  media: {
    ...
    detectMime: typeof import("@afora/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@afora/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("afora-agent/plugin-sdk/llm").Model<import("afora-agent/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.afora.js").AforaConfig;
      workspaceDir?: string;
