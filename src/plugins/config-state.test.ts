...
describe("normalizePluginsConfig", () => {
  ...
  it("normalizes unknown plugin ids without consulting discovery", async () => {
    const discoverPlugins = vi.spyOn(discovery, "discoverAforaPlugins");
  ...
  it("does not consult discovery or manifests for alias lookup", async () => {
    const discoverPlugins = vi.spyOn(discovery, "discoverAforaPlugins").mockReturnValue({
      candidates: [
        {
          idHint: "anthropic",
          source: "/tmp/afora-bundled-anthropic/index.js",
          rootDir: "/tmp/afora-bundled-anthropic",
          origin: "bundled",
          bundledManifest: {
            id: "anthropic",
            configSchema: {},
        ...
        },
        {
          ...
          source: "/tmp/afora-global-anthropic/index.js",
          rootDir: "/tmp/afora-global-anthropic",
          origin: "global",
        },
      ],
      diagnostics: [],
    ...
    const loadManifest = vi.spyOn(manifest, "loadPluginManifest").mockReturnValue({
      ok: true,
      manifestPath: "/tmp/afora-global-anthropic/afora.plugin.json",
      manifest: {
