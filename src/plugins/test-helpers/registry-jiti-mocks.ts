...
vi.mock("../discovery.js", () => ({
  discoverAforaPlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverAforaPlugins>
  ) => registryJitiMocks.discoverAforaPlugins(...args),
}));
