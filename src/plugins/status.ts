...
import { normalizeAforaVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeAforaVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeAforaVersionBase(plugin.version) ??
    plugin.version
  );
}
