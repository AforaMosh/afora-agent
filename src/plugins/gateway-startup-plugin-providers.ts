...
export function collectConfiguredWebSearchProviderIds(config: AforaConfig): ReadonlySet<string> {
...
function isMemorySlotExplicitlyDisabled(config: AforaConfig): boolean {
