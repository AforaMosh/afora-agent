...
export function listEmbeddingProviders(cfg?: AforaConfig): EmbeddingProviderAdapter[] {
...
function resolveEmbeddingProviderLookupIds(id: string, cfg?: AforaConfig): string[] {
