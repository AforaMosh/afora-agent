...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    surfaces: [
      "afora-agent/plugin-sdk/llm registerApiProvider",
      "afora-agent/plugin-sdk/llm unregisterApiProviders",
    ],
  ...
  },
  {
    ...
    surfaces: [
      ...
      "afora-agent/plugin-sdk/memory-core-host-engine-embeddings registerMemoryEmbeddingProvider",
  ...
  },
  {
    ...
    surfaces: [
      "afora-agent/plugin-sdk/session-store-runtime loadSessionStore",
      "afora-agent/plugin-sdk/session-store-runtime updateSessionStore",
      "afora-agent/plugin-sdk/session-store-runtime resolveSessionFilePath",
      "afora-agent/plugin-sdk/session-store-runtime resolveSessionStoreEntry",
  ...
  },
  {
    ...
    surfaces: [
      "@afora/whatsapp WebInboundMessage flat fields",
  ...
  },
  {
    ...
    docsPath: "/plugins/compatibility",
    surfaces: [
      "@afora/whatsapp WebInboundMessage top-level admission fields",
      "WhatsApp monitorWebInbox onMessage callback",
      "WhatsApp monitorWebChannel listenerFactory injected messages",
    ],
    diagnostics: ["plugin compatibility registry and compatibility guide"],
  ...
  },
  {
    ...
    docsPath: "/plugins/compatibility",
    surfaces: [
      "afora-agent/plugin-sdk reply-runtime MsgContext.UntrustedContext and UntrustedStructuredContext",
      "afora-agent/plugin-sdk reply-runtime UntrustedStructuredContextEntry",
      "afora-agent/plugin-sdk channel-inbound SupplementalContextFacts.untrustedContext",
      "afora-agent/plugin-sdk security-runtime buildUntrustedChannelMetadata",
    ],
  ...
  },
  {
    ...
    surfaces: [
      "afora-agent/plugin-sdk/discord component message helpers",
      "afora-agent/plugin-sdk/telegram-account resolveTelegramAccount",
    ],
  ...
  },
  {
    ...
    surfaces: [
      ...
      "afora-agent/plugin-sdk/channel-route ChannelRouteExplicitTarget",
      "afora-agent/plugin-sdk/channel-route ChannelRouteExplicitTargetParser",
      "afora-agent/plugin-sdk/channel-route resolveChannelRouteTargetWithParser",
    ],
  ...
  },
  {
    ...
    surfaces: [
      ...
      "afora-agent/extension-api runEmbeddedPiAgent",
      "afora-agent/plugin-sdk/agent-harness-runtime EmbeddedPi* aliases",
    ],
    diagnostics: ["plugin SDK compatibility registry"],
    tests: [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "afora-agent/plugin-sdk/bundled-channel-config-schema DiscordConfigSchema",
      "afora-agent/plugin-sdk/bundled-channel-config-schema SignalConfigSchema",
      "afora-agent/plugin-sdk/bundled-channel-config-schema MSTeamsConfigSchema",
      "afora-agent/plugin-sdk/setup-runtime createLegacyCompatChannelDmPolicy",
      "afora-agent/plugin-sdk/setup-runtime promptLegacyChannelAllowFromForAccount",
    ],
    diagnostics: ["plugin compatibility registry and migration guide"],
    tests: ["src/plugins/compat/registry.test.ts"],
    releaseNote:
