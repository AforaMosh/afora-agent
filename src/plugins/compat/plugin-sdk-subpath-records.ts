...
const PLUGIN_SDK_SUBPATH_SEEDS = [
  {
    ...
    status: "removed",
    owner: "channel",
    replacement: "`afora-agent/plugin-sdk/channel-outbound`",
    releaseNote:
  ...
  },
  {
    ...
    replacement:
      "`api.pluginConfig`, `afora-agent/plugin-sdk/config-mutation`, `afora-agent/plugin-sdk/runtime-config-snapshot`, and `afora-agent/plugin-sdk/config-contracts`",
  },
  {
    ...
    replacement:
      "`afora-agent/plugin-sdk/channel-inbound` and `afora-agent/plugin-sdk/channel-outbound`",
  },
  {
  ...
  },
  {
    ...
    removeAfter: "2026-09-01",
    replacement:
      "focused subpaths including `afora-agent/plugin-sdk/delivery-queue-runtime`, `afora-agent/plugin-sdk/diagnostic-runtime`, `afora-agent/plugin-sdk/error-runtime`, `afora-agent/plugin-sdk/exec-approvals-runtime`, `afora-agent/plugin-sdk/fetch-runtime`, and `afora-agent/plugin-sdk/ssrf-runtime`",
  },
  {
    ...
    owner: "sdk",
    replacement:
      "`afora-agent/plugin-sdk/logging-core`, `afora-agent/plugin-sdk/text-chunking`, `afora-agent/plugin-sdk/text-utility-runtime`, and `afora-agent/plugin-sdk/string-coerce-runtime`",
    releaseNote:
  ...
  },
  {
    ...
    owner: "channel",
    replacement:
      "`afora-agent/plugin-sdk/channel-secret-basic-runtime` and `afora-agent/plugin-sdk/channel-secret-tts-runtime`",
    releaseNote:
  ...
  },
  {
    ...
    status: "removed",
    owner: "config",
    replacement: "`afora-agent/plugin-sdk/channel-config-schema`",
    releaseNote:
  ...
  },
  {
    ...
    status: "removed",
    owner: "channel",
    replacement: "`afora-agent/plugin-sdk/run-command`",
    releaseNote:
  ...
  },
  {
    ...
    removeAfter: "2026-09-01",
    replacement:
      "`afora-agent/plugin-sdk/channel-outbound` and `afora-agent/plugin-sdk/channel-inbound`",
  },
  {
    ...
    status: "removed",
    owner: "channel",
    replacement: "`afora-agent/plugin-sdk/channel-ingress-runtime`",
    releaseNote:
...
function buildPluginSdkSubpathRecord(seed: (typeof PLUGIN_SDK_SUBPATH_SEEDS)[number]) {
  if ("status" in seed) {
    return {
      ...
      surfaces: [`afora-agent/plugin-sdk/${seed.subpath}`],
...
const BUNDLED_ONLY_PUBLIC_PLUGIN_SDK_SUBPATH_SEEDS = [
  {
    ...
    replacement:
      "`api.registerMediaUnderstandingProvider(...)` with provider-owned request helpers and types from `afora-agent/plugin-sdk/plugin-entry`; retain the public subpath through the 2026-09-30 window while official plugin consumers migrate",
  ...
  },
  {
    ...
    removeAfter: "2026-09-30",
    replacement:
      "host-prepared memory prompts via `afora-agent/plugin-sdk/core` and memory capability registration through the injected plugin API; retain the facade through the 2026-09-30 window and until a focused public-artifact read seam exists",
...
function buildPublicSdkSubpathRecord({
  ...
  return {
    ...
    ...compat,
    surfaces: [`afora-agent/plugin-sdk/${subpath}`],
