...
export function buildBuiltinChatCommands(
  ...
  const definitions: BuiltinCommandDescriptor[] = [
    ...
    defineBuiltinCommand(
      "afora",
      "Run the Afora setup and repair helper.",
      "management",
      "essential",
      {
        nativeName: false,
    ...
    defineBuiltinCommand("mcp", "Show or set Afora MCP servers.", "management", "power", {
      args: [
        defineCommandArgument("action", "show | get | set | unset", {
          choices: ["show", "get", "set", "unset"],
        }),
    ...
    defineBuiltinCommand("restart", "Restart Afora.", "tools", "power"),
