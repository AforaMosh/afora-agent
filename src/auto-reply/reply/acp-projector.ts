// Projects ACP runtime events into Afora-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@afora/acp-core/runtime/types";
import {
