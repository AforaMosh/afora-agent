...
const acpMocks = vi.hoisted(() => ({
  ...
  readAcpSessionEntry: vi.fn<(params: { sessionKey: string; cfg?: AforaConfig }) => unknown>(
    () => null,
  ),
  readAcpSessionMeta: vi.fn<(params: { sessionKey: string; cfg?: AforaConfig }) => unknown>(
    () => null,
  ),
...
vi.mock("../../tts/tts.js", () => ({
  ...
  resolveTtsConfig: (cfg: AforaConfig) => ttsMocks.resolveTtsConfig(cfg),
}));
...
vi.mock("../../tts/tts-config.js", () => ({
  normalizeTtsAutoMode: (value: unknown) => ttsMocks.normalizeTtsAutoMode(value),
  resolveConfiguredTtsMode: (cfg: AforaConfig) => ttsMocks.resolveTtsConfig(cfg).mode,
  resolveEffectiveTtsConfig: (cfg: AforaConfig) => cfg.tts ?? {},
...
export const emptyConfig = {} as AforaConfig;
