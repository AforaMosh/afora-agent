import { asFiniteNumber as readFiniteNumberValue } from "@afora/normalization-core/number-coercion";
import { asOptionalRecord as readRecordValue } from "@afora/normalization-core/record-coerce";
