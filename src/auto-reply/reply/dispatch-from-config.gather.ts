...
export async function gatherDispatchRequest(
  ...
  // The finalized turn owns the exact prompt bytes; reply cleanup must not guess
  // where a multiline inbound message ends and the assistant's real answer begins.
