...
const SECTION_DOCS_URLS = {
  accessGroups: "https://docs.afora.ai/channels/access-groups",
  messages: "https://docs.afora.ai/concepts/messages",
  tts: "https://docs.afora.ai/tts",
  commands: "https://docs.afora.ai/tools/slash-commands",
  hooks: "https://docs.afora.ai/automation/hooks",
  cron: "https://docs.afora.ai/automation/cron-jobs",
  bindings: "https://docs.afora.ai/concepts/agent-bindings",
  plugins: "https://docs.afora.ai/plugins/manage-plugins",
  mcp: "https://docs.afora.ai/tools/mcp",
  memory: "https://docs.afora.ai/concepts/memory",
  talk: "https://docs.afora.ai/nodes/talk",
  gateway: "https://docs.afora.ai/gateway/configuration",
  browser: "https://docs.afora.ai/tools/browser",
  nodeHost: "https://docs.afora.ai/nodes",
  discovery: "https://docs.afora.ai/gateway/discovery",
  acp: "https://docs.afora.ai/tools/acp-agents",
  agents: "https://docs.afora.ai/concepts/agent",
  models: "https://docs.afora.ai/concepts/models",
  skills: "https://docs.afora.ai/tools/skills",
  tools: "https://docs.afora.ai/tools",
  session: "https://docs.afora.ai/concepts/session",
  security: "https://docs.afora.ai/gateway/security",
  approvals: "https://docs.afora.ai/tools/exec-approvals",
  env: "https://docs.afora.ai/help/environment",
  auth: "https://docs.afora.ai/concepts/oauth",
  update: "https://docs.afora.ai/install/updating",
  logging: "https://docs.afora.ai/logging",
  diagnostics: "https://docs.afora.ai/gateway/diagnostics",
  cli: "https://docs.afora.ai/cli",
  secrets: "https://docs.afora.ai/gateway/secrets",
  ui: "https://docs.afora.ai/web/control-ui",
  wizard: "https://docs.afora.ai/start/wizard",
  channels: "https://docs.afora.ai/channels",
  broadcast: "https://docs.afora.ai/channels/broadcast-groups",
  audio: "https://docs.afora.ai/nodes/audio",
  voicewake: "https://docs.afora.ai/nodes/voicewake",
  presence: "https://docs.afora.ai/concepts/presence",
  cloudWorkers: "https://docs.afora.ai/gateway/cloud-workers",
  desktop: "https://docs.afora.ai/gateway/configuration",
  worktrees: "https://docs.afora.ai/concepts/managed-worktrees",
  proxy: "https://docs.afora.ai/security/network-proxy",
  transcripts: "https://docs.afora.ai/plugins/meeting-plugins",
  surfaces: "https://docs.afora.ai/concepts/messages",
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "gateway.controlUi.basePath": "/afora",
  "gateway.controlUi.root": "dist/control-ui",
  "gateway.controlUi.allowedOrigins": "https://control.example.com",
  "gateway.push.apns.relay.baseUrl": "https://ios-push-relay.afora.ai",
  "channels.mattermost.baseUrl": "https://chat.example.com",
  "agents.entries.*.identity.avatar": "avatars/afora.png",
};
