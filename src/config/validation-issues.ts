import { asNullableObjectRecord, isRecord } from "@afora/normalization-core/record-coerce";
...
const SECRETREF_POLICY_DOC_URL = "https://docs.afora.ai/reference/secretref-credential-surface";
