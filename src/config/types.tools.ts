...
export type CodeModeConfig =
  ...
  | "auto"
  | {
      /** Enable generic Afora code mode. Default: "auto", which engages it only for models whose catalog compat flags `codeMode: "preferred"`. */
...
export type ToolsConfig = {
  ...
  /** Runtime loop detection for repetitive/ stuck tool-call patterns. */
  loopDetection?: ToolLoopDetectionConfig;
  /** Compact large Afora, MCP, and client tool catalogs behind search/call tools. */
