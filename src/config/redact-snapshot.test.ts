...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/afora.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/afora/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/afora/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/afora/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/afora/nickserv-password.txt");
