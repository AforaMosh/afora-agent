...
export const RUNTIME_FIELD_HELP: Record<string, string> = {
  ...
  "gateway.controlUi.github.token":
    "SecretRef-backed service credential for Control UI GitHub previews and project discovery. Omit it to retain the GH_TOKEN/GITHUB_TOKEN environment fallback. Agent tool identities are never used here.",
