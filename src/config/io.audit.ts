...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.AFORA_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.AFORA_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.AFORA_WATCH_COMMAND),
...
export type ConfigAuditScrubResult = {
  ...
  // to swap the file. Caller should re-run `afora doctor --fix` once the
