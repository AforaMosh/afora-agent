      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/brave/afora.plugin.json",
        ...
        ...mockWebSearchProviders
          ...
          .map((provider) => ({
            ...
            source: "test",
            manifestPath: `/tmp/plugins/${provider.pluginId}/afora.plugin.json`,
          ...
          })),
        {
          ...
          source: "test",
          manifestPath: "/tmp/plugins/acme-search/afora.plugin.json",
