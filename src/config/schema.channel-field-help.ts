...
const SHARED_CHANNEL_FIELD_HELP: Record<string, string> = {
  ...
  capabilities: "Override the channel capabilities Afora assumes this account supports.",
  ...
  textChunkLimit: "Maximum characters per outbound message before Afora splits it.",
