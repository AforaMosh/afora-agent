...
export const ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS_ENV =
  "AFORA_ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS";
...
export function resolveFutureConfigActionBlock(
  ...
  return {
    ...
    currentVersion,
    touchedVersion,
    message: `Refusing to ${params.action} because this Afora binary (${currentVersion}) is older than the config last written by Afora ${touchedVersion}.`,
    hints: [
