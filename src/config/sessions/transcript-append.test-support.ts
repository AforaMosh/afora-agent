...
import { resolveTimestampMsToIsoString } from "@afora/normalization-core/number-coercion";
...
async function appendSessionTranscriptMessageLocked<TMessage>(
  ...
  const entry = {
    ...
    ...(leafInfo.appendMode === "side" && isTranscriptOnlyAforaAssistantMessage(finalMessage)
