...
import {
  ...
  projectTranscriptVideoContent,
} from "./session-accessor.sqlite-transcript-media-projection.js";
import {
...
export function redactTranscriptMessageForStorage<TMessage>(
  ...
  const persistedMessage = projectTranscriptVideoContent(message) as AgentMessage;
