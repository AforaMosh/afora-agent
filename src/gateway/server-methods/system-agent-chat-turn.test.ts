...
describe("system-agent chat input", () => {
  it.each([
    ...
    },
    {
      ...
      error: "Delegated Afora sessions cannot submit structured wizard answers.",
    },
    {
      input: {
        sessionId: "s1",
      ...
      error: "A wizard answer cannot reset its Afora chat session.",
    },
    {
      input: {
        sessionId: "s1",
    ...
    },
    {
      ...
      error: "Delegated Afora sessions cannot cancel hosted wizards.",
    },
    {
      input: {
        sessionId: "s1",
      ...
      error: "A wizard cancel cannot reset its Afora chat session.",
    },
