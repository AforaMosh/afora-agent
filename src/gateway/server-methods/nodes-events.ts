// Node event methods validate event envelopes and bind event work to the
// authenticated node connection and pairing generation.
...
import { resolveDispatchableNodeSession } from "./nodes-wake.js";
import {
