  ...
  it.each([
    {
      ...
      expected:
        "v2|dev-1|afora-macos|ui|operator|operator.admin,operator.read|1700000000000||nonce-abc",
    },
    {
      ...
      expected:
        "v3|dev-1|afora-macos|ui|operator|operator.admin,operator.read|1700000000000|tok-123|nonce-abc|ios|iphone",
    },
    {
      ...
      expected: "v3|dev-2|afora-ios|ui|operator|operator.read|1700000000001||nonce-def||",
    },
  ])("$name", ({ build, expected }) => {
