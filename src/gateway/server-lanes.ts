...
export function resolveGatewayLaneConcurrency(cfg: AforaConfig): GatewayLaneConcurrency {
...
export function applyGatewayLaneConcurrency(
  ...
  // is precisely the additive-capacity behaviour afora#98813 was held for.
