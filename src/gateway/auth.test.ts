...
describe("gateway auth", () => {
  ...
  it("resolves token/password from AFORA gateway env vars", () => {
    const auth = resolveGatewayAuth({
      authConfig: {},
      env: {
        AFORA_GATEWAY_TOKEN: "env-token",
        AFORA_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides AFORA_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        AFORA_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
