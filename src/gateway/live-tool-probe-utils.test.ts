    ...
    it.each([
      {
        ...
        text: "Same request, same answer — this isn't a real Afora probe. No part of the system asks me to parrot back nonce values.",
        expected: true,
      },
      {
  ...
  describe("shouldRetryToolReadProbe", () => {
    it.each([
      ...
      },
      {
        ...
        params: {
          text: "This isn't a real Afora probe; I won't parrot back nonce values.",
          nonceA: "nonce-a",
          nonceB: "nonce-b",
          provider: "anthropic",
          attempt: 0,
