...
export function hasAmbiguousGatewayAuthModeConfig(cfg: AforaConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: AforaConfig): void {
