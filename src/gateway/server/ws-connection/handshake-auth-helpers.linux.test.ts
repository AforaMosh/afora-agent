// Linux native-app admission tests: afora-linux joins the native UI client class,
...
describe("linux native-app handshake admission", () => {
  it("auto-approves local afora-linux pairing and keeps remote pairing explicit", () => {
