...
export const MEMORY_DREAMING_SYSTEM_EVENT_TEXT =
  "__afora_memory_core_short_term_promotion_dream__";
...
export const LEGACY_MEMORY_LIGHT_DREAMING_EVENT_TEXT = "__afora_memory_core_light_sleep__";
...
export const LEGACY_MEMORY_REM_DREAMING_EVENT_TEXT = "__afora_memory_core_rem_sleep__";
...
export function resolveMemoryDreamingPluginId(
  cfg: AforaConfig | Record<string, unknown> | undefined,
): string {
