...
import { normalizeStructuredPromptSection } from "@afora/ai/internal/shared";
...
/**
 * Delegate a context-engine compaction request to Afora's built-in runtime compaction path.
 *
