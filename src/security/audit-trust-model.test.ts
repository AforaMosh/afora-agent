...
function audit(cfg: AforaConfig) {
    ...
    const cases = [
      ...
      },
      {
        ...
        assert: (findings: ReturnType<typeof audit>) => {
          ...
          expect(finding.detail).toContain("https://docs.afora.ai/gateway/multi-tenant-hosting");
      ...
      },
      {
        ...
        assert: (findings: ReturnType<typeof audit>) => {
          ...
          expect(finding.remediation).toContain(
            "https://docs.afora.ai/channels/groups#session-keys",
          );
        },
      },
      {
