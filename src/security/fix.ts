...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AforaConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AforaConfig; env: NodeJS.ProcessEnv }): {
  cfg: AforaConfig;
  changes: string[];
} {
