...
let closeAforaAgentDatabasesForTest: typeof import("../state/afora-agent-db.js").closeAforaAgentDatabasesForTest;
let withAforaTestState: typeof import("../test-utils/afora-test-state.js").withAforaTestState;
...
describe("auth profile migration isolation", () => {
  beforeEach(async () => {
    ...
    ({ closeAforaAgentDatabasesForTest } = await import("../state/afora-agent-db.js"));
    ({ withAforaTestState } = await import("../test-utils/afora-test-state.js"));
    clearSecretsRuntimeSnapshot();
