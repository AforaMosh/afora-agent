...
export type SecretRefCredentialMatrixDocument = {
  ...
  scope: "Credentials that are strictly user-supplied and not minted/rotated by Afora runtime.";
...
export function buildSecretRefCredentialMatrix(): SecretRefCredentialMatrixDocument {
  ...
  return {
    ...
    pathSyntax: 'Dot path with "*" for map keys and "[]" for arrays.',
    scope:
      "Credentials that are strictly user-supplied and not minted/rotated by Afora runtime.",
