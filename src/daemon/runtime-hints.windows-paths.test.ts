...
const resolveGatewayLogPathsMock = vi.fn(() => ({
  logDir: "C:\\tmp\\afora-state\\logs",
  stdoutPath: "C:\\tmp\\afora-state\\logs\\gateway.log",
  stderrPath: "C:\\tmp\\afora-state\\logs\\gateway.err.log",
}));
const resolveGatewaySupervisorLogPathsMock = vi.fn(() => ({
  logDir: "C:\\Users\\test\\Library\\Logs\\afora",
  stdoutPath: "C:\\Users\\test\\Library\\Logs\\afora\\gateway.log",
  stderrPath: "C:\\Users\\test\\Library\\Logs\\afora\\gateway.err.log",
}));
const resolveGatewayRestartLogPathMock = vi.fn(
  () => "C:\\tmp\\afora-state\\logs\\gateway-restart.log",
);
