...
import type { RemoteModelCatalogPricing } from "@afora/model-catalog-core";
import type { ModelCatalogCost } from "@afora/model-catalog-core/model-catalog-types";
...
const EMPTY_CONFIG: AforaConfig = {};
const pricingContextByConfig = new WeakMap<AforaConfig, PricingContext>();
...
function buildPricingContext(config: AforaConfig): PricingContext {
...
function getPricingContext(config: AforaConfig): PricingContext {
...
export function modelCatalogPricingFingerprint(config?: AforaConfig): string {
