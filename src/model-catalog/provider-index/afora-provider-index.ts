// Bundled Afora provider index advertises pre-install provider metadata for model picker discovery.
import type { AforaProviderIndex } from "./types.js";

// Afora-owned preview metadata for providers whose plugins may not be
...
export const AFORA_PROVIDER_INDEX = {
  version: 1,
  providers: {
    moonshot: {
      id: "moonshot",
