import { normalizeOptionalString as readTtsResultString } from "@afora/normalization-core/string-coerce";
import type { AforaConfig, ResolvedTtsPersona, TtsProvider } from "../config/types.js";
