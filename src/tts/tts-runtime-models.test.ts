  ...
  it("uses agents.defaults.voiceModel as the default speech provider and model", async () => {
    ...
    const result = await synthesizeSpeech({
      ...
      cfg: {
        ...
        tts: {
          enabled: true,
          prefsPath: "/tmp/afora-speech-core-voice-model-default-test.json",
        },
      } as AforaConfig,
      disableFallback: true,
    });
    ...
    const result = await synthesizeSpeech({
      ...
      cfg: {
        ...
        tts: {
          enabled: true,
          provider: "openrouter",
          prefsPath: "/tmp/afora-speech-core-explicit-model-alias-test.json",
          providers: {
            openrouter: {
  ...
  it("tries voiceModel fallbacks before auto-selected speech providers", async () => {
    ...
    const result = await synthesizeSpeech({
      ...
      cfg: {
        ...
        tts: {
          enabled: true,
          prefsPath: "/tmp/afora-speech-core-voice-model-fallback-test.json",
        },
      } as AforaConfig,
    });
  ...
  it("tries same-provider voiceModel fallbacks as separate model attempts", async () => {
    ...
    const result = await synthesizeSpeech({
      ...
      cfg: {
        ...
        tts: {
          enabled: true,
          prefsPath: "/tmp/afora-speech-core-same-provider-voice-model-fallback-test.json",
        },
      } as AforaConfig,
    });
    ...
    const result = await textToSpeechStream({
      ...
      cfg: {
        tts: {
          enabled: true,
          provider: "buffered",
          prefsPath: "/tmp/afora-speech-core-streaming-fallback-test.json",
        },
      } as AforaConfig,
    });
    ...
    const result = await textToSpeechStream({
      ...
      cfg: {
        tts: {
          enabled: true,
          provider: "primary",
          prefsPath: "/tmp/afora-speech-core-streaming-timeout-test.json",
        },
      } as AforaConfig,
    });
