...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: AforaConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: AforaConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: AforaConfig;
  agentDir?: string;
  listProviders: (cfg?: AforaConfig) => CapabilityProviderCandidate[];
}): string[] {
