...
function resolveHeartbeat(config: AforaConfig, agentId: string): unknown {
...
function resolvePortableTools(config: AforaConfig, agentId: string): unknown {
...
function resolvePortableMemorySearch(config: AforaConfig, agentId: string): unknown {
