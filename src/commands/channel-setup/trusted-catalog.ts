...
function resolveEffectiveTrustConfig(cfg: AforaConfig, env?: NodeJS.ProcessEnv): AforaConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: AforaConfig): string[] | undefined {
