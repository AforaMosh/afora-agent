...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://afora.local")).toBe("https://afora.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://afora.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: afora security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://afora.local" },
      ...
      { Item: "Security", Value: "Run: afora security audit --deep" },
