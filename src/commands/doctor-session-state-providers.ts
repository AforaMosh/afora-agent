...
import { normalizeStringEntriesLower } from "@afora/normalization-core/string-normalization";
...
function resolveSessionAgentId(cfg: AforaConfig, sessionKey: string): string | undefined {
