...
function hasExplicitMemorySearchConfig(cfg: AforaConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: AforaConfig): MemoryPluginStatus {
