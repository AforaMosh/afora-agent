...
export function scanLegacyToolsBySenderKeys(cfg: AforaConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: AforaConfig): {
  config: AforaConfig;
  changes: string[];
} {
