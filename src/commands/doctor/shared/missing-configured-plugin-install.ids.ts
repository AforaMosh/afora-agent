...
function addConfiguredAgentRuntimePluginIds(ids: Set<string>, cfg: AforaConfig): void {
...
function addConfiguredSpeechProviderPluginIds(ids: Set<string>, cfg: AforaConfig): void {
  for (const pluginId of resolveOfficialExternalProviderContractPluginIds({
...
function addConfiguredWebFetchProviderPluginIds(ids: Set<string>, cfg: AforaConfig): void {
...
export function collectBlockedPluginIds(cfg: AforaConfig): Set<string> {
  const ids = new Set<string>();
