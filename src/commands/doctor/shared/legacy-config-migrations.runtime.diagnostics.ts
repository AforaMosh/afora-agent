...
const UNSUPPORTED_OTEL_GRPC_PROTOCOL_RULE: LegacyConfigRule = {
  ...
  message:
    'diagnostics.otel.protocol = "grpc" is no longer accepted because gRPC export is not implemented. Run "afora doctor --fix", then configure an OTLP/HTTP collector before re-enabling telemetry.',
