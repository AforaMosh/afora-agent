...
function collectExecSafeBinScopes(cfg: AforaConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: AforaConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: AforaConfig): {
  config: AforaConfig;
  changes: string[];
  warnings: string[];
} {
