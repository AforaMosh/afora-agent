...
export function collectMissingDefaultAccountBindingWarnings(cfg: AforaConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: AforaConfig): string[] {
  const warnings: string[] = [];
