...
export const UPDATE_IN_PROGRESS_ENV = "AFORA_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "AFORA_UPDATE_POST_CORE_CONVERGENCE";
export const UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV =
  "AFORA_UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR";
export const UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV =
  "AFORA_UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE";
 ...
 * `AFORA_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `AFORA_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
