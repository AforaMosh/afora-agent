...
const THREAD_BINDING_RULES: LegacyConfigRule[] = [
  {
    ...
    message:
      'session.threadBindings.ttlHours was renamed to session.threadBindings.idleHours. Run "afora doctor --fix".',
    match: (value) => hasLegacyThreadBindingTtl(value),
  },
  {
    path: ["channels"],
    message:
      'channels.<id>.threadBindings.ttlHours was renamed to channels.<id>.threadBindings.idleHours. Run "afora doctor --fix".',
    match: (value) => hasLegacyThreadBindingInAnyChannel(value, hasLegacyThreadBindingTtl),
  },
  {
    path: ["session", "threadBindings"],
    message:
      'session.threadBindings.spawnSubagentSessions/spawnAcpSessions were replaced by session.threadBindings.spawnSessions. Run "afora doctor --fix".',
    match: (value) => hasLegacyThreadBindingSpawnSplit(value),
  },
  {
    path: ["channels"],
    message:
      'channels.<id>.threadBindings.spawnSubagentSessions/spawnAcpSessions were replaced by channels.<id>.threadBindings.spawnSessions. Run "afora doctor --fix".',
...
const GROUP_ROUTING_RULES: LegacyConfigRule[] = [
  {
    ...
    message:
      'routing.allowFrom was removed; use channels.whatsapp.allowFrom instead. Run "afora doctor --fix".',
  },
  {
    path: ["routing", "groupChat", "requireMention"],
    message:
      'routing.groupChat.requireMention was removed; use channels.<channel>.groups."*".requireMention instead. Run "afora doctor --fix".',
  },
  {
    path: ["routing", "groupChat", "historyLimit"],
    message:
      'routing.groupChat.historyLimit was moved; use messages.groupChat.historyLimit instead. Run "afora doctor --fix".',
  },
  {
    path: ["routing", "groupChat", "mentionPatterns"],
    message:
      'routing.groupChat.mentionPatterns was moved; use messages.groupChat.mentionPatterns instead. Run "afora doctor --fix".',
  },
  {
    path: ["channels", "telegram", "requireMention"],
    message:
      'channels.telegram.requireMention was removed; use channels.telegram.groups."*".requireMention instead. Run "afora doctor --fix".',
  },
];
...
const FEISHU_ACCOUNT_RULES: LegacyConfigRule[] = [
  {
    ...
    message:
      'channels.feishu.accounts.<id>.botName was renamed to channels.feishu.accounts.<id>.name. Run "afora doctor --fix".',
...
const WEBCHAT_CHANNEL_RULES: LegacyConfigRule[] = [
  {
    ...
    message: 'channels.webchat is retired. Run "afora doctor --fix".',
  },
];
