...
export const LEGACY_VLLM_QWEN_AGENT_THINKING_FORMAT_RULE: LegacyConfigRule = {
  ...
  message:
    'agents.defaults.models.<vllm-model>.params.qwenThinkingFormat is legacy; run "afora doctor --fix" to move it to models.providers.vllm.models[].compat.thinkingFormat.',
...
export const LEGACY_VLLM_QWEN_PROVIDER_THINKING_FORMAT_RULE: LegacyConfigRule = {
  ...
  message:
    'models.providers.vllm.params.qwenThinkingFormat is legacy; run "afora doctor --fix" to move it to models.providers.vllm.models[].compat.thinkingFormat.',
...
export const LEGACY_VLLM_QWEN_PROVIDER_MODEL_THINKING_FORMAT_RULE: LegacyConfigRule = {
  ...
  message:
    'models.providers.vllm.models[*].params.qwenThinkingFormat is legacy; run "afora doctor --fix" to move it to models.providers.vllm.models[].compat.thinkingFormat.',
...
export const LEGACY_VLLM_QWEN_DEFAULT_PARAMS_THINKING_FORMAT_RULE: LegacyConfigRule = {
  ...
  message:
    'agents.defaults.params.qwenThinkingFormat is legacy; run "afora doctor --fix" to move it to models.providers.vllm.models[].compat.thinkingFormat.',
...
export const LEGACY_VLLM_QWEN_AGENT_PARAMS_THINKING_FORMAT_RULE: LegacyConfigRule = {
  path: ["agents"],
  message:
    'agents.list[].params.qwenThinkingFormat is legacy; run "afora doctor --fix" to move it to models.providers.vllm.models[].compat.thinkingFormat.',
...
export const INVALID_THINKING_FORMAT_RULE: LegacyConfigRule = {
  path: ["models", "providers"],
  message:
    'models.providers.<id>.models[*].compat.thinkingFormat has an unrecognized value; run "afora doctor --fix" to remove it and restore the runtime default.',
...
export const STALE_CONTEXT_WINDOW_RULE: LegacyConfigRule = {
  path: ["models", "providers"],
  message:
    'models.providers.<id>.models[*].contextWindow has a stale catalog value; run "afora doctor --fix" to repair it.',
