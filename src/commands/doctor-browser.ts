...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: AforaConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: AforaConfig, deps?: BrowserDoctorDeps) {
  try {
