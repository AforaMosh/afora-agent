...
describe("channels list", () => {
  ...
  it("default output shows configured official external channels when the plugin is missing", async () => {
    ...
    mocks.resolveMissingOfficialExternalChannelPluginRepairHint.mockReturnValue({
      ...
      installCommand: "afora plugins install @afora/discord",
      doctorFixCommand: "afora doctor --fix",
      repairHint:
        "Install the official external plugin with: afora plugins install @afora/discord, or run: afora doctor --fix.",
    });
    mocks.readConfigFileSnapshot.mockResolvedValue({
      ...baseConfigSnapshot,
      config: {
    ...
    expect(output).toContain(
      "run afora plugins install @afora/discord or afora doctor --fix",
    );
