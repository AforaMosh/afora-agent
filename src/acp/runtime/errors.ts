/** ACP runtime error exports wired to Afora secret redaction. */
import { configureAcpErrorRedactor } from "@afora/acp-core";
...
export * from "@afora/acp-core/runtime/errors";
export * from "@afora/acp-core/runtime/error-text";
