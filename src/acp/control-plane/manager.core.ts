...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: AforaConfig; sessionKey: string }): AcpSessionResolution {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: AforaConfig; sessionKey: string }): void {
