/** Resolves ACP request metadata into Afora Gateway session keys and reset behavior. */
import { readBool, readMetadataString } from "@afora/acp-core/meta";
...
/** Parses ACP request metadata into Afora session routing hints. */
