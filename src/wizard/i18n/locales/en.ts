...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in Afora config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `afora doctor` next.",
    ...
    memoryImport: {
      ...
      confirm: "Import these memories into your Afora workspace?",
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: AFORA_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in Afora config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in Afora config",
    ...
    guided: {
      ...
      custodianIntro: "Hi — I'm Afora. I keep this system running. Let's get you set up.",
      failedOptionsIntro: "These didn't work just now:",
      findMeLater:
        "You can always find me later — run `afora` in a terminal, or open Settings in the dashboard.",
      ...
      complete: "Afora is ready.",
      completeWithoutAi: "Afora setup is saved. Connect AI before opening chat.",
      ...
      escapeHatches: "For the full step-by-step wizard, run `afora onboard --classic`.",
      ...
      invalidConfigDetails: "Afora config {path} is invalid:\n{issues}",
      invalidConfigRepair:
      ...
      nextSteps:
        "Workspace: {workspace}\nAdd a channel: `afora channels add`\nPrefer chatting? Run `afora setup` and say `connect telegram` (or `connect slack`).\nOpen the dashboard: `afora dashboard`\nChat later: `afora`",
      nextStepsWithoutAi:
        "Workspace: {workspace}\nAdd AI later: re-run `afora onboard`\nAfter AI connects, add a channel: `afora channels add`\nOpen the dashboard: `afora dashboard`",
    ...
    security: {
      ...
      attribution:
        "Afora is an open-source assistant that learns and grows with you, by the Afora Foundation (a non-profit).",
      baselineDmSessions:
      ...
      hardeningRequired:
        "If you're not comfortable managing access controls and security hardening, don't run Afora without help.",
      learnMore: "Learn more at",
      notMultitenant: "Afora is not designed to safely separate multiple users by default.",
      personalAgent: "By default, Afora is a personal agent for one operator.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.afora.ai/skills",
      enterEnv: "Enter {env}",
      ...
      manualPrereqsDoctorHint:
        "Install those tools first, then run `afora doctor` to review skills + requirements.",
    ...
    clickclack: {
      ...
      helpCreateToken:
        "In ClickClack: Workspace settings → Integrations → Afora → create bot → copy token",
      invalidToken:
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "Afora" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so Afora can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for Afora",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: afora channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL Afora uses to send replies back to Chat.",
      ...
      publicWebhookUrlScope:
        "Expose only this webhook route; Afora uses it for short-lived attachment downloads.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "Afora"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var AFORA_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: AFORA_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to Afora with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with afora configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.afora.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control Afora.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control Afora.",
      ...
      daemonRuntimeNodeHint:
        "Required because Afora state uses node:sqlite; Bun cannot run the Gateway.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control Afora.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control Afora.",
      outroSeeded:
      ...
      containerSystemdUnavailable:
        "Systemd user services are not available inside this container. Afora is skipping only the background service install; run the Gateway in the foreground or use your container supervisor.",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.afora.ai/security",
      ...
      webDocs: "Docs: https://docs.afora.ai/tools/web",
      ...
      whatNow: 'What now: https://afora.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.afora.ai/concepts/agent-workspace",
