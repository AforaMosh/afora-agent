  ...
  it("classifies common daemon hint kinds", () => {
    ...
    expect(writeJson).toHaveBeenCalledWith(
      expect.objectContaining({
        ...
        hints,
        hintItems: [
          { kind: "install", text: "afora gateway install" },
          {
            kind: "container-restart",
            text: "Restart the container or the service that manages it for afora-demo-container.",
          },
          {
          ...
          },
          {
            ...
            text: "If you're in a container, run the gateway in the foreground instead of `afora gateway`.",
          },
          {
            kind: "wsl-systemd",
