...
import { openExistingAforaStateDatabaseReadOnly } from "../state/afora-state-db.js";
...
export async function runClawsUpdateCommand(
  ...
  if (!source) {
    const database = await openExistingAforaStateDatabaseReadOnly();
  ...
  const plan = await buildClawUpdatePlan({
    ...
    targetAforaProfile: loaded.aforaProfile,
