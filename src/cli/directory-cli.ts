    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["afora directory self --channel slack", "Show the connected account identity."],
          [
            'afora directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["afora directory groups list --channel discord", "List available groups/channels."],
          [
            "afora directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.afora.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
