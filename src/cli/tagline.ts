...
const DEFAULT_TAGLINE = "All your chats, one Afora.";
...
const TAGLINES: string[] = [
  ...
  "You had me at 'afora gateway start.'",
  ...
  "If found wandering, please return to ~/.afora.",
  ...
  "Afora Support will never DM you first. I, on the other hand, absolutely will.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.AFORA_TAGLINE_INDEX;
