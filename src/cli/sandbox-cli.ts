...
const SANDBOX_EXAMPLES = {
  main: [
    ["afora sandbox list", "List all sandbox containers."],
    ["afora sandbox list --browser", "List only browser containers."],
    ["afora sandbox recreate --all", "Recreate all containers."],
    ["afora sandbox recreate --session main", "Recreate a specific session."],
    ["afora sandbox recreate --agent mybot", "Recreate agent containers."],
    ["afora sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["afora sandbox list", "List all sandbox containers."],
    ["afora sandbox list --browser", "List only browser containers."],
    ["afora sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["afora sandbox recreate --all", "Recreate all containers."],
    ["afora sandbox recreate --session main", "Recreate a specific session."],
    ["afora sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["afora sandbox recreate --browser --all", "Recreate only browser containers."],
    ["afora sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["afora sandbox explain", "Show effective sandbox config."],
    ["afora sandbox explain --session agent:main:main", "Explain a specific session."],
    ["afora sandbox explain --agent work", "Explain an agent sandbox."],
    ["afora sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.afora.ai/cli/sandbox")}\n`,
    )
    .action(() => {
