// Shared Afora banner: the dot-matrix lobster mascot beside the AFORA
...
function plainTitleLine(): string {
  ...
  return supportsDecorativeEmoji() && icon ? `${icon} AFORA ${icon}` : "AFORA";
}
...
/**
 * Prints the Afora banner: animated on rich interactive terminals, static
