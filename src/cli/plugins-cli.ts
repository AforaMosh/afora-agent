...
export function registerPluginsCli(program: Command) {
  const plugins = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/plugins", "docs.afora.ai/cli/plugins")}\n`,
    );
  ...
  marketplace
    .command("entries")
    .description("List entries from the configured Afora marketplace feed")
  ...
  marketplace
    .command("refresh")
    .description("Refresh the configured Afora marketplace feed snapshot")
