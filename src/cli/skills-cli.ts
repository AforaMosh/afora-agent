...
export function registerSkillsCli(program: Command) {
  const skills = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/skills", "docs.afora.ai/cli/skills")}\n`,
    );
  ...
  skills
    ...
    .addHelpText(
      "after",
      "\nExamples:\n  afora skills install @owner/weather\n  afora skills install skills-sh:owner/repo/weather\n",
    )
    .action(
      async (
        slug: string,
  ...
  skills
    ...
    .option("--agent <id>", "Target agent workspace (defaults to cwd-inferred, then default agent)")
    .addHelpText("after", "\nExamples:\n  afora skills verify @owner/weather\n")
    .action(
      async (
        slug: string,
        opts: {
