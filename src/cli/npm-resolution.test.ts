...
const CLI_STATE_ROOT = "/tmp/afora";
...
describe("npm-resolution helpers", () => {
  it("pins the install record to the resolved spec and logs a notice", () => {
    ...
    const record = resolvePinnedNpmInstallRecordForCli(
      "@afora/plugin-alpha@latest",
      true,
      ALPHA_INSTALL_PATH,
      "1.2.3",
      {
        name: "@afora/plugin-alpha",
        version: "1.2.3",
        resolvedSpec: "@afora/plugin-alpha@1.2.3",
      },
    ...
    expect(record).toEqual({
      source: "npm",
      spec: "@afora/plugin-alpha@1.2.3",
      installPath: ALPHA_INSTALL_PATH,
      version: "1.2.3",
      resolvedName: "@afora/plugin-alpha",
    ...
    expect(logs).toEqual(["Pinned npm install record to @afora/plugin-alpha@1.2.3."]);
  });
  ...
  it("keeps the requested spec and formats a warning when pin resolution is missing", () => {
    ...
    expect(record).toEqual({
      source: "npm",
      spec: "@afora/plugin-alpha@latest",
      installPath: ALPHA_INSTALL_PATH,
      version: "1.2.3",
