...
describe("process supervisor", () => {
  ...
  it("bounds retained output on UTF-16 boundaries while streaming full chunks", async () => {
    ...
    const stdoutMarker = `[afora: captured stdout truncated to last ${maxCapturedOutputChars} chars]\n`;
    const stderrMarker = `[afora: captured stderr truncated to last ${maxCapturedOutputChars} chars]\n`;
