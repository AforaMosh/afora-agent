...
const INFERENCE_UNAVAILABLE_MESSAGE =
  "Afora could not reach working inference. Run `afora onboard` on the machine running Afora to reconnect — it live-tests the route before saving it. Then try again.";
...
/** Safe public error for an Afora turn that could not complete with intelligence. */
