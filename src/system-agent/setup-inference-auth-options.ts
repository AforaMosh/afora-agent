...
export type SetupInferenceManualProvider = {
  /** Provider-auth choice id sent back to `afora.setup.activate`. */
  id: string;
...
export type SetupInferenceAuthOption = {
  /** Provider-auth choice id sent to `afora.setup.auth.start`. */
  id: string;
  /** Canonical provider identity for clients with bundled brand artwork. */
  brandId?: string;
  label: string;
...
export type SetupInferencePrepareOption = {
  /** Provider-auth choice id sent to `afora.setup.prepare.start`. */
  id: string;
  /** Canonical provider identity for clients with bundled brand artwork. */
  brandId?: string;
  label: string;
