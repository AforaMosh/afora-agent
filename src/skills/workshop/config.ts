// Workshop config helpers resolve skill workshop settings from Afora config.
...
export function resolveSkillWorkshopConfig(config?: AforaConfig): SkillWorkshopConfig {
