...
const CASES: GuidanceCase[] = [
  {
    ...
    required: ["AFORA_STATE_DIR"],
    forbidden: [
      "for f in ~/.afora/agents/<agentId>/sessions/*.jsonl",
      'rg -l "phrase" ~/.afora/agents/<agentId>/sessions/*.jsonl',
      "~/.afora/agents/<agentId>/sessions/<id>.jsonl",
    ],
  },
  {
  ...
  },
  {
    ...
    forbidden: [
      'SHERPA_ONNX_RUNTIME_DIR: "~/.afora/tools/sherpa-onnx-tts/runtime"',
      'SHERPA_ONNX_MODEL_DIR: "~/.afora/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high"',
      "<state-dir>",
    ],
  },
  {
...
describe("bundled skill env-path guidance", () => {
  it.each(CASES)(
    "keeps $file aligned with AFORA env overrides",
