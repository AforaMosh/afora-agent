...
export function resolveSkillsInstallPreferences(config?: AforaConfig): SkillsInstallPreferences {
...
const BUNDLED_SOURCES = new Set(["afora-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: AforaConfig): ReadonlySet<string> | undefined {
