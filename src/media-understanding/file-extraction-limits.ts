...
import { asPositiveFiniteNumber as positiveExtractionLimit } from "@afora/normalization-core/number-coercion";
...
export function resolveFileExtractionLimits(cfg: AforaConfig): FileExtractionLimits {
