...
import type { AforaStateDatabaseOptions } from "./afora-state-db-contract.js";
import { ensureAgentDatabaseLeaseSchema } from "./afora-state-db-schema-additive.js";
...
export function claimAforaAgentDatabaseLease(params: {
  agentId: string;
  path: string;
...
export function releaseAforaAgentDatabaseLease(
  leaseId: string,
...
export function assertNoAforaAgentDatabaseLeases(
  agentIdRaw: string,
  options: AforaStateDatabaseOptions = {},
): void {
