// Removes transient runtime state from restorable Afora database snapshots.
...
type SnapshotSanitizerDatabase = Pick<AforaStateKyselyDatabase, "exec_approvals_config">;
...
export function sanitizeAforaStateLeaseRows(database: DatabaseSync): void {
...
export function sanitizeAforaGlobalStateSnapshot(database: DatabaseSync): void {
