...
type WebFetchConfig = NonNullable<AforaConfig["tools"]>["web"] extends infer Web
...
let webFetchProviderCache = new WeakMap<AforaConfig, WebFetchProviderCacheEntry>();
...
function resolveFetchConfig(config: AforaConfig | undefined): WebFetchConfig | undefined {
...
function createWebFetchProviderConfigFingerprint(config: AforaConfig): string {
